...
The underlying framework and its runtime libraries support automatic persistence and automatic visualization of network-like data (features you may deliver with your own applications).
...
Graph representations are typically employed in engineering (designs, blueprints), model transformation (models, object meshes), computer linguistics (abstract syntax graphs, semantic nets, knowledge graphs), or compiler construction (intermediate representations, program graphs) -- but a graph is maybe the most natural representation of the data of your domain, too?
