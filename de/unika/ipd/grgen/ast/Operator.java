 ...
 */
public class Operator extends FunctionSignature {
	...
	final static private void makeOp(int id, TypeNode resType, TypeNode[] opTypes) {
		...
		typeMap.put(resType, new Operator(id, resType, opTypes));
	}
	 ...
	 */
	protected static Operator getNearest(int id, TypeNode[] opTypes) {
		Integer oid = new Integer(id);
		Operator res = null;
	 ...
	 */
	private Operator(int id, TypeNode resType, TypeNode[] opTypes) {
