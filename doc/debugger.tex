...
You may also specify \texttt{MSAGL} (see \ref{sec:MSAGL} for more on MSAGL). Note that no file will be dumped in this case, and that the shell will be frozen until you close the graph viewer window (furthermore, parameters will be ignored). 
