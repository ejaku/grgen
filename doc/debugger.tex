...
Technically, the debugger using MSAGL as graph viewer can be embedded into your own .NET program by utilizing the \texttt{graph\-Viewer\-And\-Sequence\-Debugger} assembly of \GrG\ (i.e. you can use it on API level, like MSAGL).
