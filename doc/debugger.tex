...
If \MSAGL{} is used, the debugger is displayed in a WindowsForms\cite{WinForms} console like control (potentially supported by a real GUI) instead of on a stdout console.
