...
\begin{figure}[hptb]
  ...
  \caption{Some contents of the ``Node'' class of the initial program graph, shown in the GUI debugger, with an upper pane sequence rendered in graph form, i.e. as an abstract syntax tree}
