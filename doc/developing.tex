...
The application tests checking that the languages work as expected (on the outside) had priority over checking internal components --- but the unit tests are to be extended, as they allow to find errors much earlier than the syntax/semantics test suites that take a long time to execute.
