...
A few filters (that do not need information from a specific match) are auto-supplied, they can be used without implementation and even without declaration. They allow keeping or removing a certain number of matches from the beginning or the end of the matches list.
