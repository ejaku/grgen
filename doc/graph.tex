...
\item[\texttt{equalsAnyStructurally(.,.)}] returns the subgraph (type: \texttt{graph}) from the set of subgraphs given with the second argument (type: \texttt{set<graph>}) that is isomorphic to the (sub)graph given as first argument (type: \texttt{graph}), neglecting attribute values (i.e. structural equality is sufficient).
\end{description}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Assertions}\label{sec:assert}
