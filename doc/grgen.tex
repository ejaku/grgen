...
\bibitem{batztech} G. Batz: \emph{An Optimization Technique for Subgraph Matching Strategies} Technischer Bericht, IPD Goos, Nr. 2006-7, Fakultät für Informatik, Universität Karlsruhe, 2006
...
\bibitem{beaver} H. Marxen, J. Buntrock: \emph{Old list of record TMs.}\\ http://www.drb.insel.de/\textasciitilde heiner/BB/index.html. Version: August 2000
...
\bibitem{pascal} N. Wirth, K. Jensen: \emph{Pascal User Manual and Report} Springer, $^41991$
\end{document}
