...
{morekeywords={actions,using,rule,test,pattern,replace,if,for,eval,negative,independent,node,edge,graph,modify,delete,class,model,connect,extends,enum,abstract,const,exec,emit,alternative,multiple,iterated,optional,yield,copy,sequence,def,evalhere,emithere,break,package,function,procedure,filter,include,var,ref,while,do,this,in,return,hom},
sensitive=true,
morecomment=[l]{//},
morecomment=[s]{/*}{*/},
morestring=[b]",
...
\begin{titlepage}
  ...
  \LARGE Refers to \GrG\ Release 4.3beta\\[1ex]
%  \LARGE ---DRAFT---\\[1ex]
