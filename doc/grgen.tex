...
\begin{titlepage}
  ...
  \LARGE Refers to \GrG\ Release 1.0\\[3ex]
...
\vfill
%		
We whish all readers of the manual and especially all users of \GrG\ a pleasent graph rewrite experience.
If you find that any statements in this manual needs improvement, we encourage you to write the maintainer of \GrG an email: \url{rubino@ipd.uni-karlsruhe.de}.
Thank you for using \GrG.
\vspace{2em}
The authors of \GrG
