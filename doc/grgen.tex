...
\chapter*{Foreword}
Fist of all a word about terms and definitions: This manual deals with graph rewriting.
Some people call this also graph transformation; some even think there is a difference between the two.
...
Especially we want to thank Sebastian Hack, Michael Beck, Tom Gelhausen, Moritz Kroll, Dr.~Andreas Ludwig, Dr.~Markus Noga.
