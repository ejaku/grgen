...
{morekeywords={abstract,alternative,arbitrary,array,auto,break,case,class,copy,connect,const,continue,count,def,delete,directed,do,edge,else,emit,emithere,enum,eval,evalhere,exact,exec,extends,external,false,filter,for,function,hom,if,in,independent,index,induced,iterated,map,match,modify,multiple,nameof,negative,node,null,optional,package,pattern,patternpath,procedure,deque,replace,return,rule,sequence,set,switch,test,true,typeof,undirected,using,visited,while,yield},
sensitive=true,
morecomment=[l]{//},
morecomment=[s]{/*}{*/},
morestring=[b]",
...
\begin{titlepage}
  ...
  \LARGE Refers to \GrG\ Release 4.4.2\\[1ex]
%  \LARGE ---DRAFT---\\[1ex]
