...
See Chapter~\ref{seqcomp} for graph rewrite sequences expressions (this command is esp. of interest for rule queries) and esp. Chapter~\ref{cha:graphquery} for rule queries.
