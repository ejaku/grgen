...
You may skip it and return to it when you are interested to learn more about the parts of the commands as you visit them.
...
They can be accessed in the \GrShell\ directly by their name, whereas in the sequences (or the rule language), a double colon prefix as required (using them outside of the shell is discouraged; see Chapter \ref{cha:xgrs} for the distinction between graph global aka shell and sequence local variables).
