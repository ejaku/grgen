...
\begin{note}
The \GrShell\ can reassign variables. This is in contrast to the rule language (chapter \ref{chaprulelang}), where we use \emph{names}. Those names have a static single assignment semantics in terms of compiler construction.
\end{note}
