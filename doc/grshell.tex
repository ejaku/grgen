...
\begin{grshelllet}
debug apply <rule with ? as placeholders>
\end{grshelllet}
...
todo: Replaced "dump edge labels (on | off)" by "dump edge [only] <type> labels (on | off | <text>)"
...
\begin{grshelllet} 
setvisited <elem> <visid> <visited>
\end{grshelllet}

\begin{grshelllet}
isvisited <elem> <visid>
\end{grshelllet}
