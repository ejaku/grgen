...
Create graph elements, initializing their attributes.
...
This are the commands you may find in the GRS export/import files.
...
\end{rail}\ixkeyw{show}\ixkeyw{profiles}
