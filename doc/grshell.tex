...
This way you can get an importable graph if you intend to remove some attributes -- otherwise import fails due to an unknown attribute getting initialized (in the file adhering to the old graph model).
