...
Prints the inherited/descendant types of the given \emph{EntityType} (\emph{NodeType}/\emph{EdgeType}/\emph{ObjectType}/\emph{TransientObjectType}); the kind identifier must fit to the specified type.
