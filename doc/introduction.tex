...
The \node{Phi}\footnote{a helper node from the static single assignment form employed, see \cite{braun13cc} for a simple algorithm for constructing it from an abstract syntax tree} 
