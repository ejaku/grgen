...
But also in \emph{engineering} or \emph{architecture} where you need to describe the buildup of the modeled system from components, here you can derive system \emph{blueprints} or simulate their behaviour.
...
The benefits from using \GrG{ }can be already felt from this example, they become really outstanding as the patterns grow in size and complexity.
