\chapter{Advanced Model with Object-Oriented and Graph-Oriented Programming}\indexmain{methods}\indexmain{graph-oriented programming}\indexmain{object-oriented programming}
