...
The \emph{ExternalClassDeclaration} registers an \indexed{external class}, including its subtype hierarchy, exluding any attributes with \GrG~which can subsequently be used in attribute computations with \indexed{external function} calls.
...
See Section~\ref{sec:builtintypes} for a list of built-in primitive and Section~\ref{sec:builtingenerictypes} for a list of built-in generic types.
