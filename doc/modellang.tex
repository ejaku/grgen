...
\end{rail}
\emph{ClassDeclaration} defines a node type or an edge type. \emph{EnumDeclaration} defines an enum type for use as attribute of nodes or edges. As all identifier definitions types do not need to be declared\indexmain{declaration} before they are used.
