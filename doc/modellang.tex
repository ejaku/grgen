...
\begin{note}
	The C-like semantics of enum item declarations implies that multiple items of one enum type can be associated with the same {\tt int} value, and esp. implies that such items/cases can not be distinguished anymore in-memory after assignment to a variable.
