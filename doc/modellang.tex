...
It allows you to specify \emph{node} and \emph{edge classes} bearing typed \emph{attributes} that are used in building and wiring the graph. 
...
In Chapter~\ref{cha:performance}, you find more on \emph{indices}, which allow you to quickly access the elements of the graph that are of interest to you.
...
A \emph{\indexed{connection assertion}} allows you to specify a \emph{constraint} on the topology.
