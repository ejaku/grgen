...
The following patterns that allow you to match a simplified abstract syntax tree give a rough picture of the language of nested and subpatterns:
...
The \indexmain{pattern cardinality} blocks allow you to specify how often the nested pattern -- opening a scope -- is to be matched.
