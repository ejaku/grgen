...
The yielding parts are executed bottom-up for one after matching and for the other while rewriting, they allow accumulating results.
...
it does not allow assigning to or changing non-\texttt{def} variables, or carrying out graph-changing commands.
