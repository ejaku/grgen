...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Basic graph querying and manipulation
    ...
    \item These constructs combined allow to program a state space enumeration
  \end{itemize}
\end{itemize}
...
See the extracted HTML documentation for interface descriptions at \url{http://www.grgen.net/doc/API_3_5/};
