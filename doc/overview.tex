...
Executing a generated graph rewrite system requires .NET Framework\cite{NET} version 4.7.2 or mono\cite{MONO} version 3.0, or later; compiling (and debugging) a graph rewrite system in addition requires JAVA\cite{JAVA} version 1.8 or later. 
