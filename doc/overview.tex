...
\begin{description}
  ...
  \item[Hints] The \indexed{layout algorithm} \indexedsee{compiler graph}{layout algorithm} (\yComp's default setting, a version of (\texttt{\indexedsee{hierarchic}{layout algorithm}} optimized for graph based compiler intermediate representations) may not be a good choice for your graph at hand. 
...
In contrast to systems like \indexed{Fujaba}~\cite{fujaba,fuj}, our strongest competitor regarding performance, 
...
This means that design decisions were taken to ease uses in this applications at the cost of rendering uses in other domains more difficult.
