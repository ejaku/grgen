...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Extended control (e.g decisions, transactions, indeterministic choice)
...
(causing the wrong impression that graph rewriting is notoriously inefficient in the heads of users).
