...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Creation of new nodes/edges of only dynamically known types or as exact copies of other
...
%	\pagebreak
  ...
  \begin{itemize}
    ...
    \item These constructs combined allow to easily program searches or state space enumerations
  \end{itemize}
\end{itemize}
...
This means especially that you are not allowed to ship it with a release of your own commercial software, in contrast to the \GrG libraries.
