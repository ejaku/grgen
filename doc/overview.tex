...
Executing a generated graph rewrite system requires .NET Framework\cite{NET} version 4.7.2 or mono\cite{MONO} version 5.10, or later (maybe complete packaging); the same holds for compiling it, building \GrG{} itself and debugging a graph rewrite system with \yComp{} in addition requires JAVA\cite{JAVAweb} version 1.8 or later. 
