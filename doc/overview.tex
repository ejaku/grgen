...
This frees you from the smearing of graph traversal and graph matching/rewriting functionality, and in consequence from many tedious modifications during development stemming from the continuous change of traversal code due to the steady evolution of functionality.
