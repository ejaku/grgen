...
Take care of the fact that connectedness checks for nodes that are reached via multiple edges are not printed in the search plan -- but they \emph{are} carried out, as early as possible.
