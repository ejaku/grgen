...
\begin{figure}[htbp]
    \begin{note}
        ...
        todo: If you are using Notepad++ you may be interested in the syntax highlighting for the model and rule language of GrGen provided in the syntaxhighlighting directory.
    \end{note}
\end{figure}
