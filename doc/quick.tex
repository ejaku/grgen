...
You can clearly see the syntax \texttt{x:NodeType} for nodes and \texttt{-e:EdgeType->} for Edges.
...
If everything is working you can delete the \texttt{debug} keyword in front of \texttt{xgrs}.
