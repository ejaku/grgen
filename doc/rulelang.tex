...
The nested \texttt{negative}s which specify a pattern which must not be available in the host graph are described in Chapter~\ref{cha:nestedsub}
...
\begin{rail}
  TestDeclaration: TestModifier 'test' ActionSignature lbrace Pattern rbrace ;
  RuleDeclaration: RuleModifier 'rule' ActionSignature lbrace Pattern Replace rbrace ;
