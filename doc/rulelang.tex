...
The \texttt{eval} are executed before the execution statements, i.e.\ the execution statements work on the recalculated attributes.
\begin{description}
...
\begin{rail}
  ...
  RewriteTerm: (() | '!') ('[' Rule ']' | Rule) |
    Text '=' (Text | '@' '(' Text ')') |
    'def' '(' Parameters ')' |
    'true' |
    'false' |
    '(' RewriteSequence ')' ;
\end{rail}\ixnterm{RewriteSequence}\ixnterm{RewriteTerm}
\makeatother
\mbox{\quad}\\
