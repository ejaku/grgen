...
\begin{rail}
  HomomorphySpecification:
    'hom' '(' (Ident + ',') ')' ';' |
    'independent' '(' Ident (backslash ( '(' (TypeExpr + '+')  ')' | TypeExpr ))? ')' ';'
    ;
...
Thus we got a mode of specification requesting homomorphic matching with additional isomorphy exceptions in contrast to the default mode,
