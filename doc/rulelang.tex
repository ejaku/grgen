...
\begin{figure}[htbp]
  ...
  \label{rule:figrule}
\end{figure}
In \GrG\, the preservation morphism $r$ is defined implicitly by using \indexed{name}s in pattern \indexed{graphlet}s and replace graphlets. (We don not need to care about the the differences of the replace part and the modify part at the moment.)
