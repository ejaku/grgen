...
\begin{rail}
  TestDeclaration: TestModifier 'test' ActionSignature lbrace Pattern rbrace FilterDecl;
  RuleDeclaration: RuleModifier 'rule' ActionSignature lbrace Pattern Replace rbrace FilterDecl;
