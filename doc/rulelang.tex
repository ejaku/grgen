...
\label{patternpart}
\begin{rail}
  Pattern: (() | 'dpo' | 'induced' | 'exact') 'pattern' lbrace (()+PatternStatement) rbrace ;
\end{rail}\ixkeyw{pattern}\ixkeyw{dpo}\ixkeyw{induced}\ixnterm{Pattern}
...
\subsection{Pattern Modifier}\indexmain{Modifier} 
\label{sct:patternmodifier}
\TODO{Explain dpo, induced, and exact}
