...
\begin{rail}
  ...
  RuleDeclaration: 'rule' (() | 'exact' | 'induced' | 'dpo' | 'dangling' | 'identification' ) ActionSignature lbrace Pattern Replace rbrace ;
