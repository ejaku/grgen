...
\begin{rail}  
  ReplaceStatement:
    Graphlet ';' |
    'delete' '(' (Ident + ',') ')' ';' |
    'eval' lbrace ((Assignment|VisitedAssignment|SetMapStateChange) ';' +) rbrace |
