...
%TODO: don't try to show every feature, esp. not negatives, show graphlets, show the stuff explained in this chapter
%\begin{figure}[tb]
...
You may use packages as a remedy, in the model for conflicting data units, or in the actions for conflicting computation units -- or you may use name prefixes as you would do in C.
