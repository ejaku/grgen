...
which delivers a canonical representation of the graph, 
and allows to reduce graph comparisons to string comparisons,
at the price of computing the canonical representation.
