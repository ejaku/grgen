...
The relational operators work as specified in Section~\ref{sub:expr} for numerical types and string type, and Chapter~\ref{cha:graph} for graph type.
...
\texttt{op e} & For \texttt{op} being boolean \texttt{!} or arithmetic \texttt{-,+} or bitwise \texttt{\~}\\
\hline
