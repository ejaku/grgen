...
All container constructors and copy constructors are supported.
...
From the infix operators, deque concatenation is supported, as well as all the relational operators.
