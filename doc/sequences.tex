...
TODO: Semantic! same as progamming languages of C-family. 
logical, lazy, eager
then left and then right, lazy or, lazy an, exclusive or, or, and
negation
TODO: Prioritäten! 
...
\begin{rail}
  VariableHandling: 
    ...
    SetVariable '.' ( 'add' '(' Value ')' | 'remove' '(' Value ')' | 'clear' '(' ')' ) |
    MapVariable '.' ( 'add' '(' Key ',' Value ')' | 'remove' '(' Key ')' | 'clear' '(' ')' ) |
	Variable '.' Attribute '=' Variable |
