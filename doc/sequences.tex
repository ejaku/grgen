...
There are two kinds of variables available in \GrG, i) graph global variables\indexmain{graph global variables} and ii) sequence local variables\indexmain{sequence local variables}.
...
\begin{rail}
  VisitedFlagsManagement:
    ...
    'vreset' '(' Variable ')'
\end{rail}\ixkeyw{valloc}\ixkeyw{vfree}\ixkeyw{visited}\ixkeyw{vreset}\label{allocvisitflag}\label{freevisitflag}
