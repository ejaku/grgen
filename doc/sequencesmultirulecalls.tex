...
In this chapter we'll take a look at different ways of applying multiple rules with a single construct, and at match classes, which allow applying the same filter on the matches of different rules.
