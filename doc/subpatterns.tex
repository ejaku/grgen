...
Exceeding the more verbose syntax they offer constructs for matching the pattern a bounded number of times (same notation as the one for the bounded iteration in the sequences).
...
Negative and independent patterns are used to explicitely check context constraints
