...
like e.g. an inheritance hierarchy of classes in our example domain of program graphs, see ex. \ref{exsptree}, i.e. you can match a \indexed{spanning tree} in the graph.
