...
\begin{note}
It could be necessary to utilize the OpenJDK in an old version (e.g. \texttt{1.8}) to get a running yComp.jar because of incompatibilities introduced later on (or JAVA from Oracle).
\end{note}
