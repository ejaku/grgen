...
\item[\texttt{sin(.)}] returns the sinus of the argument, which must be of type \texttt{double}
\item[\texttt{cos(.)}] returns the cosinus of the argument, which must be of type \texttt{double}
\item[\texttt{tan(.)}] returns the tangens of the argument, which must be of type \texttt{double}
\end{description}
