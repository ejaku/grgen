...
If an \emph{EntityType} is supplied, only attributes defined in the \emph{EntityType} are displayed (otherwise all attributes known to all types of the specified \emph{EntityKind}).
...
or might be too big a step in tightening the level of structural checking in an already existing large model.
...
Shows the graph model as a graph similar to a UML inheritance diagram.
