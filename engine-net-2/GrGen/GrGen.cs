...
namespace de.unika.ipd.grGen.grGen
{
    class GrGen
    {
        ...
        static int Main(string[] args)
        {
            ...
            if(specFile == null)
            {
                Console.WriteLine("Usage: GrGen [OPTIONS] <grg-file>[.grg]");
                Console.WriteLine("Options:");
                Console.WriteLine("  -o <output-dir>       Output directory for the generated assemblies");
                Console.WriteLine("  -b <backend-dll>      Use the specified backend library (default: LGSPBackend)");
                Console.WriteLine("  -keep [<gen-dir>]     Don't delete generated files making it possible");
                Console.WriteLine("                        to use the files in a C# project directly.");
                Console.WriteLine("                        This way you can also debug non-matching rules.");
                Console.WriteLine("                        Optionally you can specify a destination directory.");
                Console.WriteLine("  -use <existing-dir>   Use old C# files generated by the Java frontend");
                Console.WriteLine("                        using the -keep option in the specified directory");
                Console.WriteLine("  -usefull <exist-dir>  Use all old C# files generated using the -keep option");
                Console.WriteLine("                        in the specified directory");
                Console.WriteLine("  -debug                Compiles the assemblies with debug information");
                return 1;
            }
