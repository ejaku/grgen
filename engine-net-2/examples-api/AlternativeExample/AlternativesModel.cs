...
// Generated from "..\..\tests\alternatives\Alternatives.grg" on Sat Apr 19 15:09:16 CEST 2025
...
namespace de.unika.ipd.grGen.Model_Alternatives
{
	...
	{
		[ThreadStatic] private static int poolLevel;
		[ThreadStatic] private static GRGEN_MODEL.@A[] pool;
		...
		public override GRGEN_LIBGR.INode Clone() {
			return new GRGEN_MODEL.@A(this, null, null);
		}

		public override GRGEN_LIBGR.INode Copy(GRGEN_LIBGR.IGraph graph, IDictionary<object, object> oldToNewObjectMap) {
			return new GRGEN_MODEL.@A(this, graph, oldToNewObjectMap);
		}

		private @A(GRGEN_MODEL.@A oldElem, GRGEN_LIBGR.IGraph graph, IDictionary<object, object> oldToNewObjectMap) : base(GRGEN_MODEL.NodeType_A.typeVar)
		{
		}
		...
		public static GRGEN_MODEL.@A CreateNode(GRGEN_LGSP.LGSPGraph graph)
		{
			...
			{
				if(pool == null)
					pool = new GRGEN_MODEL.@A[GRGEN_LGSP.LGSPGraph.poolSize];
				node = pool[--poolLevel];
				node.lgspInhead = null;
				node.lgspOuthead = null;
				node.lgspFlags &= ~(uint) GRGEN_LGSP.LGSPElemFlags.HAS_VARIABLES;
	...
	{
		[ThreadStatic] private static int poolLevel;
		[ThreadStatic] private static GRGEN_MODEL.@B[] pool;
		...
		public override GRGEN_LIBGR.INode Clone() {
			return new GRGEN_MODEL.@B(this, null, null);
		}

		public override GRGEN_LIBGR.INode Copy(GRGEN_LIBGR.IGraph graph, IDictionary<object, object> oldToNewObjectMap) {
			return new GRGEN_MODEL.@B(this, graph, oldToNewObjectMap);
		}

		private @B(GRGEN_MODEL.@B oldElem, GRGEN_LIBGR.IGraph graph, IDictionary<object, object> oldToNewObjectMap) : base(GRGEN_MODEL.NodeType_B.typeVar)
		{
		}
		...
		public static GRGEN_MODEL.@B CreateNode(GRGEN_LGSP.LGSPGraph graph)
		{
			...
			{
				if(pool == null)
					pool = new GRGEN_MODEL.@B[GRGEN_LGSP.LGSPGraph.poolSize];
				node = pool[--poolLevel];
				node.lgspInhead = null;
				node.lgspOuthead = null;
				node.lgspFlags &= ~(uint) GRGEN_LGSP.LGSPElemFlags.HAS_VARIABLES;
	...
	public sealed partial class ObjectType_Object : GRGEN_LIBGR.ObjectType
	{
		...
		public override string ObjectInterfaceName { get { return "de.unika.ipd.grGen.Model_Alternatives.IObject"; } }
		public override string ObjectClassName { get { return "de.unika.ipd.grGen.Model_Alternatives.@Object"; } }
	...
	public sealed partial class TransientObjectType_TransientObject : GRGEN_LIBGR.TransientObjectType
	{
		...
		public override string TransientObjectInterfaceName { get { return "de.unika.ipd.grGen.Model_Alternatives.ITransientObject"; } }
		public override string TransientObjectClassName { get { return "de.unika.ipd.grGen.Model_Alternatives.@TransientObject"; } }
	...
	public sealed class AlternativesObjectModel : GRGEN_LIBGR.IObjectModel
	{
		public AlternativesObjectModel()
		{
	...
	public sealed class AlternativesTransientObjectModel : GRGEN_LIBGR.ITransientObjectModel
	{
		public AlternativesTransientObjectModel()
		{
	...
	public sealed class AlternativesGraphModel : GRGEN_LGSP.LGSPGraphModel
	{
		...
		private AlternativesObjectModel objectModel = new AlternativesObjectModel();
		private AlternativesTransientObjectModel transientObjectModel = new AlternativesTransientObjectModel();
		...
		public override string MD5Hash { get { return "eda3f90b55d93d14a7d999b4279fcda1"; } }
	}
	...
	{
		public AlternativesGraph(GRGEN_LGSP.LGSPGlobalVariables globalVariables) : base(new AlternativesGraphModel(), globalVariables, GetGraphName())
		{
		}
	...
	{
		public AlternativesNamedGraph(GRGEN_LGSP.LGSPGlobalVariables globalVariables) : base(new AlternativesGraphModel(), globalVariables, GetGraphName(), 0)
		{
		}
