...
// Generated from "..\..\tests\antWorld\AntWorld_ExtendAtEndOfRound_NoGammel.grg" on Sun Mar 23 22:55:07 CET 2014
...
namespace de.unika.ipd.grGen.Model_AntWorld_NoGammel
{
	...
	public sealed class AntWorld_NoGammelGraphModel : GRGEN_LGSP.LGSPGraphModel
	{
		...
		public override void CreateAndBindIndexSet(GRGEN_LGSP.LGSPGraph graph) {
			graph.indices = new AntWorld_NoGammelIndexSet(graph);
		}
		public override void FillIndexSetAsClone(GRGEN_LGSP.LGSPGraph graph, GRGEN_LGSP.LGSPGraph originalGraph, IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap) {
			((AntWorld_NoGammelIndexSet)graph.indices).FillAsClone(originalGraph, oldToNewMap);
		}
