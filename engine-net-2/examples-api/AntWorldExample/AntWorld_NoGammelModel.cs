...
namespace de.unika.ipd.grGen.Model_AntWorld_NoGammel
{
	...
	public sealed class AntWorld_NoGammelGraphModel : GRGEN_LGSP.LGSPGraphModel
	{
		...
		public override GRGEN_LIBGR.IIndexSet CreateIndexSet(GRGEN_LIBGR.IGraph graph) {
			return new AntWorld_NoGammelIndexSet((GRGEN_LGSP.LGSPGraph)graph);
		}
		public override void FillIndexSetAsClone(GRGEN_LIBGR.IGraph graph, GRGEN_LIBGR.IGraph originalGraph, IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap) {
			((AntWorld_NoGammelIndexSet)graph.Indices).FillAsClone((GRGEN_LGSP.LGSPGraph)originalGraph, oldToNewMap);
		}
	...
	//
	public class AntWorld_NoGammelGraph : GRGEN_LGSP.LGSPGraph
	{
		public AntWorld_NoGammelGraph() : base(new AntWorld_NoGammelGraphModel(), GetGraphName())
		{
		}
	...
	//
	public class AntWorld_NoGammelNamedGraph : GRGEN_LGSP.LGSPNamedGraph
	{
		public AntWorld_NoGammelNamedGraph() : base(new AntWorld_NoGammelGraphModel(), GetGraphName(), 0)
		{
		}
