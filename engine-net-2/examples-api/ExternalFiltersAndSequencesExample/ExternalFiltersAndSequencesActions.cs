...
namespace de.unika.ipd.grGen.Action_ExternalFiltersAndSequences
{
	public class Rule_filterBase : GRGEN_LGSP.LGSPRulePattern
	{
		...
		private Rule_filterBase()
		{
			...
			filters = new GRGEN_LGSP.LGSPFilter[] { new GRGEN_LGSP.LGSPFilterFunction("f1", true), new GRGEN_LGSP.LGSPFilterFunction("nomnomnom", true), new GRGEN_LGSP.LGSPFilterAutoGenerated("auto", null), };
	...
	public class Rule_filterBass : GRGEN_LGSP.LGSPRulePattern
	{
		...
		private Rule_filterBass()
		{
			...
			defNames = new string[] { };
			outputs = new GRGEN_LIBGR.GrGenType[] { };
			filters = new GRGEN_LGSP.LGSPFilter[] { new GRGEN_LGSP.LGSPFilterFunction("f2", true), new GRGEN_LGSP.LGSPFilterFunction("f3", true), new GRGEN_LGSP.LGSPFilterAutoGenerated("auto", null), };
	...
	public class Rule_filterHass : GRGEN_LGSP.LGSPRulePattern
	{
		...
		private Rule_filterHass()
		{
			...
			filters = new GRGEN_LGSP.LGSPFilter[] { new GRGEN_LGSP.LGSPFilterFunction("f4", true), };
