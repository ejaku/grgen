...
namespace de.unika.ipd.grGen.Action_ExternalFiltersAndSequences
{
	public class Rule_filterBase : GRGEN_LGSP.LGSPRulePattern
	{
		...
		private Rule_filterBase()
		{
			...
			filters = new GRGEN_LGSP.LGSPFilter[] { new GRGEN_LGSP.LGSPFilterAutoGenerated("auto", null), new GRGEN_LGSP.LGSPFilterFunction("f1", true, new GRGEN_LIBGR.GrGenType[] {}, new String[] {}), new GRGEN_LGSP.LGSPFilterFunction("nomnomnom", true, new GRGEN_LIBGR.GrGenType[] {}, new String[] {}), };
	...
	public class Rule_filterBass : GRGEN_LGSP.LGSPRulePattern
	{
		...
		private Rule_filterBass()
		{
			...
			defNames = new string[] { };
			outputs = new GRGEN_LIBGR.GrGenType[] { };
			filters = new GRGEN_LGSP.LGSPFilter[] { new GRGEN_LGSP.LGSPFilterAutoGenerated("auto", null), new GRGEN_LGSP.LGSPFilterFunction("f2", true, new GRGEN_LIBGR.GrGenType[] {}, new String[] {}), new GRGEN_LGSP.LGSPFilterFunction("f3", true, new GRGEN_LIBGR.GrGenType[] {}, new String[] {}), };
	...
	public class Rule_filterHass : GRGEN_LGSP.LGSPRulePattern
	{
		...
		private Rule_filterHass()
		{
			...
			filters = new GRGEN_LGSP.LGSPFilter[] { new GRGEN_LGSP.LGSPFilterFunction("f4", true, new GRGEN_LIBGR.GrGenType[] {GRGEN_LIBGR.VarType.GetVarType(typeof(int)), GRGEN_LIBGR.VarType.GetVarType(typeof(string)), }, new String[] {"i", "s", }), };
...
procEnv.SetVariableValue("b", tmpvar_14b);
        ...
        public static bool ApplyXGRS_r_1(GRGEN_LGSP.LGSPGraphProcessingEnvironment procEnv, GRGEN_MODEL.IN var_n)
        {
            ...
            MatchFilters.Filter_f4(procEnv, matches_84, (int)(GRGEN_LIBGR.ContainerHelper.IfAttributeOfElementIsContainerThenCloneContainer(((GRGEN_LIBGR.IGraphElement)procEnv.GetVariableValue("n")), "i", ((GRGEN_LIBGR.IGraphElement)procEnv.GetVariableValue("n")).GetAttribute("i"))), (string)("foo"));
            ...
            MatchFilters.Filter_f1(procEnv, matches_88);
            if(matches_88.Count==0) {
                ...
                while(enum_88.MoveNext())
                {
                    ...
                    MatchFilters.Filter_f1(procEnv, matches_87);
            ...
            MatchFilters.Filter_f1(procEnv, matches_90);
            ...
            MatchFilters.Filter_f2(procEnv, matches_91);
    ...
    public class Action_filterHass : GRGEN_LGSP.LGSPAction, GRGEN_LIBGR.IAction, IAction_filterHass
    {
        ...
        void GRGEN_LIBGR.IAction.Filter(GRGEN_LIBGR.IActionExecutionEnvironment actionEnv, GRGEN_LIBGR.IMatches matches, GRGEN_LIBGR.FilterCall filter)
        {
            ...
            switch(filter.FullName) {
                case "f4": MatchFilters.Filter_f4((GRGEN_LGSP.LGSPGraphProcessingEnvironment)actionEnv, (GRGEN_LIBGR.IMatchesExact<Rule_filterHass.IMatch_filterHass>)matches, (System.Int32)(filter.ArgumentExpressions[0]!=null ? filter.ArgumentExpressions[0].Evaluate((GRGEN_LIBGR.IGraphProcessingEnvironment)actionEnv) : filter.Arguments[0]), (System.String)(filter.ArgumentExpressions[1]!=null ? filter.ArgumentExpressions[1].Evaluate((GRGEN_LIBGR.IGraphProcessingEnvironment)actionEnv) : filter.Arguments[1])); break;
                default: throw new Exception("Unknown filter name!");
            }
        }
    }
