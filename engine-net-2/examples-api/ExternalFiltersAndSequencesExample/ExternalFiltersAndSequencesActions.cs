...
namespace de.unika.ipd.grGen.Action_ExternalFiltersAndSequences
{
	public class Rule_filterBase : GRGEN_LGSP.LGSPRulePattern
	{
		...
		private Rule_filterBase()
			...
			new string[] { },
			new GRGEN_LIBGR.GrGenType[] { },
			new GRGEN_LGSP.LGSPFilter[] { new GRGEN_LGSP.LGSPFilterAutoGenerated("auto", null, "auto", new String[] { } ), new GRGEN_LGSP.LGSPFilterFunction("f1", null, "f1", true, new GRGEN_LIBGR.GrGenType[] {}, new String[] {}), new GRGEN_LGSP.LGSPFilterFunction("nomnomnom", null, "nomnomnom", true, new GRGEN_LIBGR.GrGenType[] {}, new String[] {}), }
		)
		{
		}
	...
	public class Rule_filterBass : GRGEN_LGSP.LGSPRulePattern
	{
		...
		private Rule_filterBass()
			...
			new string[] { },
			new GRGEN_LIBGR.GrGenType[] { },
			new GRGEN_LGSP.LGSPFilter[] { new GRGEN_LGSP.LGSPFilterAutoGenerated("auto", null, "auto", new String[] { } ), new GRGEN_LGSP.LGSPFilterFunction("f2", null, "f2", true, new GRGEN_LIBGR.GrGenType[] {}, new String[] {}), new GRGEN_LGSP.LGSPFilterFunction("f3", null, "f3", true, new GRGEN_LIBGR.GrGenType[] {}, new String[] {}), }
		)
		{
		}
		private void initialize()
	...
	public class Rule_filterHass : GRGEN_LGSP.LGSPRulePattern
	{
		...
		private Rule_filterHass()
			...
			new GRGEN_LGSP.LGSPFilter[] { new GRGEN_LGSP.LGSPFilterFunction("f4", null, "f4", true, new GRGEN_LIBGR.GrGenType[] {GRGEN_LIBGR.VarType.GetVarType(typeof(int)), GRGEN_LIBGR.VarType.GetVarType(typeof(string)), }, new String[] {"i", "s", }), }
		)
		{
		}
		private void initialize()
...
procEnv.SetVariableValue("b", tmpvar_14b);
        ...
        public static bool ApplyXGRS_r_1(GRGEN_LGSP.LGSPGraphProcessingEnvironment procEnv, GRGEN_MODEL.IN var_n)
        {
            ...
            bool res_61;
            bool res_62;
            GRGEN_LIBGR.IMatchesExact<Rule_filterBase.IMatch_filterBase> matches_40 = rule_filterBase.Match(procEnv, 1);
            GRGEN_ACTIONS.MatchFilters.Filter_f1(procEnv, matches_40);
            procEnv.Matched(matches_40, null, false);
            if(matches_40.Count==0) {
                res_40 = (bool)(false);
            } else {
                res_40 = (bool)(true);
                procEnv.PerformanceInfo.MatchesFound += matches_40.Count;
                procEnv.Finishing(matches_40, false);
                Rule_filterBase.IMatch_filterBase match_40 = matches_40.FirstExact;
                rule_filterBase.Modify(procEnv, match_40);
                procEnv.PerformanceInfo.RewritesPerformed++;
                procEnv.Finished(matches_40, false);
            }
            GRGEN_LIBGR.IMatchesExact<Rule_filterBase.IMatch_filterBase> matches_41 = rule_filterBase.Match(procEnv, 1);
            GRGEN_ACTIONS.MatchFilters.Filter_nomnomnom(procEnv, matches_41);
            ...
            if(matches_41.Count==0) {
                ...
                Rule_filterBase.IMatch_filterBase match_41 = matches_41.FirstExact;
                rule_filterBase.Modify(procEnv, match_41);
                procEnv.PerformanceInfo.RewritesPerformed++;
                procEnv.Finished(matches_41, false);
            }
            res_42 = (bool)(res_41);
            GRGEN_LIBGR.IMatchesExact<Rule_filterBase.IMatch_filterBase> matches_43 = rule_filterBase.Match(procEnv, 1);
            GRGEN_ACTIONS.MatchFilters.Filter_filterBase_auto(procEnv, matches_43);
            ...
            if(matches_43.Count==0) {
                ...
                Rule_filterBase.IMatch_filterBase match_43 = matches_43.FirstExact;
                rule_filterBase.Modify(procEnv, match_43);
                procEnv.PerformanceInfo.RewritesPerformed++;
                procEnv.Finished(matches_43, false);
            }
            res_44 = (bool)(res_43);
            GRGEN_LIBGR.IMatchesExact<Rule_filterBass.IMatch_filterBass> matches_45 = rule_filterBass.Match(procEnv, procEnv.MaxMatches);
            GRGEN_ACTIONS.MatchFilters.Filter_f2(procEnv, matches_45);
            ...
            if(matches_45.Count==0) {
                ...
                IEnumerator<Rule_filterBass.IMatch_filterBass> enum_45 = matches_45.GetEnumeratorExact();
                while(enum_45.MoveNext())
                {
                    Rule_filterBass.IMatch_filterBass match_45 = enum_45.Current;
                    if(match_45!=matches_45.FirstExact) procEnv.RewritingNextMatch();
                    rule_filterBass.Modify(procEnv, match_45);
                    procEnv.PerformanceInfo.RewritesPerformed++;
                }
                procEnv.Finished(matches_45, false);
            }
            res_46 = (bool)(res_45);
            GRGEN_LIBGR.IMatchesExact<Rule_filterBass.IMatch_filterBass> matches_47 = rule_filterBass.Match(procEnv, procEnv.MaxMatches);
            GRGEN_ACTIONS.MatchFilters.Filter_f3(procEnv, matches_47);
            ...
            if(matches_47.Count==0) {
                ...
                int numchooserandomvar_47 = (int)procEnv.GetVariableValue("x");
                if(matches_47.Count < numchooserandomvar_47) numchooserandomvar_47 = matches_47.Count;
                for(int i = 0; i < numchooserandomvar_47; ++i)
                {
                    if(i != 0) procEnv.RewritingNextMatch();
                    Rule_filterBass.IMatch_filterBass match_47 = matches_47.RemoveMatchExact(GRGEN_LIBGR.Sequence.randomGenerator.Next(matches_47.Count));
                    rule_filterBass.Modify(procEnv, match_47);
                    procEnv.PerformanceInfo.RewritesPerformed++;
                }
                procEnv.Finished(matches_47, false);
            }
            res_48 = (bool)(res_47);
            GRGEN_LIBGR.IMatchesExact<Rule_filterBass.IMatch_filterBass> matches_49 = rule_filterBass.Match(procEnv, procEnv.MaxMatches);
            GRGEN_ACTIONS.MatchFilters.Filter_filterBass_auto(procEnv, matches_49);
            ...
            if(matches_49.Count==0) {
                ...
                IEnumerator<Rule_filterBass.IMatch_filterBass> enum_49 = matches_49.GetEnumeratorExact();
                while(enum_49.MoveNext())
                {
                    Rule_filterBass.IMatch_filterBass match_49 = enum_49.Current;
                    if(match_49!=matches_49.FirstExact) procEnv.RewritingNextMatch();
                    rule_filterBass.Modify(procEnv, match_49);
                    procEnv.PerformanceInfo.RewritesPerformed++;
                }
                procEnv.Finished(matches_49, false);
            }
            res_50 = (bool)(res_49);
            GRGEN_LIBGR.IMatchesExact<Rule_filterHass.IMatch_filterHass> matches_55 = rule_filterHass.Match(procEnv, 1, (GRGEN_MODEL.IN)procEnv.GetVariableValue("n"));
            GRGEN_ACTIONS.MatchFilters.Filter_f4(procEnv, matches_55, (int)(GRGEN_LIBGR.ContainerHelper.IfAttributeOfElementIsContainerThenCloneContainer(((GRGEN_LIBGR.IGraphElement)procEnv.GetVariableValue("n")), "i", ((GRGEN_LIBGR.IGraphElement)procEnv.GetVariableValue("n")).GetAttribute("i"))), (string)("foo"));
            procEnv.Matched(matches_55, null, false);
            if(matches_55.Count==0) {
                res_55 = (bool)(false);
            } else {
                res_55 = (bool)(true);
                procEnv.PerformanceInfo.MatchesFound += matches_55.Count;
                procEnv.Finishing(matches_55, false);
                Rule_filterHass.IMatch_filterHass match_55 = matches_55.FirstExact;
                GRGEN_MODEL.IE tmpvar_16ee; 
                rule_filterHass.Modify(procEnv, match_55, out tmpvar_16ee);
                procEnv.SetVariableValue("ee", tmpvar_16ee);

                procEnv.PerformanceInfo.RewritesPerformed++;
                procEnv.Finished(matches_55, false);
            }
            res_56 = (bool)(res_55);
            GRGEN_LIBGR.IMatchesExact<Rule_filterBase.IMatch_filterBase> matches_59 = rule_filterBase.Match(procEnv, procEnv.MaxMatches);
            GRGEN_ACTIONS.MatchFilters.Filter_f1(procEnv, matches_59);
            if(matches_59.Count==0) {
                res_59 = (bool)(false);
            } else {
                res_59 = (bool)(true);
                matches_59 = (GRGEN_LIBGR.IMatchesExact<Rule_filterBase.IMatch_filterBase>)matches_59.Clone();
                procEnv.PerformanceInfo.MatchesFound += matches_59.Count;
                procEnv.Finishing(matches_59, false);
                int matchesTried_59 = 0;
                IEnumerator<Rule_filterBase.IMatch_filterBase> enum_59 = matches_59.GetEnumeratorExact();
                while(enum_59.MoveNext())
                {
                    Rule_filterBase.IMatch_filterBase match_59 = enum_59.Current;
                    ++matchesTried_59;
                    int transID_59 = procEnv.TransactionManager.Start();
                    int oldRewritesPerformed_59 = procEnv.PerformanceInfo.RewritesPerformed;
                    procEnv.Matched(matches_59, match_59, false);
                    rule_filterBase.Modify(procEnv, match_59);
                    procEnv.PerformanceInfo.RewritesPerformed++;
                    procEnv.Finished(matches_59, false);
                    GRGEN_LIBGR.IMatchesExact<Rule_filterBase.IMatch_filterBase> matches_58 = rule_filterBase.Match(procEnv, 1);
                    GRGEN_ACTIONS.MatchFilters.Filter_f1(procEnv, matches_58);
                    procEnv.Matched(matches_58, null, false);
                    if(matches_58.Count==0) {
                        res_58 = (bool)(false);
                    } else {
                        res_58 = (bool)(true);
                        procEnv.PerformanceInfo.MatchesFound += matches_58.Count;
                        procEnv.Finishing(matches_58, false);
                        Rule_filterBase.IMatch_filterBase match_58 = matches_58.FirstExact;
                        rule_filterBase.Modify(procEnv, match_58);
                        procEnv.PerformanceInfo.RewritesPerformed++;
                        procEnv.Finished(matches_58, false);
                    }
                    if(!res_58) {
                        procEnv.TransactionManager.Rollback(transID_59);
                        procEnv.PerformanceInfo.RewritesPerformed = oldRewritesPerformed_59;
                        if(matchesTried_59 < matches_59.Count) {
                            continue;
                        } else {
                            res_59 = (bool)(false);
                            break;
                    ...
                    procEnv.TransactionManager.Commit(transID_59);
                    res_59 = (bool)(true);
                    break;
                }
            }
            res_60 = (bool)(res_59);
            res_63 = (bool)(false);
            GRGEN_LIBGR.IMatchesExact<Rule_filterBase.IMatch_filterBase> matches_61 = rule_filterBase.Match(procEnv, 1);
            GRGEN_ACTIONS.MatchFilters.Filter_f1(procEnv, matches_61);
            procEnv.PerformanceInfo.MatchesFound += matches_61.Count;
            if(matches_61.Count!=0) {
                res_63 = (bool)(true);
            }
            GRGEN_LIBGR.IMatchesExact<Rule_filterBass.IMatch_filterBass> matches_62 = rule_filterBass.Match(procEnv, procEnv.MaxMatches);
            GRGEN_ACTIONS.MatchFilters.Filter_f2(procEnv, matches_62);
            procEnv.PerformanceInfo.MatchesFound += matches_62.Count;
            if(matches_62.Count!=0) {
                res_63 = (bool)(true);
            }
            int total_match_to_apply_63 = 0;
            total_match_to_apply_63 += matches_61.Count;
            if(matches_62.Count>0) ++total_match_to_apply_63;
            total_match_to_apply_63 = GRGEN_LIBGR.Sequence.randomGenerator.Next(total_match_to_apply_63);
            int cur_total_match_63 = 0;
            bool first_rewrite_63 = true;
            if(matches_61.Count!=0 && cur_total_match_63<=total_match_to_apply_63) {
                if(cur_total_match_63==total_match_to_apply_63) {
                    Rule_filterBase.IMatch_filterBase match_61 = matches_61.FirstExact;
                    procEnv.Matched(matches_61, null, false);
                    procEnv.Finishing(matches_61, false);
                    if(!first_rewrite_63) procEnv.RewritingNextMatch();
                    rule_filterBase.Modify(procEnv, match_61);
                    procEnv.PerformanceInfo.RewritesPerformed++;
                    first_rewrite_63 = false;
                }
                ++cur_total_match_63;
                procEnv.Finished(matches_61, false);
            }
            if(matches_62.Count!=0 && cur_total_match_63<=total_match_to_apply_63) {
                if(cur_total_match_63==total_match_to_apply_63) {
    ...
    public class Sequence_counterExample2 : GRGEN_LIBGR.SequenceDefinitionCompiled
    {
        ...
        public static bool ApplyXGRS_counterExample2(GRGEN_LGSP.LGSPGraphProcessingEnvironment procEnv)
        {
            ...
            object res_73;
            res_73 = true;
            res_74 = (bool)(!GRGEN_LIBGR.TypesHelper.IsDefaultValue(res_73));
