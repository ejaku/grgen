...
// Generated from "..\..\tests\independent\Independent.grg" on Sat Apr 19 15:09:43 CEST 2025
...
namespace de.unika.ipd.grGen.Action_Independent
{
	public class Pattern_iteratedPath : GRGEN_LGSP.LGSPMatchingPattern
	{
		...
		private void initialize()
		{
			...
			GRGEN_LGSP.PatternGraphEmbedding iteratedPath_alt_0_recursive__sub0 = new GRGEN_LGSP.PatternGraphEmbedding("_sub0", Pattern_iteratedPath.Instance, 
				...
				new GRGEN_LGSP.PatternNode[] { iteratedPath_alt_0_recursive_node_intermediate, iteratedPath_node_end }, new GRGEN_LGSP.PatternEdge[] {  }, new GRGEN_LGSP.PatternVariable[] {  });
		...
		public void iteratedPath_alt_0_recursive_Delete(GRGEN_LGSP.LGSPActionExecutionEnvironment actionEnv, Match_iteratedPath_alt_0_recursive curMatch)
		{
			...
			GRGEN_LGSP.LGSPNode node_end = curMatch._node_end;
			GRGEN_LGSP.LGSPEdge edge__edge0 = curMatch._edge__edge0;
			GRGEN_ACTIONS.Pattern_iteratedPath.Match_iteratedPath subpattern__sub0 = curMatch.@__sub0;
			graph.Remove(edge__edge0);
			graph.RemoveEdges(node_beg);
			graph.Remove(node_beg);
			...
			graph.RemoveEdges(node_end);
			graph.Remove(node_end);
			GRGEN_ACTIONS.Pattern_iteratedPath.Instance.iteratedPath_Delete(actionEnv, subpattern__sub0);
		}
		...
		public interface IMatch_iteratedPath_alt_0_recursive : IMatch_iteratedPath_alt_0
		{
			...
			//Variables
			//EmbeddedGraphs
			@GRGEN_ACTIONS.Pattern_iteratedPath.Match_iteratedPath @_sub0 { get; }
			//Alternatives
			//Iterateds
			//Independents
			// further match object stuff
		...
		public class Match_iteratedPath : GRGEN_LGSP.MatchListElement<Match_iteratedPath>, IMatch_iteratedPath
		{
			...
			{
				switch(name) {
				case "beg": _node_beg = (GRGEN_LGSP.LGSPNode)value; break;
				case "end": _node_end = (GRGEN_LGSP.LGSPNode)value; break;
				default: break;
				}
			}
			...
			public override int NumberOfAlternatives { get { return 1; } }
			...
			public override GRGEN_LIBGR.IPatternGraph Pattern { get { return Pattern_iteratedPath.instance.pat_iteratedPath; } }
			public override GRGEN_LIBGR.IMatchClass MatchClass { get { return null; } }
			public override GRGEN_LIBGR.IMatch Clone() { return new Match_iteratedPath(this); }
			public override GRGEN_LIBGR.IMatch Clone(IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap) { return new Match_iteratedPath(this, oldToNewMap); }
			...
			public void AssignContent(Match_iteratedPath that, IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap)
			{
				_node_beg = (GRGEN_LGSP.LGSPNode)oldToNewMap[that._node_beg];
				_node_end = (GRGEN_LGSP.LGSPNode)oldToNewMap[that._node_end];
				if(that._alt_0 is Match_iteratedPath_alt_0_base)
					_alt_0 = new Match_iteratedPath_alt_0_base((Match_iteratedPath_alt_0_base)that._alt_0, oldToNewMap);
				else if(that._alt_0 is Match_iteratedPath_alt_0_recursive)
					_alt_0 = new Match_iteratedPath_alt_0_recursive((Match_iteratedPath_alt_0_recursive)that._alt_0, oldToNewMap);
			}

			public Match_iteratedPath(Match_iteratedPath that, IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap)
			{
		...
		public class Match_iteratedPath_alt_0_base : GRGEN_LGSP.MatchListElement<Match_iteratedPath_alt_0_base>, IMatch_iteratedPath_alt_0_base
		{
			public GRGEN_LIBGR.INode node_beg { get { return (GRGEN_LIBGR.INode)_node_beg; } set { _node_beg = (GRGEN_LGSP.LGSPNode)value; } }
			public GRGEN_LIBGR.INode node_end { get { return (GRGEN_LIBGR.INode)_node_end; } set { _node_end = (GRGEN_LGSP.LGSPNode)value; } }
			public GRGEN_LGSP.LGSPNode _node_beg;
			...
			public override GRGEN_LIBGR.IPatternGraph Pattern { get { return Pattern_iteratedPath.instance.iteratedPath_alt_0_base; } }
			public override GRGEN_LIBGR.IMatchClass MatchClass { get { return null; } }
			public override GRGEN_LIBGR.IMatch Clone() { return new Match_iteratedPath_alt_0_base(this); }
			public override GRGEN_LIBGR.IMatch Clone(IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap) { return new Match_iteratedPath_alt_0_base(this, oldToNewMap); }
			public void SetMatchOfEnclosingPattern(GRGEN_LIBGR.IMatch matchOfEnclosingPattern) { _matchOfEnclosingPattern = matchOfEnclosingPattern; }
			...
			public void AssignContent(Match_iteratedPath_alt_0_base that, IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap)
			{
				_node_beg = (GRGEN_LGSP.LGSPNode)oldToNewMap[that._node_beg];
				_node_end = (GRGEN_LGSP.LGSPNode)oldToNewMap[that._node_end];
			...
			public Match_iteratedPath_alt_0_base(Match_iteratedPath_alt_0_base that, IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap)
			{
				AssignContent(that, oldToNewMap);
			}
		...
		public class Match_iteratedPath_alt_0_recursive : GRGEN_LGSP.MatchListElement<Match_iteratedPath_alt_0_recursive>, IMatch_iteratedPath_alt_0_recursive
		{
			public GRGEN_LIBGR.INode node_beg { get { return (GRGEN_LIBGR.INode)_node_beg; } set { _node_beg = (GRGEN_LGSP.LGSPNode)value; } }
			...
			public override void SetNode(string name, GRGEN_LIBGR.INode value)
			{
				switch(name) {
				case "beg": _node_beg = (GRGEN_LGSP.LGSPNode)value; break;
				case "intermediate": _node_intermediate = (GRGEN_LGSP.LGSPNode)value; break;
				case "end": _node_end = (GRGEN_LGSP.LGSPNode)value; break;
				default: break;
				}
			}
			...
			public @GRGEN_ACTIONS.Pattern_iteratedPath.Match_iteratedPath @_sub0 { get { return @__sub0; } }
			public @GRGEN_ACTIONS.Pattern_iteratedPath.Match_iteratedPath @__sub0;
			...
			public override GRGEN_LIBGR.IPatternGraph Pattern { get { return Pattern_iteratedPath.instance.iteratedPath_alt_0_recursive; } }
			public override GRGEN_LIBGR.IMatchClass MatchClass { get { return null; } }
			public override GRGEN_LIBGR.IMatch Clone() { return new Match_iteratedPath_alt_0_recursive(this); }
			public override GRGEN_LIBGR.IMatch Clone(IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap) { return new Match_iteratedPath_alt_0_recursive(this, oldToNewMap); }
			public void SetMatchOfEnclosingPattern(GRGEN_LIBGR.IMatch matchOfEnclosingPattern) { _matchOfEnclosingPattern = matchOfEnclosingPattern; }
			...
			public void AssignContent(Match_iteratedPath_alt_0_recursive that, IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap)
			{
				_node_beg = (GRGEN_LGSP.LGSPNode)oldToNewMap[that._node_beg];
				_node_intermediate = (GRGEN_LGSP.LGSPNode)oldToNewMap[that._node_intermediate];
				_node_end = (GRGEN_LGSP.LGSPNode)oldToNewMap[that._node_end];
				_edge__edge0 = (GRGEN_LGSP.LGSPEdge)oldToNewMap[that._edge__edge0];
				@__sub0 = new GRGEN_ACTIONS.Pattern_iteratedPath.Match_iteratedPath(that.@__sub0, oldToNewMap);
			}

			public Match_iteratedPath_alt_0_recursive(Match_iteratedPath_alt_0_recursive that, IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap)
			{
				AssignContent(that, oldToNewMap);
			}
	...
	public class Pattern_iteratedPathToIntNode : GRGEN_LGSP.LGSPMatchingPattern
	{
		...
		private void initialize()
		{
			...
			GRGEN_LGSP.PatternGraphEmbedding iteratedPathToIntNode_alt_0_recursive__sub0 = new GRGEN_LGSP.PatternGraphEmbedding("_sub0", Pattern_iteratedPathToIntNode.Instance, 
				...
				new GRGEN_LGSP.PatternNode[] { iteratedPathToIntNode_alt_0_recursive_node_intermediate }, new GRGEN_LGSP.PatternEdge[] {  }, new GRGEN_LGSP.PatternVariable[] {  });
		...
		public void iteratedPathToIntNode_alt_0_recursive_Delete(GRGEN_LGSP.LGSPActionExecutionEnvironment actionEnv, Match_iteratedPathToIntNode_alt_0_recursive curMatch)
		{
			...
			GRGEN_LGSP.LGSPNode node_intermediate = curMatch._node_intermediate;
			GRGEN_LGSP.LGSPEdge edge__edge0 = curMatch._edge__edge0;
			GRGEN_ACTIONS.Pattern_iteratedPathToIntNode.Match_iteratedPathToIntNode subpattern__sub0 = curMatch.@__sub0;
			graph.Remove(edge__edge0);
			graph.RemoveEdges(node_beg);
			graph.Remove(node_beg);
			graph.RemoveEdges(node_intermediate);
			graph.Remove(node_intermediate);
			GRGEN_ACTIONS.Pattern_iteratedPathToIntNode.Instance.iteratedPathToIntNode_Delete(actionEnv, subpattern__sub0);
		}
		...
		public interface IMatch_iteratedPathToIntNode_alt_0_recursive : IMatch_iteratedPathToIntNode_alt_0
		{
			...
			//Variables
			//EmbeddedGraphs
			@GRGEN_ACTIONS.Pattern_iteratedPathToIntNode.Match_iteratedPathToIntNode @_sub0 { get; }
			//Alternatives
			//Iterateds
			//Independents
			// further match object stuff
		...
		public class Match_iteratedPathToIntNode : GRGEN_LGSP.MatchListElement<Match_iteratedPathToIntNode>, IMatch_iteratedPathToIntNode
		{
			public GRGEN_LIBGR.INode node_beg { get { return (GRGEN_LIBGR.INode)_node_beg; } set { _node_beg = (GRGEN_LGSP.LGSPNode)value; } }
			public GRGEN_LGSP.LGSPNode _node_beg;
			...
			public override GRGEN_LIBGR.IPatternGraph Pattern { get { return Pattern_iteratedPathToIntNode.instance.pat_iteratedPathToIntNode; } }
			public override GRGEN_LIBGR.IMatchClass MatchClass { get { return null; } }
			public override GRGEN_LIBGR.IMatch Clone() { return new Match_iteratedPathToIntNode(this); }
			public override GRGEN_LIBGR.IMatch Clone(IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap) { return new Match_iteratedPathToIntNode(this, oldToNewMap); }
			public void SetMatchOfEnclosingPattern(GRGEN_LIBGR.IMatch matchOfEnclosingPattern) { _matchOfEnclosingPattern = matchOfEnclosingPattern; }
			...
			public void AssignContent(Match_iteratedPathToIntNode that, IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap)
			{
				_node_beg = (GRGEN_LGSP.LGSPNode)oldToNewMap[that._node_beg];
				if(that._alt_0 is Match_iteratedPathToIntNode_alt_0_base)
					_alt_0 = new Match_iteratedPathToIntNode_alt_0_base((Match_iteratedPathToIntNode_alt_0_base)that._alt_0, oldToNewMap);
				else if(that._alt_0 is Match_iteratedPathToIntNode_alt_0_recursive)
					_alt_0 = new Match_iteratedPathToIntNode_alt_0_recursive((Match_iteratedPathToIntNode_alt_0_recursive)that._alt_0, oldToNewMap);
			}

			public Match_iteratedPathToIntNode(Match_iteratedPathToIntNode that, IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap)
			{
				AssignContent(that, oldToNewMap);
			}
		...
		public class Match_iteratedPathToIntNode_alt_0_base : GRGEN_LGSP.MatchListElement<Match_iteratedPathToIntNode_alt_0_base>, IMatch_iteratedPathToIntNode_alt_0_base
		{
			public GRGEN_LIBGR.INode node_beg { get { return (GRGEN_LIBGR.INode)_node_beg; } set { _node_beg = (GRGEN_LGSP.LGSPNode)value; } }
			...
			public override GRGEN_LIBGR.IPatternGraph Pattern { get { return Pattern_iteratedPathToIntNode.instance.iteratedPathToIntNode_alt_0_base; } }
			public override GRGEN_LIBGR.IMatchClass MatchClass { get { return null; } }
			public override GRGEN_LIBGR.IMatch Clone() { return new Match_iteratedPathToIntNode_alt_0_base(this); }
			public override GRGEN_LIBGR.IMatch Clone(IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap) { return new Match_iteratedPathToIntNode_alt_0_base(this, oldToNewMap); }
			public void SetMatchOfEnclosingPattern(GRGEN_LIBGR.IMatch matchOfEnclosingPattern) { _matchOfEnclosingPattern = matchOfEnclosingPattern; }
			...
			public void AssignContent(Match_iteratedPathToIntNode_alt_0_base that, IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap)
			{
				_node_beg = (GRGEN_LGSP.LGSPNode)oldToNewMap[that._node_beg];
				_node_end = (GRGEN_LGSP.LGSPNode)oldToNewMap[that._node_end];
				_edge__edge0 = (GRGEN_LGSP.LGSPEdge)oldToNewMap[that._edge__edge0];
			...
			public Match_iteratedPathToIntNode_alt_0_base(Match_iteratedPathToIntNode_alt_0_base that, IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap)
			{
				AssignContent(that, oldToNewMap);
			}
		...
		public class Match_iteratedPathToIntNode_alt_0_recursive : GRGEN_LGSP.MatchListElement<Match_iteratedPathToIntNode_alt_0_recursive>, IMatch_iteratedPathToIntNode_alt_0_recursive
		{
			public GRGEN_LIBGR.INode node_beg { get { return (GRGEN_LIBGR.INode)_node_beg; } set { _node_beg = (GRGEN_LGSP.LGSPNode)value; } }
			public GRGEN_LIBGR.INode node_intermediate { get { return (GRGEN_LIBGR.INode)_node_intermediate; } set { _node_intermediate = (GRGEN_LGSP.LGSPNode)value; } }
			public GRGEN_LGSP.LGSPNode _node_beg;
			...
			public @GRGEN_ACTIONS.Pattern_iteratedPathToIntNode.Match_iteratedPathToIntNode @_sub0 { get { return @__sub0; } }
			public @GRGEN_ACTIONS.Pattern_iteratedPathToIntNode.Match_iteratedPathToIntNode @__sub0;
			...
			public override GRGEN_LIBGR.IPatternGraph Pattern { get { return Pattern_iteratedPathToIntNode.instance.iteratedPathToIntNode_alt_0_recursive; } }
			public override GRGEN_LIBGR.IMatchClass MatchClass { get { return null; } }
			public override GRGEN_LIBGR.IMatch Clone() { return new Match_iteratedPathToIntNode_alt_0_recursive(this); }
			public override GRGEN_LIBGR.IMatch Clone(IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap) { return new Match_iteratedPathToIntNode_alt_0_recursive(this, oldToNewMap); }
			public void SetMatchOfEnclosingPattern(GRGEN_LIBGR.IMatch matchOfEnclosingPattern) { _matchOfEnclosingPattern = matchOfEnclosingPattern; }
			...
			public void AssignContent(Match_iteratedPathToIntNode_alt_0_recursive that, IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap)
			{
				_node_beg = (GRGEN_LGSP.LGSPNode)oldToNewMap[that._node_beg];
				_node_intermediate = (GRGEN_LGSP.LGSPNode)oldToNewMap[that._node_intermediate];
				_edge__edge0 = (GRGEN_LGSP.LGSPEdge)oldToNewMap[that._edge__edge0];
				@__sub0 = new GRGEN_ACTIONS.Pattern_iteratedPathToIntNode.Match_iteratedPathToIntNode(that.@__sub0, oldToNewMap);
			}

			public Match_iteratedPathToIntNode_alt_0_recursive(Match_iteratedPathToIntNode_alt_0_recursive that, IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap)
			{
				AssignContent(that, oldToNewMap);
			}
	...
	public class Rule_create : GRGEN_LGSP.LGSPRulePattern
	{
		...
		private Rule_create()
			: base("create",
				...
				"de.unika.ipd.grGen.Action_Independent.Rule_create+IMatch_create",
				"de.unika.ipd.grGen.Action_Independent.Rule_create+Match_create"
			)
		{
		}
		private void initialize()
		...
		public class Match_create : GRGEN_LGSP.MatchListElement<Match_create>, IMatch_create
		{
			...
			public override GRGEN_LIBGR.IPatternGraph Pattern { get { return Rule_create.instance.pat_create; } }
			public override GRGEN_LIBGR.IMatchClass MatchClass { get { return null; } }
			public override GRGEN_LIBGR.IMatch Clone() { return new Match_create(this); }
			public override GRGEN_LIBGR.IMatch Clone(IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap) { return new Match_create(this, oldToNewMap); }
			public void SetMatchOfEnclosingPattern(GRGEN_LIBGR.IMatch matchOfEnclosingPattern) { _matchOfEnclosingPattern = matchOfEnclosingPattern; }
			...
			public void AssignContent(Match_create that, IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap)
			{
			}

			public Match_create(Match_create that, IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap)
			{
				AssignContent(that, oldToNewMap);
			}
			public Match_create()
	...
	{
		private static GRGEN_ACTIONS.Rule_create.IMatch_create instanceBearingAttributeForSearch_create = new GRGEN_ACTIONS.Rule_create.Match_create();
	}
	...
	public class Rule_find : GRGEN_LGSP.LGSPRulePattern
	{
		...
		private Rule_find()
			: base("find",
				...
				new GRGEN_LIBGR.MatchClassInfo[] { },
				"de.unika.ipd.grGen.Action_Independent.Rule_find+IMatch_find",
				"de.unika.ipd.grGen.Action_Independent.Rule_find+Match_find"
			)
		{
		}
		private void initialize()
		...
		public class Match_find : GRGEN_LGSP.MatchListElement<Match_find>, IMatch_find
		{
			public GRGEN_LIBGR.INode node_beg { get { return (GRGEN_LIBGR.INode)_node_beg; } set { _node_beg = (GRGEN_LGSP.LGSPNode)value; } }
			...
			public override GRGEN_LIBGR.IPatternGraph Pattern { get { return Rule_find.instance.pat_find; } }
			public override GRGEN_LIBGR.IMatchClass MatchClass { get { return null; } }
			public override GRGEN_LIBGR.IMatch Clone() { return new Match_find(this); }
			public override GRGEN_LIBGR.IMatch Clone(IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap) { return new Match_find(this, oldToNewMap); }
			public void SetMatchOfEnclosingPattern(GRGEN_LIBGR.IMatch matchOfEnclosingPattern) { _matchOfEnclosingPattern = matchOfEnclosingPattern; }
			...
			public void AssignContent(Match_find that, IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap)
			{
				_node_beg = (GRGEN_LGSP.LGSPNode)oldToNewMap[that._node_beg];
			...
			public Match_find(Match_find that, IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap)
			{
				AssignContent(that, oldToNewMap);
			}
			public Match_find()
		...
		public class Extractor
		{
			public static List<GRGEN_LIBGR.INode> Extract_beg(List<IMatch_find> matchList)
			{
				List<GRGEN_LIBGR.INode> resultList = new List<GRGEN_LIBGR.INode>(matchList.Count);
				foreach(IMatch_find match in matchList)
					resultList.Add(match.node_beg);
				return resultList;
			}
			public static List<GRGEN_LIBGR.INode> Extract__node0(List<IMatch_find> matchList)
			{
				List<GRGEN_LIBGR.INode> resultList = new List<GRGEN_LIBGR.INode>(matchList.Count);
				foreach(IMatch_find match in matchList)
			...
			public static List<GRGEN_LIBGR.INode> Extract_end(List<IMatch_find> matchList)
			{
				List<GRGEN_LIBGR.INode> resultList = new List<GRGEN_LIBGR.INode>(matchList.Count);
				foreach(IMatch_find match in matchList)
					resultList.Add(match.node_end);
				return resultList;
			}
			public static List<GRGEN_LIBGR.INode> Extract__node1(List<IMatch_find> matchList)
			{
				List<GRGEN_LIBGR.INode> resultList = new List<GRGEN_LIBGR.INode>(matchList.Count);
				foreach(IMatch_find match in matchList)
			...
			public static List<GRGEN_LIBGR.IDEdge> Extract__edge0(List<IMatch_find> matchList)
			{
			...
			public static List<GRGEN_LIBGR.IDEdge> Extract__edge1(List<IMatch_find> matchList)
			{
				List<GRGEN_LIBGR.IDEdge> resultList = new List<GRGEN_LIBGR.IDEdge>(matchList.Count);
				foreach(IMatch_find match in matchList)
			...
			public static List<GRGEN_LIBGR.IDEdge> Extract__edge2(List<IMatch_find> matchList)
			{
				List<GRGEN_LIBGR.IDEdge> resultList = new List<GRGEN_LIBGR.IDEdge>(matchList.Count);
				foreach(IMatch_find match in matchList)
			...
			public static List<GRGEN_LIBGR.IDEdge> Extract__edge3(List<IMatch_find> matchList)
			{
				List<GRGEN_LIBGR.IDEdge> resultList = new List<GRGEN_LIBGR.IDEdge>(matchList.Count);
				foreach(IMatch_find match in matchList)
	...
	public partial class ArrayHelper
	{
		private static GRGEN_ACTIONS.Rule_find.IMatch_find instanceBearingAttributeForSearch_find = new GRGEN_ACTIONS.Rule_find.Match_find();
		public static List<GRGEN_ACTIONS.Rule_find.IMatch_find> Array_find_groupBy_beg(List<GRGEN_ACTIONS.Rule_find.IMatch_find> list)
		{
			Dictionary<GRGEN_LIBGR.INode, List<GRGEN_ACTIONS.Rule_find.IMatch_find>> seenValues = new Dictionary<GRGEN_LIBGR.INode, List<GRGEN_ACTIONS.Rule_find.IMatch_find>>();
			for(int pos = 0; pos < list.Count; ++pos)
			{
				if(seenValues.ContainsKey(list[pos].@node_beg)) {
					seenValues[list[pos].@node_beg].Add(list[pos]);
				} else {
					List<GRGEN_ACTIONS.Rule_find.IMatch_find> tempList = new List<GRGEN_ACTIONS.Rule_find.IMatch_find>();
					tempList.Add(list[pos]);
					seenValues.Add(list[pos].@node_beg, tempList);
				}
			}
			List<GRGEN_ACTIONS.Rule_find.IMatch_find> newList = new List<GRGEN_ACTIONS.Rule_find.IMatch_find>();
			foreach(List<GRGEN_ACTIONS.Rule_find.IMatch_find> entry in seenValues.Values)
			{
		...
		public static int Array_find_indexOfBy_beg(IList<GRGEN_ACTIONS.Rule_find.IMatch_find> list, GRGEN_LIBGR.INode entry, int startIndex)
		{
		...
		public static int Array_find_indexOfBy_beg(IList<GRGEN_ACTIONS.Rule_find.IMatch_find> list, GRGEN_LIBGR.INode entry)
		{
		...
		public static int Array_find_lastIndexOfBy_beg(IList<GRGEN_ACTIONS.Rule_find.IMatch_find> list, GRGEN_LIBGR.INode entry, int startIndex)
		{
		...
		public static int Array_find_lastIndexOfBy_beg(IList<GRGEN_ACTIONS.Rule_find.IMatch_find> list, GRGEN_LIBGR.INode entry)
		{
		...
		public static List<GRGEN_ACTIONS.Rule_find.IMatch_find> Array_find_groupBy__node0(List<GRGEN_ACTIONS.Rule_find.IMatch_find> list)
		{
			Dictionary<GRGEN_LIBGR.INode, List<GRGEN_ACTIONS.Rule_find.IMatch_find>> seenValues = new Dictionary<GRGEN_LIBGR.INode, List<GRGEN_ACTIONS.Rule_find.IMatch_find>>();
			for(int pos = 0; pos < list.Count; ++pos)
			{
		...
		public static int Array_find_indexOfBy__node0(IList<GRGEN_ACTIONS.Rule_find.IMatch_find> list, GRGEN_LIBGR.INode entry, int startIndex)
		{
			for(int i = startIndex; i < list.Count; ++i)
		...
		public static int Array_find_indexOfBy__node0(IList<GRGEN_ACTIONS.Rule_find.IMatch_find> list, GRGEN_LIBGR.INode entry)
		{
			for(int i = 0; i < list.Count; ++i)
				if(list[i].@node__node0.Equals(entry))
					return i;
		...
		public static int Array_find_lastIndexOfBy__node0(IList<GRGEN_ACTIONS.Rule_find.IMatch_find> list, GRGEN_LIBGR.INode entry, int startIndex)
		{
			for(int i = startIndex; i >= 0; --i)
				if(list[i].@node__node0.Equals(entry))
					return i;
		...
		public static int Array_find_lastIndexOfBy__node0(IList<GRGEN_ACTIONS.Rule_find.IMatch_find> list, GRGEN_LIBGR.INode entry)
		{
			for(int i = list.Count - 1; i >= 0; --i)
				if(list[i].@node__node0.Equals(entry))
					return i;
		...
		public static List<GRGEN_ACTIONS.Rule_find.IMatch_find> Array_find_groupBy_end(List<GRGEN_ACTIONS.Rule_find.IMatch_find> list)
		{
			Dictionary<GRGEN_LIBGR.INode, List<GRGEN_ACTIONS.Rule_find.IMatch_find>> seenValues = new Dictionary<GRGEN_LIBGR.INode, List<GRGEN_ACTIONS.Rule_find.IMatch_find>>();
			for(int pos = 0; pos < list.Count; ++pos)
			{
				if(seenValues.ContainsKey(list[pos].@node_end)) {
					seenValues[list[pos].@node_end].Add(list[pos]);
				} else {
					List<GRGEN_ACTIONS.Rule_find.IMatch_find> tempList = new List<GRGEN_ACTIONS.Rule_find.IMatch_find>();
					tempList.Add(list[pos]);
					seenValues.Add(list[pos].@node_end, tempList);
				}
			}
			List<GRGEN_ACTIONS.Rule_find.IMatch_find> newList = new List<GRGEN_ACTIONS.Rule_find.IMatch_find>();
			foreach(List<GRGEN_ACTIONS.Rule_find.IMatch_find> entry in seenValues.Values)
		...
		public static int Array_find_indexOfBy_end(IList<GRGEN_ACTIONS.Rule_find.IMatch_find> list, GRGEN_LIBGR.INode entry, int startIndex)
		{
			for(int i = startIndex; i < list.Count; ++i)
		...
		public static int Array_find_indexOfBy_end(IList<GRGEN_ACTIONS.Rule_find.IMatch_find> list, GRGEN_LIBGR.INode entry)
		{
			for(int i = 0; i < list.Count; ++i)
				if(list[i].@node_end.Equals(entry))
					return i;
		...
		public static int Array_find_lastIndexOfBy_end(IList<GRGEN_ACTIONS.Rule_find.IMatch_find> list, GRGEN_LIBGR.INode entry, int startIndex)
		{
			for(int i = startIndex; i >= 0; --i)
				if(list[i].@node_end.Equals(entry))
					return i;
		...
		public static int Array_find_lastIndexOfBy_end(IList<GRGEN_ACTIONS.Rule_find.IMatch_find> list, GRGEN_LIBGR.INode entry)
		{
			for(int i = list.Count - 1; i >= 0; --i)
				if(list[i].@node_end.Equals(entry))
					return i;
		...
		public static List<GRGEN_ACTIONS.Rule_find.IMatch_find> Array_find_groupBy__node1(List<GRGEN_ACTIONS.Rule_find.IMatch_find> list)
		{
			Dictionary<GRGEN_LIBGR.INode, List<GRGEN_ACTIONS.Rule_find.IMatch_find>> seenValues = new Dictionary<GRGEN_LIBGR.INode, List<GRGEN_ACTIONS.Rule_find.IMatch_find>>();
			for(int pos = 0; pos < list.Count; ++pos)
			{
		...
		public static int Array_find_indexOfBy__node1(IList<GRGEN_ACTIONS.Rule_find.IMatch_find> list, GRGEN_LIBGR.INode entry, int startIndex)
		{
			for(int i = startIndex; i < list.Count; ++i)
		...
		public static int Array_find_indexOfBy__node1(IList<GRGEN_ACTIONS.Rule_find.IMatch_find> list, GRGEN_LIBGR.INode entry)
		{
			for(int i = 0; i < list.Count; ++i)
				if(list[i].@node__node1.Equals(entry))
					return i;
		...
		public static int Array_find_lastIndexOfBy__node1(IList<GRGEN_ACTIONS.Rule_find.IMatch_find> list, GRGEN_LIBGR.INode entry, int startIndex)
		{
			for(int i = startIndex; i >= 0; --i)
				if(list[i].@node__node1.Equals(entry))
					return i;
		...
		public static int Array_find_lastIndexOfBy__node1(IList<GRGEN_ACTIONS.Rule_find.IMatch_find> list, GRGEN_LIBGR.INode entry)
		{
			for(int i = list.Count - 1; i >= 0; --i)
				if(list[i].@node__node1.Equals(entry))
					return i;
		...
		public static List<GRGEN_ACTIONS.Rule_find.IMatch_find> Array_find_groupBy__edge0(List<GRGEN_ACTIONS.Rule_find.IMatch_find> list)
		{
			Dictionary<GRGEN_LIBGR.IDEdge, List<GRGEN_ACTIONS.Rule_find.IMatch_find>> seenValues = new Dictionary<GRGEN_LIBGR.IDEdge, List<GRGEN_ACTIONS.Rule_find.IMatch_find>>();
			for(int pos = 0; pos < list.Count; ++pos)
			{
		...
		public static int Array_find_indexOfBy__edge0(IList<GRGEN_ACTIONS.Rule_find.IMatch_find> list, GRGEN_LIBGR.IDEdge entry, int startIndex)
		{
			for(int i = startIndex; i < list.Count; ++i)
		...
		public static int Array_find_indexOfBy__edge0(IList<GRGEN_ACTIONS.Rule_find.IMatch_find> list, GRGEN_LIBGR.IDEdge entry)
		{
			for(int i = 0; i < list.Count; ++i)
				if(list[i].@edge__edge0.Equals(entry))
					return i;
		...
		public static int Array_find_lastIndexOfBy__edge0(IList<GRGEN_ACTIONS.Rule_find.IMatch_find> list, GRGEN_LIBGR.IDEdge entry, int startIndex)
		{
			for(int i = startIndex; i >= 0; --i)
				if(list[i].@edge__edge0.Equals(entry))
					return i;
		...
		public static int Array_find_lastIndexOfBy__edge0(IList<GRGEN_ACTIONS.Rule_find.IMatch_find> list, GRGEN_LIBGR.IDEdge entry)
		{
			for(int i = list.Count - 1; i >= 0; --i)
				if(list[i].@edge__edge0.Equals(entry))
					return i;
		...
		public static List<GRGEN_ACTIONS.Rule_find.IMatch_find> Array_find_groupBy__edge1(List<GRGEN_ACTIONS.Rule_find.IMatch_find> list)
		{
			Dictionary<GRGEN_LIBGR.IDEdge, List<GRGEN_ACTIONS.Rule_find.IMatch_find>> seenValues = new Dictionary<GRGEN_LIBGR.IDEdge, List<GRGEN_ACTIONS.Rule_find.IMatch_find>>();
			for(int pos = 0; pos < list.Count; ++pos)
			{
		...
		public static int Array_find_indexOfBy__edge1(IList<GRGEN_ACTIONS.Rule_find.IMatch_find> list, GRGEN_LIBGR.IDEdge entry, int startIndex)
		{
			for(int i = startIndex; i < list.Count; ++i)
		...
		public static int Array_find_indexOfBy__edge1(IList<GRGEN_ACTIONS.Rule_find.IMatch_find> list, GRGEN_LIBGR.IDEdge entry)
		{
			for(int i = 0; i < list.Count; ++i)
				if(list[i].@edge__edge1.Equals(entry))
					return i;
		...
		public static int Array_find_lastIndexOfBy__edge1(IList<GRGEN_ACTIONS.Rule_find.IMatch_find> list, GRGEN_LIBGR.IDEdge entry, int startIndex)
		{
			for(int i = startIndex; i >= 0; --i)
				if(list[i].@edge__edge1.Equals(entry))
					return i;
		...
		public static int Array_find_lastIndexOfBy__edge1(IList<GRGEN_ACTIONS.Rule_find.IMatch_find> list, GRGEN_LIBGR.IDEdge entry)
		{
			for(int i = list.Count - 1; i >= 0; --i)
				if(list[i].@edge__edge1.Equals(entry))
					return i;
		...
		public static List<GRGEN_ACTIONS.Rule_find.IMatch_find> Array_find_groupBy__edge2(List<GRGEN_ACTIONS.Rule_find.IMatch_find> list)
		{
			Dictionary<GRGEN_LIBGR.IDEdge, List<GRGEN_ACTIONS.Rule_find.IMatch_find>> seenValues = new Dictionary<GRGEN_LIBGR.IDEdge, List<GRGEN_ACTIONS.Rule_find.IMatch_find>>();
			for(int pos = 0; pos < list.Count; ++pos)
			{
		...
		public static int Array_find_indexOfBy__edge2(IList<GRGEN_ACTIONS.Rule_find.IMatch_find> list, GRGEN_LIBGR.IDEdge entry, int startIndex)
		{
			for(int i = startIndex; i < list.Count; ++i)
		...
		public static int Array_find_indexOfBy__edge2(IList<GRGEN_ACTIONS.Rule_find.IMatch_find> list, GRGEN_LIBGR.IDEdge entry)
		{
			for(int i = 0; i < list.Count; ++i)
				if(list[i].@edge__edge2.Equals(entry))
					return i;
		...
		public static int Array_find_lastIndexOfBy__edge2(IList<GRGEN_ACTIONS.Rule_find.IMatch_find> list, GRGEN_LIBGR.IDEdge entry, int startIndex)
		{
			for(int i = startIndex; i >= 0; --i)
				if(list[i].@edge__edge2.Equals(entry))
					return i;
		...
		public static int Array_find_lastIndexOfBy__edge2(IList<GRGEN_ACTIONS.Rule_find.IMatch_find> list, GRGEN_LIBGR.IDEdge entry)
		{
			for(int i = list.Count - 1; i >= 0; --i)
				if(list[i].@edge__edge2.Equals(entry))
					return i;
		...
		public static List<GRGEN_ACTIONS.Rule_find.IMatch_find> Array_find_groupBy__edge3(List<GRGEN_ACTIONS.Rule_find.IMatch_find> list)
		{
			Dictionary<GRGEN_LIBGR.IDEdge, List<GRGEN_ACTIONS.Rule_find.IMatch_find>> seenValues = new Dictionary<GRGEN_LIBGR.IDEdge, List<GRGEN_ACTIONS.Rule_find.IMatch_find>>();
			for(int pos = 0; pos < list.Count; ++pos)
			{
		...
		public static int Array_find_indexOfBy__edge3(IList<GRGEN_ACTIONS.Rule_find.IMatch_find> list, GRGEN_LIBGR.IDEdge entry, int startIndex)
		{
			for(int i = startIndex; i < list.Count; ++i)
		...
		public static int Array_find_indexOfBy__edge3(IList<GRGEN_ACTIONS.Rule_find.IMatch_find> list, GRGEN_LIBGR.IDEdge entry)
		{
			for(int i = 0; i < list.Count; ++i)
				if(list[i].@edge__edge3.Equals(entry))
					return i;
		...
		public static int Array_find_lastIndexOfBy__edge3(IList<GRGEN_ACTIONS.Rule_find.IMatch_find> list, GRGEN_LIBGR.IDEdge entry, int startIndex)
		{
			for(int i = startIndex; i >= 0; --i)
				if(list[i].@edge__edge3.Equals(entry))
					return i;
		...
		public static int Array_find_lastIndexOfBy__edge3(IList<GRGEN_ACTIONS.Rule_find.IMatch_find> list, GRGEN_LIBGR.IDEdge entry)
		{
			for(int i = list.Count - 1; i >= 0; --i)
				if(list[i].@edge__edge3.Equals(entry))
					return i;
	...
	public class Rule_findIndependent : GRGEN_LGSP.LGSPRulePattern
	{
		...
		private Rule_findIndependent()
			: base("findIndependent",
				...
				new GRGEN_LIBGR.MatchClassInfo[] { },
				"de.unika.ipd.grGen.Action_Independent.Rule_findIndependent+IMatch_findIndependent",
				"de.unika.ipd.grGen.Action_Independent.Rule_findIndependent+Match_findIndependent"
			)
		{
		}
		private void initialize()
		...
		public class Match_findIndependent : GRGEN_LGSP.MatchListElement<Match_findIndependent>, IMatch_findIndependent
		{
			public GRGEN_LIBGR.INode node_beg { get { return (GRGEN_LIBGR.INode)_node_beg; } set { _node_beg = (GRGEN_LGSP.LGSPNode)value; } }
			public GRGEN_LIBGR.INode node__node0 { get { return (GRGEN_LIBGR.INode)_node__node0; } set { _node__node0 = (GRGEN_LGSP.LGSPNode)value; } }
			public GRGEN_LIBGR.INode node_end { get { return (GRGEN_LIBGR.INode)_node_end; } set { _node_end = (GRGEN_LGSP.LGSPNode)value; } }
			...
			public override IEnumerable<GRGEN_LIBGR.IMatch> Independents { get { return new GRGEN_LGSP.Independents_Enumerable(this); } }
			public override IEnumerator<GRGEN_LIBGR.IMatch> IndependentsEnumerator { get { return new GRGEN_LGSP.Independents_Enumerator(this); } }
			public override int NumberOfIndependents { get { return 1; } }
			public override GRGEN_LIBGR.IMatch getIndependentAt(int index)
			{
				switch(index) {
			...
			public override GRGEN_LIBGR.IPatternGraph Pattern { get { return Rule_findIndependent.instance.pat_findIndependent; } }
			public override GRGEN_LIBGR.IMatchClass MatchClass { get { return null; } }
			public override GRGEN_LIBGR.IMatch Clone() { return new Match_findIndependent(this); }
			public override GRGEN_LIBGR.IMatch Clone(IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap) { return new Match_findIndependent(this, oldToNewMap); }
			public void SetMatchOfEnclosingPattern(GRGEN_LIBGR.IMatch matchOfEnclosingPattern) { _matchOfEnclosingPattern = matchOfEnclosingPattern; }
			...
			public void AssignContent(Match_findIndependent that, IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap)
			{
				_node_beg = (GRGEN_LGSP.LGSPNode)oldToNewMap[that._node_beg];
				_node__node0 = (GRGEN_LGSP.LGSPNode)oldToNewMap[that._node__node0];
				_node_end = (GRGEN_LGSP.LGSPNode)oldToNewMap[that._node_end];
				_edge__edge0 = (GRGEN_LGSP.LGSPEdge)oldToNewMap[that._edge__edge0];
				_edge__edge1 = (GRGEN_LGSP.LGSPEdge)oldToNewMap[that._edge__edge1];
				_idpt_0 = new Match_findIndependent_idpt_0((Match_findIndependent_idpt_0)that._idpt_0, oldToNewMap);
			}

			public Match_findIndependent(Match_findIndependent that, IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap)
			{
				AssignContent(that, oldToNewMap);
			}
		...
		public class Match_findIndependent_idpt_0 : GRGEN_LGSP.MatchListElement<Match_findIndependent_idpt_0>, IMatch_findIndependent_idpt_0
		{
			public GRGEN_LIBGR.INode node__node0 { get { return (GRGEN_LIBGR.INode)_node__node0; } set { _node__node0 = (GRGEN_LGSP.LGSPNode)value; } }
			public GRGEN_LIBGR.INode node_beg { get { return (GRGEN_LIBGR.INode)_node_beg; } set { _node_beg = (GRGEN_LGSP.LGSPNode)value; } }
			public GRGEN_LIBGR.INode node_end { get { return (GRGEN_LIBGR.INode)_node_end; } set { _node_end = (GRGEN_LGSP.LGSPNode)value; } }
			...
			public override GRGEN_LIBGR.IPatternGraph Pattern { get { return Rule_findIndependent.instance.findIndependent_idpt_0; } }
			public override GRGEN_LIBGR.IMatchClass MatchClass { get { return null; } }
			public override GRGEN_LIBGR.IMatch Clone() { return new Match_findIndependent_idpt_0(this); }
			public override GRGEN_LIBGR.IMatch Clone(IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap) { return new Match_findIndependent_idpt_0(this, oldToNewMap); }
			public void SetMatchOfEnclosingPattern(GRGEN_LIBGR.IMatch matchOfEnclosingPattern) { _matchOfEnclosingPattern = matchOfEnclosingPattern; }
			...
			public void AssignContent(Match_findIndependent_idpt_0 that, IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap)
			{
				_node__node0 = (GRGEN_LGSP.LGSPNode)oldToNewMap[that._node__node0];
				_node_beg = (GRGEN_LGSP.LGSPNode)oldToNewMap[that._node_beg];
				_node_end = (GRGEN_LGSP.LGSPNode)oldToNewMap[that._node_end];
			...
			public Match_findIndependent_idpt_0(Match_findIndependent_idpt_0 that, IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap)
			{
				AssignContent(that, oldToNewMap);
			}
		...
		public class Extractor
		{
			public static List<GRGEN_LIBGR.INode> Extract_beg(List<IMatch_findIndependent> matchList)
			{
				List<GRGEN_LIBGR.INode> resultList = new List<GRGEN_LIBGR.INode>(matchList.Count);
				foreach(IMatch_findIndependent match in matchList)
					resultList.Add(match.node_beg);
				return resultList;
			}
			public static List<GRGEN_LIBGR.INode> Extract__node0(List<IMatch_findIndependent> matchList)
			{
				List<GRGEN_LIBGR.INode> resultList = new List<GRGEN_LIBGR.INode>(matchList.Count);
				foreach(IMatch_findIndependent match in matchList)
					resultList.Add(match.node__node0);
			...
			public static List<GRGEN_LIBGR.INode> Extract_end(List<IMatch_findIndependent> matchList)
			{
				List<GRGEN_LIBGR.INode> resultList = new List<GRGEN_LIBGR.INode>(matchList.Count);
				foreach(IMatch_findIndependent match in matchList)
					resultList.Add(match.node_end);
			...
			public static List<GRGEN_LIBGR.IDEdge> Extract__edge0(List<IMatch_findIndependent> matchList)
			{
				List<GRGEN_LIBGR.IDEdge> resultList = new List<GRGEN_LIBGR.IDEdge>(matchList.Count);
				foreach(IMatch_findIndependent match in matchList)
					resultList.Add(match.edge__edge0);
			...
			public static List<GRGEN_LIBGR.IDEdge> Extract__edge1(List<IMatch_findIndependent> matchList)
			{
				List<GRGEN_LIBGR.IDEdge> resultList = new List<GRGEN_LIBGR.IDEdge>(matchList.Count);
				foreach(IMatch_findIndependent match in matchList)
					resultList.Add(match.edge__edge1);
	...
	public partial class ArrayHelper
	{
		private static GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent instanceBearingAttributeForSearch_findIndependent = new GRGEN_ACTIONS.Rule_findIndependent.Match_findIndependent();
		public static List<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent> Array_findIndependent_groupBy_beg(List<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent> list)
		{
			Dictionary<GRGEN_LIBGR.INode, List<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent>> seenValues = new Dictionary<GRGEN_LIBGR.INode, List<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent>>();
			for(int pos = 0; pos < list.Count; ++pos)
			{
				if(seenValues.ContainsKey(list[pos].@node_beg)) {
					seenValues[list[pos].@node_beg].Add(list[pos]);
				} else {
					List<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent> tempList = new List<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent>();
					tempList.Add(list[pos]);
					seenValues.Add(list[pos].@node_beg, tempList);
				}
			}
			...
			foreach(List<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent> entry in seenValues.Values)
			{
				newList.AddRange(entry);
			}
			return newList;
		...
		public static int Array_findIndependent_indexOfBy_beg(IList<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent> list, GRGEN_LIBGR.INode entry, int startIndex)
		{
			for(int i = startIndex; i < list.Count; ++i)
				if(list[i].@node_beg.Equals(entry))
					return i;
		...
		public static int Array_findIndependent_indexOfBy_beg(IList<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent> list, GRGEN_LIBGR.INode entry)
		{
			for(int i = 0; i < list.Count; ++i)
				if(list[i].@node_beg.Equals(entry))
					return i;
		...
		public static int Array_findIndependent_lastIndexOfBy_beg(IList<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent> list, GRGEN_LIBGR.INode entry, int startIndex)
		{
			for(int i = startIndex; i >= 0; --i)
				if(list[i].@node_beg.Equals(entry))
					return i;
		...
		public static int Array_findIndependent_lastIndexOfBy_beg(IList<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent> list, GRGEN_LIBGR.INode entry)
		{
			for(int i = list.Count - 1; i >= 0; --i)
				if(list[i].@node_beg.Equals(entry))
					return i;
		...
		public static List<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent> Array_findIndependent_groupBy__node0(List<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent> list)
		{
			Dictionary<GRGEN_LIBGR.INode, List<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent>> seenValues = new Dictionary<GRGEN_LIBGR.INode, List<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent>>();
			for(int pos = 0; pos < list.Count; ++pos)
			{
		...
		public static int Array_findIndependent_indexOfBy__node0(IList<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent> list, GRGEN_LIBGR.INode entry, int startIndex)
		{
			for(int i = startIndex; i < list.Count; ++i)
				if(list[i].@node__node0.Equals(entry))
					return i;
		...
		public static int Array_findIndependent_indexOfBy__node0(IList<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent> list, GRGEN_LIBGR.INode entry)
		{
			for(int i = 0; i < list.Count; ++i)
				if(list[i].@node__node0.Equals(entry))
					return i;
		...
		public static int Array_findIndependent_lastIndexOfBy__node0(IList<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent> list, GRGEN_LIBGR.INode entry, int startIndex)
		{
			for(int i = startIndex; i >= 0; --i)
				if(list[i].@node__node0.Equals(entry))
					return i;
		...
		public static int Array_findIndependent_lastIndexOfBy__node0(IList<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent> list, GRGEN_LIBGR.INode entry)
		{
			for(int i = list.Count - 1; i >= 0; --i)
				if(list[i].@node__node0.Equals(entry))
					return i;
		...
		public static List<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent> Array_findIndependent_groupBy_end(List<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent> list)
		{
			Dictionary<GRGEN_LIBGR.INode, List<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent>> seenValues = new Dictionary<GRGEN_LIBGR.INode, List<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent>>();
			for(int pos = 0; pos < list.Count; ++pos)
			{
		...
		public static int Array_findIndependent_indexOfBy_end(IList<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent> list, GRGEN_LIBGR.INode entry, int startIndex)
		{
			for(int i = startIndex; i < list.Count; ++i)
				if(list[i].@node_end.Equals(entry))
					return i;
		...
		public static int Array_findIndependent_indexOfBy_end(IList<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent> list, GRGEN_LIBGR.INode entry)
		{
			for(int i = 0; i < list.Count; ++i)
				if(list[i].@node_end.Equals(entry))
					return i;
		...
		public static int Array_findIndependent_lastIndexOfBy_end(IList<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent> list, GRGEN_LIBGR.INode entry, int startIndex)
		{
			for(int i = startIndex; i >= 0; --i)
				if(list[i].@node_end.Equals(entry))
					return i;
		...
		public static int Array_findIndependent_lastIndexOfBy_end(IList<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent> list, GRGEN_LIBGR.INode entry)
		{
			for(int i = list.Count - 1; i >= 0; --i)
				if(list[i].@node_end.Equals(entry))
					return i;
		...
		public static List<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent> Array_findIndependent_groupBy__edge0(List<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent> list)
		{
			Dictionary<GRGEN_LIBGR.IDEdge, List<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent>> seenValues = new Dictionary<GRGEN_LIBGR.IDEdge, List<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent>>();
			for(int pos = 0; pos < list.Count; ++pos)
			{
				if(seenValues.ContainsKey(list[pos].@edge__edge0)) {
					seenValues[list[pos].@edge__edge0].Add(list[pos]);
		...
		public static int Array_findIndependent_indexOfBy__edge0(IList<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent> list, GRGEN_LIBGR.IDEdge entry, int startIndex)
		{
			for(int i = startIndex; i < list.Count; ++i)
				if(list[i].@edge__edge0.Equals(entry))
					return i;
		...
		public static int Array_findIndependent_indexOfBy__edge0(IList<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent> list, GRGEN_LIBGR.IDEdge entry)
		{
			for(int i = 0; i < list.Count; ++i)
				if(list[i].@edge__edge0.Equals(entry))
					return i;
		...
		public static int Array_findIndependent_lastIndexOfBy__edge0(IList<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent> list, GRGEN_LIBGR.IDEdge entry, int startIndex)
		{
			for(int i = startIndex; i >= 0; --i)
				if(list[i].@edge__edge0.Equals(entry))
					return i;
		...
		public static int Array_findIndependent_lastIndexOfBy__edge0(IList<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent> list, GRGEN_LIBGR.IDEdge entry)
		{
			for(int i = list.Count - 1; i >= 0; --i)
				if(list[i].@edge__edge0.Equals(entry))
					return i;
		...
		public static List<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent> Array_findIndependent_groupBy__edge1(List<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent> list)
		{
			Dictionary<GRGEN_LIBGR.IDEdge, List<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent>> seenValues = new Dictionary<GRGEN_LIBGR.IDEdge, List<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent>>();
			for(int pos = 0; pos < list.Count; ++pos)
			{
		...
		public static int Array_findIndependent_indexOfBy__edge1(IList<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent> list, GRGEN_LIBGR.IDEdge entry, int startIndex)
		{
			for(int i = startIndex; i < list.Count; ++i)
				if(list[i].@edge__edge1.Equals(entry))
					return i;
		...
		public static int Array_findIndependent_indexOfBy__edge1(IList<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent> list, GRGEN_LIBGR.IDEdge entry)
		{
			for(int i = 0; i < list.Count; ++i)
				if(list[i].@edge__edge1.Equals(entry))
					return i;
		...
		public static int Array_findIndependent_lastIndexOfBy__edge1(IList<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent> list, GRGEN_LIBGR.IDEdge entry, int startIndex)
		{
			for(int i = startIndex; i >= 0; --i)
				if(list[i].@edge__edge1.Equals(entry))
					return i;
		...
		public static int Array_findIndependent_lastIndexOfBy__edge1(IList<GRGEN_ACTIONS.Rule_findIndependent.IMatch_findIndependent> list, GRGEN_LIBGR.IDEdge entry)
		{
			for(int i = list.Count - 1; i >= 0; --i)
				if(list[i].@edge__edge1.Equals(entry))
					return i;
	...
	public class Rule_findMultiNested : GRGEN_LGSP.LGSPRulePattern
	{
		...
		private Rule_findMultiNested()
			: base("findMultiNested",
				...
				new GRGEN_LIBGR.MatchClassInfo[] { },
				"de.unika.ipd.grGen.Action_Independent.Rule_findMultiNested+IMatch_findMultiNested",
				"de.unika.ipd.grGen.Action_Independent.Rule_findMultiNested+Match_findMultiNested"
			)
		{
		}
		private void initialize()
		...
		public class Match_findMultiNested : GRGEN_LGSP.MatchListElement<Match_findMultiNested>, IMatch_findMultiNested
		{
			public GRGEN_LIBGR.INode node_beg { get { return (GRGEN_LIBGR.INode)_node_beg; } set { _node_beg = (GRGEN_LGSP.LGSPNode)value; } }
			public GRGEN_LIBGR.INode node__node0 { get { return (GRGEN_LIBGR.INode)_node__node0; } set { _node__node0 = (GRGEN_LGSP.LGSPNode)value; } }
			public GRGEN_LIBGR.INode node_end { get { return (GRGEN_LIBGR.INode)_node_end; } set { _node_end = (GRGEN_LGSP.LGSPNode)value; } }
			...
			public override IEnumerable<GRGEN_LIBGR.IMatch> Independents { get { return new GRGEN_LGSP.Independents_Enumerable(this); } }
			public override IEnumerator<GRGEN_LIBGR.IMatch> IndependentsEnumerator { get { return new GRGEN_LGSP.Independents_Enumerator(this); } }
			public override int NumberOfIndependents { get { return 2; } }
			public override GRGEN_LIBGR.IMatch getIndependentAt(int index)
			{
				switch(index) {
			...
			public override GRGEN_LIBGR.IPatternGraph Pattern { get { return Rule_findMultiNested.instance.pat_findMultiNested; } }
			public override GRGEN_LIBGR.IMatchClass MatchClass { get { return null; } }
			public override GRGEN_LIBGR.IMatch Clone() { return new Match_findMultiNested(this); }
			public override GRGEN_LIBGR.IMatch Clone(IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap) { return new Match_findMultiNested(this, oldToNewMap); }
			public void SetMatchOfEnclosingPattern(GRGEN_LIBGR.IMatch matchOfEnclosingPattern) { _matchOfEnclosingPattern = matchOfEnclosingPattern; }
			...
			public void AssignContent(Match_findMultiNested that, IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap)
			{
				_node_beg = (GRGEN_LGSP.LGSPNode)oldToNewMap[that._node_beg];
				_node__node0 = (GRGEN_LGSP.LGSPNode)oldToNewMap[that._node__node0];
				_node_end = (GRGEN_LGSP.LGSPNode)oldToNewMap[that._node_end];
				_edge__edge0 = (GRGEN_LGSP.LGSPEdge)oldToNewMap[that._edge__edge0];
				_edge__edge1 = (GRGEN_LGSP.LGSPEdge)oldToNewMap[that._edge__edge1];
				_idpt_0 = new Match_findMultiNested_idpt_0((Match_findMultiNested_idpt_0)that._idpt_0, oldToNewMap);
				_idpt_2 = new Match_findMultiNested_idpt_2((Match_findMultiNested_idpt_2)that._idpt_2, oldToNewMap);
			}

			public Match_findMultiNested(Match_findMultiNested that, IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap)
			{
				AssignContent(that, oldToNewMap);
			}
		...
		public class Match_findMultiNested_idpt_0 : GRGEN_LGSP.MatchListElement<Match_findMultiNested_idpt_0>, IMatch_findMultiNested_idpt_0
		{
			public GRGEN_LIBGR.INode node__node0 { get { return (GRGEN_LIBGR.INode)_node__node0; } set { _node__node0 = (GRGEN_LGSP.LGSPNode)value; } }
			public GRGEN_LIBGR.INode node_beg { get { return (GRGEN_LIBGR.INode)_node_beg; } set { _node_beg = (GRGEN_LGSP.LGSPNode)value; } }
			public GRGEN_LIBGR.INode node_end { get { return (GRGEN_LIBGR.INode)_node_end; } set { _node_end = (GRGEN_LGSP.LGSPNode)value; } }
			...
			public override GRGEN_LIBGR.IPatternGraph Pattern { get { return Rule_findMultiNested.instance.findMultiNested_idpt_0; } }
			public override GRGEN_LIBGR.IMatchClass MatchClass { get { return null; } }
			public override GRGEN_LIBGR.IMatch Clone() { return new Match_findMultiNested_idpt_0(this); }
			public override GRGEN_LIBGR.IMatch Clone(IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap) { return new Match_findMultiNested_idpt_0(this, oldToNewMap); }
			public void SetMatchOfEnclosingPattern(GRGEN_LIBGR.IMatch matchOfEnclosingPattern) { _matchOfEnclosingPattern = matchOfEnclosingPattern; }
			...
			public void AssignContent(Match_findMultiNested_idpt_0 that, IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap)
			{
				_node__node0 = (GRGEN_LGSP.LGSPNode)oldToNewMap[that._node__node0];
				_node_beg = (GRGEN_LGSP.LGSPNode)oldToNewMap[that._node_beg];
				_node_end = (GRGEN_LGSP.LGSPNode)oldToNewMap[that._node_end];
				_edge__edge0 = (GRGEN_LGSP.LGSPEdge)oldToNewMap[that._edge__edge0];
				_edge__edge1 = (GRGEN_LGSP.LGSPEdge)oldToNewMap[that._edge__edge1];
				_idpt_1 = new Match_findMultiNested_idpt_0_idpt_1((Match_findMultiNested_idpt_0_idpt_1)that._idpt_1, oldToNewMap);
			}

			public Match_findMultiNested_idpt_0(Match_findMultiNested_idpt_0 that, IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap)
			{
				AssignContent(that, oldToNewMap);
			}
		...
		public class Match_findMultiNested_idpt_0_idpt_1 : GRGEN_LGSP.MatchListElement<Match_findMultiNested_idpt_0_idpt_1>, IMatch_findMultiNested_idpt_0_idpt_1
		{
			public GRGEN_LIBGR.INode node_beg { get { return (GRGEN_LIBGR.INode)_node_beg; } set { _node_beg = (GRGEN_LGSP.LGSPNode)value; } }
			public GRGEN_LIBGR.INode node__node0 { get { return (GRGEN_LIBGR.INode)_node__node0; } set { _node__node0 = (GRGEN_LGSP.LGSPNode)value; } }
			public GRGEN_LIBGR.INode node_end { get { return (GRGEN_LIBGR.INode)_node_end; } set { _node_end = (GRGEN_LGSP.LGSPNode)value; } }
			...
			public override GRGEN_LIBGR.IPatternGraph Pattern { get { return Rule_findMultiNested.instance.findMultiNested_idpt_0_idpt_1; } }
			public override GRGEN_LIBGR.IMatchClass MatchClass { get { return null; } }
			public override GRGEN_LIBGR.IMatch Clone() { return new Match_findMultiNested_idpt_0_idpt_1(this); }
			public override GRGEN_LIBGR.IMatch Clone(IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap) { return new Match_findMultiNested_idpt_0_idpt_1(this, oldToNewMap); }
			public void SetMatchOfEnclosingPattern(GRGEN_LIBGR.IMatch matchOfEnclosingPattern) { _matchOfEnclosingPattern = matchOfEnclosingPattern; }
			...
			public void AssignContent(Match_findMultiNested_idpt_0_idpt_1 that, IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap)
			{
				_node_beg = (GRGEN_LGSP.LGSPNode)oldToNewMap[that._node_beg];
				_node__node0 = (GRGEN_LGSP.LGSPNode)oldToNewMap[that._node__node0];
				_node_end = (GRGEN_LGSP.LGSPNode)oldToNewMap[that._node_end];
			...
			public Match_findMultiNested_idpt_0_idpt_1(Match_findMultiNested_idpt_0_idpt_1 that, IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap)
			{
				AssignContent(that, oldToNewMap);
			}
		...
		public class Match_findMultiNested_idpt_2 : GRGEN_LGSP.MatchListElement<Match_findMultiNested_idpt_2>, IMatch_findMultiNested_idpt_2
		{
			public GRGEN_LIBGR.INode node_beg { get { return (GRGEN_LIBGR.INode)_node_beg; } set { _node_beg = (GRGEN_LGSP.LGSPNode)value; } }
			public GRGEN_LIBGR.INode node__node0 { get { return (GRGEN_LIBGR.INode)_node__node0; } set { _node__node0 = (GRGEN_LGSP.LGSPNode)value; } }
			public GRGEN_LIBGR.INode node_end { get { return (GRGEN_LIBGR.INode)_node_end; } set { _node_end = (GRGEN_LGSP.LGSPNode)value; } }
			...
			public override GRGEN_LIBGR.IPatternGraph Pattern { get { return Rule_findMultiNested.instance.findMultiNested_idpt_2; } }
			public override GRGEN_LIBGR.IMatchClass MatchClass { get { return null; } }
			public override GRGEN_LIBGR.IMatch Clone() { return new Match_findMultiNested_idpt_2(this); }
			public override GRGEN_LIBGR.IMatch Clone(IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap) { return new Match_findMultiNested_idpt_2(this, oldToNewMap); }
			public void SetMatchOfEnclosingPattern(GRGEN_LIBGR.IMatch matchOfEnclosingPattern) { _matchOfEnclosingPattern = matchOfEnclosingPattern; }
			...
			public void AssignContent(Match_findMultiNested_idpt_2 that, IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap)
			{
				_node_beg = (GRGEN_LGSP.LGSPNode)oldToNewMap[that._node_beg];
				_node__node0 = (GRGEN_LGSP.LGSPNode)oldToNewMap[that._node__node0];
				_node_end = (GRGEN_LGSP.LGSPNode)oldToNewMap[that._node_end];
				_edge__edge0 = (GRGEN_LGSP.LGSPEdge)oldToNewMap[that._edge__edge0];
				_edge__edge1 = (GRGEN_LGSP.LGSPEdge)oldToNewMap[that._edge__edge1];
				_idpt_3 = new Match_findMultiNested_idpt_2_idpt_3((Match_findMultiNested_idpt_2_idpt_3)that._idpt_3, oldToNewMap);
			}

			public Match_findMultiNested_idpt_2(Match_findMultiNested_idpt_2 that, IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap)
			{
				AssignContent(that, oldToNewMap);
			}
		...
		public class Match_findMultiNested_idpt_2_idpt_3 : GRGEN_LGSP.MatchListElement<Match_findMultiNested_idpt_2_idpt_3>, IMatch_findMultiNested_idpt_2_idpt_3
		{
			public GRGEN_LIBGR.INode node__node0 { get { return (GRGEN_LIBGR.INode)_node__node0; } set { _node__node0 = (GRGEN_LGSP.LGSPNode)value; } }
			public GRGEN_LIBGR.INode node_beg { get { return (GRGEN_LIBGR.INode)_node_beg; } set { _node_beg = (GRGEN_LGSP.LGSPNode)value; } }
			public GRGEN_LIBGR.INode node_end { get { return (GRGEN_LIBGR.INode)_node_end; } set { _node_end = (GRGEN_LGSP.LGSPNode)value; } }
			...
			public override GRGEN_LIBGR.IPatternGraph Pattern { get { return Rule_findMultiNested.instance.findMultiNested_idpt_2_idpt_3; } }
			public override GRGEN_LIBGR.IMatchClass MatchClass { get { return null; } }
			public override GRGEN_LIBGR.IMatch Clone() { return new Match_findMultiNested_idpt_2_idpt_3(this); }
			public override GRGEN_LIBGR.IMatch Clone(IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap) { return new Match_findMultiNested_idpt_2_idpt_3(this, oldToNewMap); }
			public void SetMatchOfEnclosingPattern(GRGEN_LIBGR.IMatch matchOfEnclosingPattern) { _matchOfEnclosingPattern = matchOfEnclosingPattern; }
			...
			public void AssignContent(Match_findMultiNested_idpt_2_idpt_3 that, IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap)
			{
				_node__node0 = (GRGEN_LGSP.LGSPNode)oldToNewMap[that._node__node0];
				_node_beg = (GRGEN_LGSP.LGSPNode)oldToNewMap[that._node_beg];
				_node_end = (GRGEN_LGSP.LGSPNode)oldToNewMap[that._node_end];
			...
			public Match_findMultiNested_idpt_2_idpt_3(Match_findMultiNested_idpt_2_idpt_3 that, IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap)
			{
				AssignContent(that, oldToNewMap);
			}
		...
		public class Extractor
		{
			public static List<GRGEN_LIBGR.INode> Extract_beg(List<IMatch_findMultiNested> matchList)
			{
				List<GRGEN_LIBGR.INode> resultList = new List<GRGEN_LIBGR.INode>(matchList.Count);
				foreach(IMatch_findMultiNested match in matchList)
					resultList.Add(match.node_beg);
				return resultList;
			}
			public static List<GRGEN_LIBGR.INode> Extract__node0(List<IMatch_findMultiNested> matchList)
			{
				List<GRGEN_LIBGR.INode> resultList = new List<GRGEN_LIBGR.INode>(matchList.Count);
				foreach(IMatch_findMultiNested match in matchList)
					resultList.Add(match.node__node0);
			...
			public static List<GRGEN_LIBGR.INode> Extract_end(List<IMatch_findMultiNested> matchList)
			{
				List<GRGEN_LIBGR.INode> resultList = new List<GRGEN_LIBGR.INode>(matchList.Count);
				foreach(IMatch_findMultiNested match in matchList)
					resultList.Add(match.node_end);
			...
			public static List<GRGEN_LIBGR.IDEdge> Extract__edge0(List<IMatch_findMultiNested> matchList)
			{
				List<GRGEN_LIBGR.IDEdge> resultList = new List<GRGEN_LIBGR.IDEdge>(matchList.Count);
				foreach(IMatch_findMultiNested match in matchList)
					resultList.Add(match.edge__edge0);
			...
			public static List<GRGEN_LIBGR.IDEdge> Extract__edge1(List<IMatch_findMultiNested> matchList)
			{
				List<GRGEN_LIBGR.IDEdge> resultList = new List<GRGEN_LIBGR.IDEdge>(matchList.Count);
				foreach(IMatch_findMultiNested match in matchList)
					resultList.Add(match.edge__edge1);
	...
	public partial class ArrayHelper
	{
		private static GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested instanceBearingAttributeForSearch_findMultiNested = new GRGEN_ACTIONS.Rule_findMultiNested.Match_findMultiNested();
		public static List<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested> Array_findMultiNested_groupBy_beg(List<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested> list)
		{
			Dictionary<GRGEN_LIBGR.INode, List<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested>> seenValues = new Dictionary<GRGEN_LIBGR.INode, List<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested>>();
			for(int pos = 0; pos < list.Count; ++pos)
			{
				if(seenValues.ContainsKey(list[pos].@node_beg)) {
					seenValues[list[pos].@node_beg].Add(list[pos]);
				} else {
					List<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested> tempList = new List<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested>();
					tempList.Add(list[pos]);
					seenValues.Add(list[pos].@node_beg, tempList);
				}
			}
			...
			foreach(List<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested> entry in seenValues.Values)
			{
				newList.AddRange(entry);
			}
			return newList;
		...
		public static int Array_findMultiNested_indexOfBy_beg(IList<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested> list, GRGEN_LIBGR.INode entry, int startIndex)
		{
			for(int i = startIndex; i < list.Count; ++i)
				if(list[i].@node_beg.Equals(entry))
					return i;
		...
		public static int Array_findMultiNested_indexOfBy_beg(IList<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested> list, GRGEN_LIBGR.INode entry)
		{
			for(int i = 0; i < list.Count; ++i)
				if(list[i].@node_beg.Equals(entry))
					return i;
		...
		public static int Array_findMultiNested_lastIndexOfBy_beg(IList<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested> list, GRGEN_LIBGR.INode entry, int startIndex)
		{
			for(int i = startIndex; i >= 0; --i)
				if(list[i].@node_beg.Equals(entry))
					return i;
		...
		public static int Array_findMultiNested_lastIndexOfBy_beg(IList<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested> list, GRGEN_LIBGR.INode entry)
		{
			for(int i = list.Count - 1; i >= 0; --i)
				if(list[i].@node_beg.Equals(entry))
					return i;
		...
		public static List<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested> Array_findMultiNested_groupBy__node0(List<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested> list)
		{
			Dictionary<GRGEN_LIBGR.INode, List<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested>> seenValues = new Dictionary<GRGEN_LIBGR.INode, List<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested>>();
			for(int pos = 0; pos < list.Count; ++pos)
			{
		...
		public static int Array_findMultiNested_indexOfBy__node0(IList<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested> list, GRGEN_LIBGR.INode entry, int startIndex)
		{
			for(int i = startIndex; i < list.Count; ++i)
				if(list[i].@node__node0.Equals(entry))
					return i;
		...
		public static int Array_findMultiNested_indexOfBy__node0(IList<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested> list, GRGEN_LIBGR.INode entry)
		{
			for(int i = 0; i < list.Count; ++i)
				if(list[i].@node__node0.Equals(entry))
					return i;
		...
		public static int Array_findMultiNested_lastIndexOfBy__node0(IList<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested> list, GRGEN_LIBGR.INode entry, int startIndex)
		{
			for(int i = startIndex; i >= 0; --i)
				if(list[i].@node__node0.Equals(entry))
					return i;
		...
		public static int Array_findMultiNested_lastIndexOfBy__node0(IList<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested> list, GRGEN_LIBGR.INode entry)
		{
			for(int i = list.Count - 1; i >= 0; --i)
				if(list[i].@node__node0.Equals(entry))
					return i;
		...
		public static List<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested> Array_findMultiNested_groupBy_end(List<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested> list)
		{
			Dictionary<GRGEN_LIBGR.INode, List<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested>> seenValues = new Dictionary<GRGEN_LIBGR.INode, List<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested>>();
			for(int pos = 0; pos < list.Count; ++pos)
			{
		...
		public static int Array_findMultiNested_indexOfBy_end(IList<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested> list, GRGEN_LIBGR.INode entry, int startIndex)
		{
			for(int i = startIndex; i < list.Count; ++i)
				if(list[i].@node_end.Equals(entry))
					return i;
		...
		public static int Array_findMultiNested_indexOfBy_end(IList<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested> list, GRGEN_LIBGR.INode entry)
		{
			for(int i = 0; i < list.Count; ++i)
				if(list[i].@node_end.Equals(entry))
					return i;
		...
		public static int Array_findMultiNested_lastIndexOfBy_end(IList<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested> list, GRGEN_LIBGR.INode entry, int startIndex)
		{
			for(int i = startIndex; i >= 0; --i)
				if(list[i].@node_end.Equals(entry))
					return i;
		...
		public static int Array_findMultiNested_lastIndexOfBy_end(IList<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested> list, GRGEN_LIBGR.INode entry)
		{
			for(int i = list.Count - 1; i >= 0; --i)
				if(list[i].@node_end.Equals(entry))
					return i;
		...
		public static List<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested> Array_findMultiNested_groupBy__edge0(List<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested> list)
		{
			Dictionary<GRGEN_LIBGR.IDEdge, List<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested>> seenValues = new Dictionary<GRGEN_LIBGR.IDEdge, List<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested>>();
			for(int pos = 0; pos < list.Count; ++pos)
			{
				if(seenValues.ContainsKey(list[pos].@edge__edge0)) {
					seenValues[list[pos].@edge__edge0].Add(list[pos]);
		...
		public static int Array_findMultiNested_indexOfBy__edge0(IList<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested> list, GRGEN_LIBGR.IDEdge entry, int startIndex)
		{
			for(int i = startIndex; i < list.Count; ++i)
				if(list[i].@edge__edge0.Equals(entry))
					return i;
		...
		public static int Array_findMultiNested_indexOfBy__edge0(IList<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested> list, GRGEN_LIBGR.IDEdge entry)
		{
			for(int i = 0; i < list.Count; ++i)
				if(list[i].@edge__edge0.Equals(entry))
					return i;
		...
		public static int Array_findMultiNested_lastIndexOfBy__edge0(IList<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested> list, GRGEN_LIBGR.IDEdge entry, int startIndex)
		{
			for(int i = startIndex; i >= 0; --i)
				if(list[i].@edge__edge0.Equals(entry))
					return i;
		...
		public static int Array_findMultiNested_lastIndexOfBy__edge0(IList<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested> list, GRGEN_LIBGR.IDEdge entry)
		{
			for(int i = list.Count - 1; i >= 0; --i)
				if(list[i].@edge__edge0.Equals(entry))
					return i;
		...
		public static List<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested> Array_findMultiNested_groupBy__edge1(List<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested> list)
		{
			Dictionary<GRGEN_LIBGR.IDEdge, List<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested>> seenValues = new Dictionary<GRGEN_LIBGR.IDEdge, List<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested>>();
			for(int pos = 0; pos < list.Count; ++pos)
			{
		...
		public static int Array_findMultiNested_indexOfBy__edge1(IList<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested> list, GRGEN_LIBGR.IDEdge entry, int startIndex)
		{
			for(int i = startIndex; i < list.Count; ++i)
				if(list[i].@edge__edge1.Equals(entry))
					return i;
		...
		public static int Array_findMultiNested_indexOfBy__edge1(IList<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested> list, GRGEN_LIBGR.IDEdge entry)
		{
			for(int i = 0; i < list.Count; ++i)
				if(list[i].@edge__edge1.Equals(entry))
					return i;
		...
		public static int Array_findMultiNested_lastIndexOfBy__edge1(IList<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested> list, GRGEN_LIBGR.IDEdge entry, int startIndex)
		{
			for(int i = startIndex; i >= 0; --i)
				if(list[i].@edge__edge1.Equals(entry))
					return i;
		...
		public static int Array_findMultiNested_lastIndexOfBy__edge1(IList<GRGEN_ACTIONS.Rule_findMultiNested.IMatch_findMultiNested> list, GRGEN_LIBGR.IDEdge entry)
		{
			for(int i = list.Count - 1; i >= 0; --i)
				if(list[i].@edge__edge1.Equals(entry))
					return i;
	...
	public class Rule_createIterated : GRGEN_LGSP.LGSPRulePattern
	{
		...
		private Rule_createIterated()
			: base("createIterated",
				...
				new GRGEN_LIBGR.MatchClassInfo[] { },
				"de.unika.ipd.grGen.Action_Independent.Rule_createIterated+IMatch_createIterated",
				"de.unika.ipd.grGen.Action_Independent.Rule_createIterated+Match_createIterated"
			)
		{
		}
		private void initialize()
		...
		public class Match_createIterated : GRGEN_LGSP.MatchListElement<Match_createIterated>, IMatch_createIterated
		{
			...
			public override GRGEN_LIBGR.IPatternGraph Pattern { get { return Rule_createIterated.instance.pat_createIterated; } }
			public override GRGEN_LIBGR.IMatchClass MatchClass { get { return null; } }
			public override GRGEN_LIBGR.IMatch Clone() { return new Match_createIterated(this); }
			public override GRGEN_LIBGR.IMatch Clone(IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap) { return new Match_createIterated(this, oldToNewMap); }
			public void SetMatchOfEnclosingPattern(GRGEN_LIBGR.IMatch matchOfEnclosingPattern) { _matchOfEnclosingPattern = matchOfEnclosingPattern; }
			...
			public void AssignContent(Match_createIterated that, IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap)
			{
			}

			public Match_createIterated(Match_createIterated that, IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap)
			{
				AssignContent(that, oldToNewMap);
			}
	...
	public partial class ArrayHelper
	{
		private static GRGEN_ACTIONS.Rule_createIterated.IMatch_createIterated instanceBearingAttributeForSearch_createIterated = new GRGEN_ACTIONS.Rule_createIterated.Match_createIterated();
	}
	...
	public class Rule_findChainPlusChainToInt : GRGEN_LGSP.LGSPRulePattern
	{
		...
		private Rule_findChainPlusChainToInt()
			: base("findChainPlusChainToInt",
				...
				new GRGEN_LIBGR.MatchClassInfo[] { },
				"de.unika.ipd.grGen.Action_Independent.Rule_findChainPlusChainToInt+IMatch_findChainPlusChainToInt",
				"de.unika.ipd.grGen.Action_Independent.Rule_findChainPlusChainToInt+Match_findChainPlusChainToInt"
			)
		{
		}
		private void initialize()
		{
			...
			GRGEN_LGSP.PatternGraphEmbedding findChainPlusChainToInt__sub0 = new GRGEN_LGSP.PatternGraphEmbedding("_sub0", Pattern_iteratedPath.Instance, 
				...
				new GRGEN_LGSP.PatternNode[] { findChainPlusChainToInt_node_beg, findChainPlusChainToInt_node_end }, new GRGEN_LGSP.PatternEdge[] {  }, new GRGEN_LGSP.PatternVariable[] {  });
			GRGEN_LGSP.PatternGraphEmbedding findChainPlusChainToInt__sub1 = new GRGEN_LGSP.PatternGraphEmbedding("_sub1", Pattern_iteratedPathToIntNode.Instance, 
				...
				new GRGEN_LGSP.PatternNode[] { findChainPlusChainToInt_node_end }, new GRGEN_LGSP.PatternEdge[] {  }, new GRGEN_LGSP.PatternVariable[] {  });
		...
		public void Modify(GRGEN_LGSP.LGSPActionExecutionEnvironment actionEnv, GRGEN_LIBGR.IMatch _curMatch)
		{
			...
			GRGEN_LGSP.LGSPNode node_end = curMatch._node_end;
			GRGEN_ACTIONS.Pattern_iteratedPath.Match_iteratedPath subpattern__sub0 = curMatch.@__sub0;
			GRGEN_ACTIONS.Pattern_iteratedPathToIntNode.Match_iteratedPathToIntNode subpattern__sub1 = curMatch.@__sub1;
			actionEnv.SelectedMatchRewritten();
			return;
		}
		...
		public interface IMatch_findChainPlusChainToInt : GRGEN_LIBGR.IMatch
		{
			...
			//EmbeddedGraphs
			@GRGEN_ACTIONS.Pattern_iteratedPath.Match_iteratedPath @_sub0 { get; }
			@GRGEN_ACTIONS.Pattern_iteratedPathToIntNode.Match_iteratedPathToIntNode @_sub1 { get; }
			//Alternatives
			//Iterateds
			//Independents
			// further match object stuff
		...
		public class Match_findChainPlusChainToInt : GRGEN_LGSP.MatchListElement<Match_findChainPlusChainToInt>, IMatch_findChainPlusChainToInt
		{
			public GRGEN_LIBGR.INode node_beg { get { return (GRGEN_LIBGR.INode)_node_beg; } set { _node_beg = (GRGEN_LGSP.LGSPNode)value; } }
			public GRGEN_LIBGR.INode node_end { get { return (GRGEN_LIBGR.INode)_node_end; } set { _node_end = (GRGEN_LGSP.LGSPNode)value; } }
			public GRGEN_LGSP.LGSPNode _node_beg;
			...
			public @GRGEN_ACTIONS.Pattern_iteratedPath.Match_iteratedPath @_sub0 { get { return @__sub0; } }
			public @GRGEN_ACTIONS.Pattern_iteratedPathToIntNode.Match_iteratedPathToIntNode @_sub1 { get { return @__sub1; } }
			public @GRGEN_ACTIONS.Pattern_iteratedPath.Match_iteratedPath @__sub0;
			public @GRGEN_ACTIONS.Pattern_iteratedPathToIntNode.Match_iteratedPathToIntNode @__sub1;
			...
			public override GRGEN_LIBGR.IPatternGraph Pattern { get { return Rule_findChainPlusChainToInt.instance.pat_findChainPlusChainToInt; } }
			public override GRGEN_LIBGR.IMatchClass MatchClass { get { return null; } }
			public override GRGEN_LIBGR.IMatch Clone() { return new Match_findChainPlusChainToInt(this); }
			public override GRGEN_LIBGR.IMatch Clone(IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap) { return new Match_findChainPlusChainToInt(this, oldToNewMap); }
			public void SetMatchOfEnclosingPattern(GRGEN_LIBGR.IMatch matchOfEnclosingPattern) { _matchOfEnclosingPattern = matchOfEnclosingPattern; }
			...
			public void AssignContent(Match_findChainPlusChainToInt that, IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap)
			{
				_node_beg = (GRGEN_LGSP.LGSPNode)oldToNewMap[that._node_beg];
				_node_end = (GRGEN_LGSP.LGSPNode)oldToNewMap[that._node_end];
				@__sub0 = new GRGEN_ACTIONS.Pattern_iteratedPath.Match_iteratedPath(that.@__sub0, oldToNewMap);
				@__sub1 = new GRGEN_ACTIONS.Pattern_iteratedPathToIntNode.Match_iteratedPathToIntNode(that.@__sub1, oldToNewMap);
			}

			public Match_findChainPlusChainToInt(Match_findChainPlusChainToInt that, IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap)
			{
				AssignContent(that, oldToNewMap);
			}
		...
		public class Extractor
		{
			public static List<GRGEN_LIBGR.INode> Extract_beg(List<IMatch_findChainPlusChainToInt> matchList)
			{
				List<GRGEN_LIBGR.INode> resultList = new List<GRGEN_LIBGR.INode>(matchList.Count);
				foreach(IMatch_findChainPlusChainToInt match in matchList)
					resultList.Add(match.node_beg);
				return resultList;
			}
			public static List<GRGEN_LIBGR.INode> Extract_end(List<IMatch_findChainPlusChainToInt> matchList)
			{
				List<GRGEN_LIBGR.INode> resultList = new List<GRGEN_LIBGR.INode>(matchList.Count);
				foreach(IMatch_findChainPlusChainToInt match in matchList)
					resultList.Add(match.node_end);
	...
	public partial class ArrayHelper
	{
		private static GRGEN_ACTIONS.Rule_findChainPlusChainToInt.IMatch_findChainPlusChainToInt instanceBearingAttributeForSearch_findChainPlusChainToInt = new GRGEN_ACTIONS.Rule_findChainPlusChainToInt.Match_findChainPlusChainToInt();
		public static List<GRGEN_ACTIONS.Rule_findChainPlusChainToInt.IMatch_findChainPlusChainToInt> Array_findChainPlusChainToInt_groupBy_beg(List<GRGEN_ACTIONS.Rule_findChainPlusChainToInt.IMatch_findChainPlusChainToInt> list)
		{
			Dictionary<GRGEN_LIBGR.INode, List<GRGEN_ACTIONS.Rule_findChainPlusChainToInt.IMatch_findChainPlusChainToInt>> seenValues = new Dictionary<GRGEN_LIBGR.INode, List<GRGEN_ACTIONS.Rule_findChainPlusChainToInt.IMatch_findChainPlusChainToInt>>();
			for(int pos = 0; pos < list.Count; ++pos)
			{
				if(seenValues.ContainsKey(list[pos].@node_beg)) {
					seenValues[list[pos].@node_beg].Add(list[pos]);
				} else {
					List<GRGEN_ACTIONS.Rule_findChainPlusChainToInt.IMatch_findChainPlusChainToInt> tempList = new List<GRGEN_ACTIONS.Rule_findChainPlusChainToInt.IMatch_findChainPlusChainToInt>();
					tempList.Add(list[pos]);
					seenValues.Add(list[pos].@node_beg, tempList);
				}
			}
			...
			foreach(List<GRGEN_ACTIONS.Rule_findChainPlusChainToInt.IMatch_findChainPlusChainToInt> entry in seenValues.Values)
			{
				newList.AddRange(entry);
			}
			return newList;
		...
		public static int Array_findChainPlusChainToInt_indexOfBy_beg(IList<GRGEN_ACTIONS.Rule_findChainPlusChainToInt.IMatch_findChainPlusChainToInt> list, GRGEN_LIBGR.INode entry, int startIndex)
		{
			for(int i = startIndex; i < list.Count; ++i)
				if(list[i].@node_beg.Equals(entry))
					return i;
		...
		public static int Array_findChainPlusChainToInt_indexOfBy_beg(IList<GRGEN_ACTIONS.Rule_findChainPlusChainToInt.IMatch_findChainPlusChainToInt> list, GRGEN_LIBGR.INode entry)
		{
			for(int i = 0; i < list.Count; ++i)
				if(list[i].@node_beg.Equals(entry))
					return i;
		...
		public static int Array_findChainPlusChainToInt_lastIndexOfBy_beg(IList<GRGEN_ACTIONS.Rule_findChainPlusChainToInt.IMatch_findChainPlusChainToInt> list, GRGEN_LIBGR.INode entry, int startIndex)
		{
			for(int i = startIndex; i >= 0; --i)
				if(list[i].@node_beg.Equals(entry))
					return i;
		...
		public static int Array_findChainPlusChainToInt_lastIndexOfBy_beg(IList<GRGEN_ACTIONS.Rule_findChainPlusChainToInt.IMatch_findChainPlusChainToInt> list, GRGEN_LIBGR.INode entry)
		{
			for(int i = list.Count - 1; i >= 0; --i)
				if(list[i].@node_beg.Equals(entry))
					return i;
		...
		public static List<GRGEN_ACTIONS.Rule_findChainPlusChainToInt.IMatch_findChainPlusChainToInt> Array_findChainPlusChainToInt_groupBy_end(List<GRGEN_ACTIONS.Rule_findChainPlusChainToInt.IMatch_findChainPlusChainToInt> list)
		{
			Dictionary<GRGEN_LIBGR.INode, List<GRGEN_ACTIONS.Rule_findChainPlusChainToInt.IMatch_findChainPlusChainToInt>> seenValues = new Dictionary<GRGEN_LIBGR.INode, List<GRGEN_ACTIONS.Rule_findChainPlusChainToInt.IMatch_findChainPlusChainToInt>>();
			for(int pos = 0; pos < list.Count; ++pos)
			{
		...
		public static int Array_findChainPlusChainToInt_indexOfBy_end(IList<GRGEN_ACTIONS.Rule_findChainPlusChainToInt.IMatch_findChainPlusChainToInt> list, GRGEN_LIBGR.INode entry, int startIndex)
		{
			for(int i = startIndex; i < list.Count; ++i)
				if(list[i].@node_end.Equals(entry))
					return i;
		...
		public static int Array_findChainPlusChainToInt_indexOfBy_end(IList<GRGEN_ACTIONS.Rule_findChainPlusChainToInt.IMatch_findChainPlusChainToInt> list, GRGEN_LIBGR.INode entry)
		{
			for(int i = 0; i < list.Count; ++i)
				if(list[i].@node_end.Equals(entry))
					return i;
		...
		public static int Array_findChainPlusChainToInt_lastIndexOfBy_end(IList<GRGEN_ACTIONS.Rule_findChainPlusChainToInt.IMatch_findChainPlusChainToInt> list, GRGEN_LIBGR.INode entry, int startIndex)
		{
			for(int i = startIndex; i >= 0; --i)
				if(list[i].@node_end.Equals(entry))
					return i;
		...
		public static int Array_findChainPlusChainToInt_lastIndexOfBy_end(IList<GRGEN_ACTIONS.Rule_findChainPlusChainToInt.IMatch_findChainPlusChainToInt> list, GRGEN_LIBGR.INode entry)
		{
			for(int i = list.Count - 1; i >= 0; --i)
				if(list[i].@node_end.Equals(entry))
					return i;
	...
	public class Rule_findChainPlusChainToIntIndependent : GRGEN_LGSP.LGSPRulePattern
	{
		...
		private Rule_findChainPlusChainToIntIndependent()
			: base("findChainPlusChainToIntIndependent",
				...
				new GRGEN_LIBGR.MatchClassInfo[] { },
				"de.unika.ipd.grGen.Action_Independent.Rule_findChainPlusChainToIntIndependent+IMatch_findChainPlusChainToIntIndependent",
				"de.unika.ipd.grGen.Action_Independent.Rule_findChainPlusChainToIntIndependent+Match_findChainPlusChainToIntIndependent"
			)
		{
		}
		private void initialize()
		{
			...
			GRGEN_LGSP.PatternGraphEmbedding findChainPlusChainToIntIndependent__sub0 = new GRGEN_LGSP.PatternGraphEmbedding("_sub0", Pattern_iteratedPath.Instance, 
				...
				new GRGEN_LGSP.PatternNode[] { findChainPlusChainToIntIndependent_node_beg, findChainPlusChainToIntIndependent_node_end }, new GRGEN_LGSP.PatternEdge[] {  }, new GRGEN_LGSP.PatternVariable[] {  });
			...
			GRGEN_LGSP.PatternGraphEmbedding findChainPlusChainToIntIndependent_idpt_0__sub0 = new GRGEN_LGSP.PatternGraphEmbedding("_sub0", Pattern_iteratedPathToIntNode.Instance, 
				...
				new GRGEN_LGSP.PatternNode[] { findChainPlusChainToIntIndependent_node_end }, new GRGEN_LGSP.PatternEdge[] {  }, new GRGEN_LGSP.PatternVariable[] {  });
		...
		public class Match_findChainPlusChainToIntIndependent : GRGEN_LGSP.MatchListElement<Match_findChainPlusChainToIntIndependent>, IMatch_findChainPlusChainToIntIndependent
		{
			public GRGEN_LIBGR.INode node_beg { get { return (GRGEN_LIBGR.INode)_node_beg; } set { _node_beg = (GRGEN_LGSP.LGSPNode)value; } }
			public GRGEN_LIBGR.INode node_end { get { return (GRGEN_LIBGR.INode)_node_end; } set { _node_end = (GRGEN_LGSP.LGSPNode)value; } }
			public GRGEN_LGSP.LGSPNode _node_beg;
			...
			public override GRGEN_LIBGR.IPatternGraph Pattern { get { return Rule_findChainPlusChainToIntIndependent.instance.pat_findChainPlusChainToIntIndependent; } }
			public override GRGEN_LIBGR.IMatchClass MatchClass { get { return null; } }
			public override GRGEN_LIBGR.IMatch Clone() { return new Match_findChainPlusChainToIntIndependent(this); }
			public override GRGEN_LIBGR.IMatch Clone(IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap) { return new Match_findChainPlusChainToIntIndependent(this, oldToNewMap); }
			public void SetMatchOfEnclosingPattern(GRGEN_LIBGR.IMatch matchOfEnclosingPattern) { _matchOfEnclosingPattern = matchOfEnclosingPattern; }
			...
			public void AssignContent(Match_findChainPlusChainToIntIndependent that, IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap)
			{
				_node_beg = (GRGEN_LGSP.LGSPNode)oldToNewMap[that._node_beg];
				_node_end = (GRGEN_LGSP.LGSPNode)oldToNewMap[that._node_end];
				@__sub0 = new GRGEN_ACTIONS.Pattern_iteratedPath.Match_iteratedPath(that.@__sub0, oldToNewMap);
				_idpt_0 = new Match_findChainPlusChainToIntIndependent_idpt_0((Match_findChainPlusChainToIntIndependent_idpt_0)that._idpt_0, oldToNewMap);
			}

			public Match_findChainPlusChainToIntIndependent(Match_findChainPlusChainToIntIndependent that, IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap)
			{
				AssignContent(that, oldToNewMap);
			}
		...
		public class Match_findChainPlusChainToIntIndependent_idpt_0 : GRGEN_LGSP.MatchListElement<Match_findChainPlusChainToIntIndependent_idpt_0>, IMatch_findChainPlusChainToIntIndependent_idpt_0
		{
			public GRGEN_LIBGR.INode node_end { get { return (GRGEN_LIBGR.INode)_node_end; } set { _node_end = (GRGEN_LGSP.LGSPNode)value; } }
			public GRGEN_LGSP.LGSPNode _node_end;
			...
			public override GRGEN_LIBGR.IPatternGraph Pattern { get { return Rule_findChainPlusChainToIntIndependent.instance.findChainPlusChainToIntIndependent_idpt_0; } }
			public override GRGEN_LIBGR.IMatchClass MatchClass { get { return null; } }
			public override GRGEN_LIBGR.IMatch Clone() { return new Match_findChainPlusChainToIntIndependent_idpt_0(this); }
			public override GRGEN_LIBGR.IMatch Clone(IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap) { return new Match_findChainPlusChainToIntIndependent_idpt_0(this, oldToNewMap); }
			public void SetMatchOfEnclosingPattern(GRGEN_LIBGR.IMatch matchOfEnclosingPattern) { _matchOfEnclosingPattern = matchOfEnclosingPattern; }
			...
			public void AssignContent(Match_findChainPlusChainToIntIndependent_idpt_0 that, IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap)
			{
				_node_end = (GRGEN_LGSP.LGSPNode)oldToNewMap[that._node_end];
				@__sub0 = new GRGEN_ACTIONS.Pattern_iteratedPathToIntNode.Match_iteratedPathToIntNode(that.@__sub0, oldToNewMap);
			}

			public Match_findChainPlusChainToIntIndependent_idpt_0(Match_findChainPlusChainToIntIndependent_idpt_0 that, IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap)
			{
				AssignContent(that, oldToNewMap);
			}
		...
		public class Extractor
		{
			public static List<GRGEN_LIBGR.INode> Extract_beg(List<IMatch_findChainPlusChainToIntIndependent> matchList)
			{
				List<GRGEN_LIBGR.INode> resultList = new List<GRGEN_LIBGR.INode>(matchList.Count);
				foreach(IMatch_findChainPlusChainToIntIndependent match in matchList)
					resultList.Add(match.node_beg);
				return resultList;
			}
			public static List<GRGEN_LIBGR.INode> Extract_end(List<IMatch_findChainPlusChainToIntIndependent> matchList)
			{
				List<GRGEN_LIBGR.INode> resultList = new List<GRGEN_LIBGR.INode>(matchList.Count);
				foreach(IMatch_findChainPlusChainToIntIndependent match in matchList)
					resultList.Add(match.node_end);
	...
	public partial class ArrayHelper
	{
		private static GRGEN_ACTIONS.Rule_findChainPlusChainToIntIndependent.IMatch_findChainPlusChainToIntIndependent instanceBearingAttributeForSearch_findChainPlusChainToIntIndependent = new GRGEN_ACTIONS.Rule_findChainPlusChainToIntIndependent.Match_findChainPlusChainToIntIndependent();
		public static List<GRGEN_ACTIONS.Rule_findChainPlusChainToIntIndependent.IMatch_findChainPlusChainToIntIndependent> Array_findChainPlusChainToIntIndependent_groupBy_beg(List<GRGEN_ACTIONS.Rule_findChainPlusChainToIntIndependent.IMatch_findChainPlusChainToIntIndependent> list)
		{
			Dictionary<GRGEN_LIBGR.INode, List<GRGEN_ACTIONS.Rule_findChainPlusChainToIntIndependent.IMatch_findChainPlusChainToIntIndependent>> seenValues = new Dictionary<GRGEN_LIBGR.INode, List<GRGEN_ACTIONS.Rule_findChainPlusChainToIntIndependent.IMatch_findChainPlusChainToIntIndependent>>();
			for(int pos = 0; pos < list.Count; ++pos)
			{
				if(seenValues.ContainsKey(list[pos].@node_beg)) {
					seenValues[list[pos].@node_beg].Add(list[pos]);
				} else {
					List<GRGEN_ACTIONS.Rule_findChainPlusChainToIntIndependent.IMatch_findChainPlusChainToIntIndependent> tempList = new List<GRGEN_ACTIONS.Rule_findChainPlusChainToIntIndependent.IMatch_findChainPlusChainToIntIndependent>();
					tempList.Add(list[pos]);
					seenValues.Add(list[pos].@node_beg, tempList);
				}
			}
			...
			foreach(List<GRGEN_ACTIONS.Rule_findChainPlusChainToIntIndependent.IMatch_findChainPlusChainToIntIndependent> entry in seenValues.Values)
			{
				newList.AddRange(entry);
			}
			return newList;
		...
		public static int Array_findChainPlusChainToIntIndependent_indexOfBy_beg(IList<GRGEN_ACTIONS.Rule_findChainPlusChainToIntIndependent.IMatch_findChainPlusChainToIntIndependent> list, GRGEN_LIBGR.INode entry, int startIndex)
		{
			for(int i = startIndex; i < list.Count; ++i)
				if(list[i].@node_beg.Equals(entry))
					return i;
		...
		public static int Array_findChainPlusChainToIntIndependent_indexOfBy_beg(IList<GRGEN_ACTIONS.Rule_findChainPlusChainToIntIndependent.IMatch_findChainPlusChainToIntIndependent> list, GRGEN_LIBGR.INode entry)
		{
			for(int i = 0; i < list.Count; ++i)
				if(list[i].@node_beg.Equals(entry))
					return i;
		...
		public static int Array_findChainPlusChainToIntIndependent_lastIndexOfBy_beg(IList<GRGEN_ACTIONS.Rule_findChainPlusChainToIntIndependent.IMatch_findChainPlusChainToIntIndependent> list, GRGEN_LIBGR.INode entry, int startIndex)
		{
			for(int i = startIndex; i >= 0; --i)
				if(list[i].@node_beg.Equals(entry))
					return i;
		...
		public static int Array_findChainPlusChainToIntIndependent_lastIndexOfBy_beg(IList<GRGEN_ACTIONS.Rule_findChainPlusChainToIntIndependent.IMatch_findChainPlusChainToIntIndependent> list, GRGEN_LIBGR.INode entry)
		{
			for(int i = list.Count - 1; i >= 0; --i)
				if(list[i].@node_beg.Equals(entry))
					return i;
		...
		public static List<GRGEN_ACTIONS.Rule_findChainPlusChainToIntIndependent.IMatch_findChainPlusChainToIntIndependent> Array_findChainPlusChainToIntIndependent_groupBy_end(List<GRGEN_ACTIONS.Rule_findChainPlusChainToIntIndependent.IMatch_findChainPlusChainToIntIndependent> list)
		{
			Dictionary<GRGEN_LIBGR.INode, List<GRGEN_ACTIONS.Rule_findChainPlusChainToIntIndependent.IMatch_findChainPlusChainToIntIndependent>> seenValues = new Dictionary<GRGEN_LIBGR.INode, List<GRGEN_ACTIONS.Rule_findChainPlusChainToIntIndependent.IMatch_findChainPlusChainToIntIndependent>>();
			for(int pos = 0; pos < list.Count; ++pos)
			{
		...
		public static int Array_findChainPlusChainToIntIndependent_indexOfBy_end(IList<GRGEN_ACTIONS.Rule_findChainPlusChainToIntIndependent.IMatch_findChainPlusChainToIntIndependent> list, GRGEN_LIBGR.INode entry, int startIndex)
		{
			for(int i = startIndex; i < list.Count; ++i)
				if(list[i].@node_end.Equals(entry))
					return i;
		...
		public static int Array_findChainPlusChainToIntIndependent_indexOfBy_end(IList<GRGEN_ACTIONS.Rule_findChainPlusChainToIntIndependent.IMatch_findChainPlusChainToIntIndependent> list, GRGEN_LIBGR.INode entry)
		{
			for(int i = 0; i < list.Count; ++i)
				if(list[i].@node_end.Equals(entry))
					return i;
		...
		public static int Array_findChainPlusChainToIntIndependent_lastIndexOfBy_end(IList<GRGEN_ACTIONS.Rule_findChainPlusChainToIntIndependent.IMatch_findChainPlusChainToIntIndependent> list, GRGEN_LIBGR.INode entry, int startIndex)
		{
			for(int i = startIndex; i >= 0; --i)
				if(list[i].@node_end.Equals(entry))
					return i;
		...
		public static int Array_findChainPlusChainToIntIndependent_lastIndexOfBy_end(IList<GRGEN_ACTIONS.Rule_findChainPlusChainToIntIndependent.IMatch_findChainPlusChainToIntIndependent> list, GRGEN_LIBGR.INode entry)
		{
			for(int i = list.Count - 1; i >= 0; --i)
				if(list[i].@node_end.Equals(entry))
					return i;
            ...
            do {
                ...
                if(head_candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0 != null)
                {
                    ...
                    do
                    {
                        ...
                        PatternAction_iteratedPathToIntNode taskFor__sub0 = PatternAction_iteratedPathToIntNode.getNewTask(actionEnv, openTasks);
    ...
    public class Action_create : GRGEN_LGSP.LGSPAction, GRGEN_LIBGR.IAction, IAction_create
    {
        public Action_create()
            : base(Rule_create.Instance.patternGraph)
        {
        ...
        [ThreadStatic] private static GRGEN_LGSP.LGSPMatchesList<Rule_create.Match_create, Rule_create.IMatch_create> matches;
    ...
    {
        public Action_find()
            : base(Rule_find.Instance.patternGraph)
        {
        ...
        [ThreadStatic] private static GRGEN_LGSP.LGSPMatchesList<Rule_find.Match_find, Rule_find.IMatch_find> matches;
    ...
    public class Action_findIndependent : GRGEN_LGSP.LGSPAction, GRGEN_LIBGR.IAction, IAction_findIndependent
    {
        public Action_findIndependent()
            : base(Rule_findIndependent.Instance.patternGraph)
        {
        ...
        [ThreadStatic] private static GRGEN_LGSP.LGSPMatchesList<Rule_findIndependent.Match_findIndependent, Rule_findIndependent.IMatch_findIndependent> matches;
...
label2: ;
    ...
    public class Action_findMultiNested : GRGEN_LGSP.LGSPAction, GRGEN_LIBGR.IAction, IAction_findMultiNested
    {
        public Action_findMultiNested()
            : base(Rule_findMultiNested.Instance.patternGraph)
        {
        ...
        [ThreadStatic] private static GRGEN_LGSP.LGSPMatchesList<Rule_findMultiNested.Match_findMultiNested, Rule_findMultiNested.IMatch_findMultiNested> matches;
...
label14: ;
    ...
    public class Action_createIterated : GRGEN_LGSP.LGSPAction, GRGEN_LIBGR.IAction, IAction_createIterated
    {
        public Action_createIterated()
            : base(Rule_createIterated.Instance.patternGraph)
        {
        ...
        [ThreadStatic] private static GRGEN_LGSP.LGSPMatchesList<Rule_createIterated.Match_createIterated, Rule_createIterated.IMatch_createIterated> matches;
    ...
    public class Action_findChainPlusChainToInt : GRGEN_LGSP.LGSPAction, GRGEN_LIBGR.IAction, IAction_findChainPlusChainToInt
    {
        public Action_findChainPlusChainToInt()
            : base(Rule_findChainPlusChainToInt.Instance.patternGraph)
        {
        ...
        [ThreadStatic] private static GRGEN_LGSP.LGSPMatchesList<Rule_findChainPlusChainToInt.Match_findChainPlusChainToInt, Rule_findChainPlusChainToInt.IMatch_findChainPlusChainToInt> matches;
        ...
        public GRGEN_LIBGR.IMatchesExact<Rule_findChainPlusChainToInt.IMatch_findChainPlusChainToInt> myMatch(GRGEN_LGSP.LGSPActionExecutionEnvironment actionEnv, int maxMatches, GRGEN_LIBGR.INode findChainPlusChainToInt_node_beg, GRGEN_LIBGR.INode findChainPlusChainToInt_node_end)
        {
            ...
            // Element iteratedPathToIntNode_node_beg_inlined__sub1_2 assigned from other element findChainPlusChainToInt_node_end 
            GRGEN_LGSP.LGSPNode candidate_iteratedPathToIntNode_node_beg_inlined__sub1_2 = candidate_findChainPlusChainToInt_node_end;
            // Element iteratedPath_node_end_inlined__sub0_1 assigned from other element findChainPlusChainToInt_node_end 
            GRGEN_LGSP.LGSPNode candidate_iteratedPath_node_end_inlined__sub0_1 = candidate_findChainPlusChainToInt_node_end;
            // Element iteratedPath_node_beg_inlined__sub0_1 assigned from other element findChainPlusChainToInt_node_beg 
            GRGEN_LGSP.LGSPNode candidate_iteratedPath_node_beg_inlined__sub0_1 = candidate_findChainPlusChainToInt_node_beg;
            // Push alternative matching task for findChainPlusChainToInt_alt_0_inlined__sub1_2_in_findChainPlusChainToInt
            AlternativeAction_findChainPlusChainToInt_alt_0_inlined__sub1_2_in_findChainPlusChainToInt taskFor_alt_0_inlined__sub1_2_in_findChainPlusChainToInt = AlternativeAction_findChainPlusChainToInt_alt_0_inlined__sub1_2_in_findChainPlusChainToInt.getNewTask(actionEnv, openTasks, Pattern_iteratedPathToIntNode.Instance.patternGraph.alternatives[(int)Pattern_iteratedPathToIntNode.iteratedPathToIntNode_AltNums.@alt_0].alternativeCases);
            taskFor_alt_0_inlined__sub1_2_in_findChainPlusChainToInt.iteratedPathToIntNode_node_beg_inlined__sub1_2 = candidate_iteratedPathToIntNode_node_beg_inlined__sub1_2;
            taskFor_alt_0_inlined__sub1_2_in_findChainPlusChainToInt.searchPatternpath = false;
            taskFor_alt_0_inlined__sub1_2_in_findChainPlusChainToInt.matchOfNestingPattern = null;
            taskFor_alt_0_inlined__sub1_2_in_findChainPlusChainToInt.lastMatchAtPreviousNestingLevel = null;
            openTasks.Push(taskFor_alt_0_inlined__sub1_2_in_findChainPlusChainToInt);
            // Push alternative matching task for findChainPlusChainToInt_alt_0_inlined__sub0_1_in_findChainPlusChainToInt
            AlternativeAction_findChainPlusChainToInt_alt_0_inlined__sub0_1_in_findChainPlusChainToInt taskFor_alt_0_inlined__sub0_1_in_findChainPlusChainToInt = AlternativeAction_findChainPlusChainToInt_alt_0_inlined__sub0_1_in_findChainPlusChainToInt.getNewTask(actionEnv, openTasks, Pattern_iteratedPath.Instance.patternGraph.alternatives[(int)Pattern_iteratedPath.iteratedPath_AltNums.@alt_0].alternativeCases);
            taskFor_alt_0_inlined__sub0_1_in_findChainPlusChainToInt.iteratedPath_node_beg_inlined__sub0_1 = candidate_iteratedPath_node_beg_inlined__sub0_1;
            taskFor_alt_0_inlined__sub0_1_in_findChainPlusChainToInt.iteratedPath_node_end_inlined__sub0_1 = candidate_iteratedPath_node_end_inlined__sub0_1;
            taskFor_alt_0_inlined__sub0_1_in_findChainPlusChainToInt.searchPatternpath = false;
            taskFor_alt_0_inlined__sub0_1_in_findChainPlusChainToInt.matchOfNestingPattern = null;
            taskFor_alt_0_inlined__sub0_1_in_findChainPlusChainToInt.lastMatchAtPreviousNestingLevel = null;
            openTasks.Push(taskFor_alt_0_inlined__sub0_1_in_findChainPlusChainToInt);
            ...
            // Match subpatterns 
            openTasks.Peek().myMatch(matchesList, maxMatches - foundPartialMatches.Count, isoSpace);
            // Pop alternative matching task for findChainPlusChainToInt_alt_0_inlined__sub0_1_in_findChainPlusChainToInt
            openTasks.Pop();
            AlternativeAction_findChainPlusChainToInt_alt_0_inlined__sub0_1_in_findChainPlusChainToInt.releaseTask(taskFor_alt_0_inlined__sub0_1_in_findChainPlusChainToInt);
            // Pop alternative matching task for findChainPlusChainToInt_alt_0_inlined__sub1_2_in_findChainPlusChainToInt
            openTasks.Pop();
            AlternativeAction_findChainPlusChainToInt_alt_0_inlined__sub1_2_in_findChainPlusChainToInt.releaseTask(taskFor_alt_0_inlined__sub1_2_in_findChainPlusChainToInt);
            // Check whether subpatterns were found 
            if(matchesList.Count>0) {
                ...
                foreach(Stack<GRGEN_LIBGR.IMatch> currentFoundPartialMatch in matchesList)
                {
                    ...
                    match__sub0._node_beg = candidate_iteratedPath_node_beg_inlined__sub0_1;
                    match__sub0._node_end = candidate_iteratedPath_node_end_inlined__sub0_1;
                    match__sub1._node_beg = candidate_iteratedPathToIntNode_node_beg_inlined__sub1_2;
                    match.__sub0 = match__sub0;
    ...
    public class AlternativeAction_findChainPlusChainToInt_alt_0_inlined__sub0_1_in_findChainPlusChainToInt : GRGEN_LGSP.LGSPSubpatternAction
    {
        private AlternativeAction_findChainPlusChainToInt_alt_0_inlined__sub0_1_in_findChainPlusChainToInt(GRGEN_LGSP.LGSPActionExecutionEnvironment actionEnv_, Stack<GRGEN_LGSP.LGSPSubpatternAction> openTasks_, GRGEN_LGSP.PatternGraph[] patternGraphs_)
            : base(patternGraphs_)
        {
            actionEnv = actionEnv_; openTasks = openTasks_;
        }

        public static AlternativeAction_findChainPlusChainToInt_alt_0_inlined__sub0_1_in_findChainPlusChainToInt getNewTask(GRGEN_LGSP.LGSPActionExecutionEnvironment actionEnv_, Stack<GRGEN_LGSP.LGSPSubpatternAction> openTasks_, GRGEN_LGSP.PatternGraph[] patternGraphs_) {
            AlternativeAction_findChainPlusChainToInt_alt_0_inlined__sub0_1_in_findChainPlusChainToInt newTask;
            if(numFreeTasks>0) {
                newTask = freeListHead;
                newTask.actionEnv = actionEnv_; newTask.openTasks = openTasks_;
                freeListHead = newTask.next;
                ...
                newTask = new AlternativeAction_findChainPlusChainToInt_alt_0_inlined__sub0_1_in_findChainPlusChainToInt(actionEnv_, openTasks_, patternGraphs_);
            }
            return newTask;
        }

        public static void releaseTask(AlternativeAction_findChainPlusChainToInt_alt_0_inlined__sub0_1_in_findChainPlusChainToInt oldTask) {
            if(numFreeTasks<MAX_NUM_FREE_TASKS) {
                oldTask.next = freeListHead;
                oldTask.actionEnv = null; oldTask.openTasks = null;
                freeListHead = oldTask;
        ...
        private static AlternativeAction_findChainPlusChainToInt_alt_0_inlined__sub0_1_in_findChainPlusChainToInt freeListHead = null;
        private static int numFreeTasks = 0;
        private const int MAX_NUM_FREE_TASKS = 100;

        private AlternativeAction_findChainPlusChainToInt_alt_0_inlined__sub0_1_in_findChainPlusChainToInt next = null;

        public GRGEN_LGSP.LGSPNode iteratedPath_node_beg_inlined__sub0_1;
        public GRGEN_LGSP.LGSPNode iteratedPath_node_end_inlined__sub0_1;
        ...
        public override void myMatch(List<Stack<GRGEN_LIBGR.IMatch>> foundPartialMatches, int maxMatches, int isoSpace)
        {
            ...
            do {
                patternGraph = patternGraphs[(int)Pattern_iteratedPath.iteratedPath_alt_0_CaseNums.@base];
                // SubPreset iteratedPath_node_beg_inlined__sub0_1 
                GRGEN_LGSP.LGSPNode candidate_iteratedPath_node_beg_inlined__sub0_1 = iteratedPath_node_beg_inlined__sub0_1;
                // SubPreset iteratedPath_node_end_inlined__sub0_1 
                GRGEN_LGSP.LGSPNode candidate_iteratedPath_node_end_inlined__sub0_1 = iteratedPath_node_end_inlined__sub0_1;
                // Extend Outgoing iteratedPath_alt_0_base_edge__edge0_inlined__sub0_1 from iteratedPath_node_beg_inlined__sub0_1 
                GRGEN_LGSP.LGSPEdge head_candidate_iteratedPath_alt_0_base_edge__edge0_inlined__sub0_1 = candidate_iteratedPath_node_beg_inlined__sub0_1.lgspOuthead;
                if(head_candidate_iteratedPath_alt_0_base_edge__edge0_inlined__sub0_1 != null)
                {
                    GRGEN_LGSP.LGSPEdge candidate_iteratedPath_alt_0_base_edge__edge0_inlined__sub0_1 = head_candidate_iteratedPath_alt_0_base_edge__edge0_inlined__sub0_1;
                    do
                    {
                        if(candidate_iteratedPath_alt_0_base_edge__edge0_inlined__sub0_1.lgspType.TypeID!=1) {
                            continue;
                        }
                        if(candidate_iteratedPath_alt_0_base_edge__edge0_inlined__sub0_1.lgspTarget != candidate_iteratedPath_node_end_inlined__sub0_1) {
                            continue;
                        }
                        if((candidate_iteratedPath_alt_0_base_edge__edge0_inlined__sub0_1.lgspFlags & (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace)==(uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace)
                        {
                            continue;
                        }
                        // Check whether there are subpattern matching tasks left to execute
                        if(openTasks.Count==0)
                        {
                            ...
                            foundPartialMatches.Add(currentFoundPartialMatch);
                            Pattern_iteratedPath.Match_iteratedPath_alt_0_base match = new Pattern_iteratedPath.Match_iteratedPath_alt_0_base();
                            match._node_beg = candidate_iteratedPath_node_beg_inlined__sub0_1;
                            match._node_end = candidate_iteratedPath_node_end_inlined__sub0_1;
                            match._edge__edge0 = candidate_iteratedPath_alt_0_base_edge__edge0_inlined__sub0_1;
                            currentFoundPartialMatch.Push(match);
                            // if enough matches were found, we leave
                            if(maxMatches > 0 && foundPartialMatches.Count >= maxMatches)
                            {
                        ...
                        uint prevGlobal__candidate_iteratedPath_alt_0_base_edge__edge0_inlined__sub0_1;
                        prevGlobal__candidate_iteratedPath_alt_0_base_edge__edge0_inlined__sub0_1 = candidate_iteratedPath_alt_0_base_edge__edge0_inlined__sub0_1.lgspFlags & (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace;
                        candidate_iteratedPath_alt_0_base_edge__edge0_inlined__sub0_1.lgspFlags |= (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace;
                        // Match subpatterns 
                        openTasks.Peek().myMatch(matchesList, maxMatches - foundPartialMatches.Count, isoSpace);
                        // Check whether subpatterns were found 
                        if(matchesList.Count>0) {
                            ...
                            if(maxMatches > 0 && foundPartialMatches.Count >= maxMatches)
                            {
                                candidate_iteratedPath_alt_0_base_edge__edge0_inlined__sub0_1.lgspFlags = candidate_iteratedPath_alt_0_base_edge__edge0_inlined__sub0_1.lgspFlags & ~((uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace) | prevGlobal__candidate_iteratedPath_alt_0_base_edge__edge0_inlined__sub0_1;
                                openTasks.Push(this);
                                return;
                            }
                            candidate_iteratedPath_alt_0_base_edge__edge0_inlined__sub0_1.lgspFlags = candidate_iteratedPath_alt_0_base_edge__edge0_inlined__sub0_1.lgspFlags & ~((uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace) | prevGlobal__candidate_iteratedPath_alt_0_base_edge__edge0_inlined__sub0_1;
                    ...
                    while( (candidate_iteratedPath_alt_0_base_edge__edge0_inlined__sub0_1 = candidate_iteratedPath_alt_0_base_edge__edge0_inlined__sub0_1.lgspOutNext) != head_candidate_iteratedPath_alt_0_base_edge__edge0_inlined__sub0_1 );
                }
            } while(false);
            if(matchesList.Count>0) {
                if(matchesList==foundPartialMatches) {
            ...
            do {
                ...
                // SubPreset iteratedPath_node_end_inlined__sub0_1 
                GRGEN_LGSP.LGSPNode candidate_iteratedPath_node_end_inlined__sub0_1 = iteratedPath_node_end_inlined__sub0_1;
                // Extend Outgoing iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_1 from iteratedPath_node_beg_inlined__sub0_1 
                GRGEN_LGSP.LGSPEdge head_candidate_iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_1 = candidate_iteratedPath_node_beg_inlined__sub0_1.lgspOuthead;
                if(head_candidate_iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_1 != null)
                {
                    GRGEN_LGSP.LGSPEdge candidate_iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_1 = head_candidate_iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_1;
                    do
                    {
                        if(candidate_iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_1.lgspType.TypeID!=1) {
                            continue;
                        }
                        if((candidate_iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_1.lgspFlags & (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace)==(uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace)
                        {
                            continue;
                        }
                        // Implicit Target iteratedPath_alt_0_recursive_node_intermediate_inlined__sub0_1 from iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_1 
                        GRGEN_LGSP.LGSPNode candidate_iteratedPath_alt_0_recursive_node_intermediate_inlined__sub0_1 = candidate_iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_1.lgspTarget;
                        if((candidate_iteratedPath_alt_0_recursive_node_intermediate_inlined__sub0_1.lgspFlags & (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED << isoSpace) != 0
                            && candidate_iteratedPath_alt_0_recursive_node_intermediate_inlined__sub0_1==candidate_iteratedPath_node_beg_inlined__sub0_1
                            )
                        {
                            continue;
                        }
                        if((candidate_iteratedPath_alt_0_recursive_node_intermediate_inlined__sub0_1.lgspFlags & (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace)==(uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace)
                        {
                            continue;
                        }
                        // Push subpattern matching task for _sub0_inlined__sub0_1
                        PatternAction_iteratedPath taskFor__sub0_inlined__sub0_1 = PatternAction_iteratedPath.getNewTask(actionEnv, openTasks);
                        taskFor__sub0_inlined__sub0_1.iteratedPath_node_beg = candidate_iteratedPath_alt_0_recursive_node_intermediate_inlined__sub0_1;
                        taskFor__sub0_inlined__sub0_1.iteratedPath_node_end = candidate_iteratedPath_node_end_inlined__sub0_1;
                        ...
                        uint prevGlobal__candidate_iteratedPath_alt_0_recursive_node_intermediate_inlined__sub0_1;
                        prevGlobal__candidate_iteratedPath_alt_0_recursive_node_intermediate_inlined__sub0_1 = candidate_iteratedPath_alt_0_recursive_node_intermediate_inlined__sub0_1.lgspFlags & (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace;
                        candidate_iteratedPath_alt_0_recursive_node_intermediate_inlined__sub0_1.lgspFlags |= (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace;
                        uint prevGlobal__candidate_iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_1;
                        prevGlobal__candidate_iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_1 = candidate_iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_1.lgspFlags & (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace;
                        candidate_iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_1.lgspFlags |= (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace;
                        // Match subpatterns 
                        openTasks.Peek().myMatch(matchesList, maxMatches - foundPartialMatches.Count, isoSpace);
                        // Pop subpattern matching task for _sub0_inlined__sub0_1
                        openTasks.Pop();
                        PatternAction_iteratedPath.releaseTask(taskFor__sub0_inlined__sub0_1);
                        // Check whether subpatterns were found 
                        if(matchesList.Count>0) {
                            // subpatterns/alternatives were found, extend the partial matches by our local match object
                            foreach(Stack<GRGEN_LIBGR.IMatch> currentFoundPartialMatch in matchesList)
                            {
                                Pattern_iteratedPath.Match_iteratedPath_alt_0_recursive match = new Pattern_iteratedPath.Match_iteratedPath_alt_0_recursive();
                                match._node_beg = candidate_iteratedPath_node_beg_inlined__sub0_1;
                                match._node_intermediate = candidate_iteratedPath_alt_0_recursive_node_intermediate_inlined__sub0_1;
                                match._node_end = candidate_iteratedPath_node_end_inlined__sub0_1;
                                match._edge__edge0 = candidate_iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_1;
                                match.__sub0 = (@Pattern_iteratedPath.Match_iteratedPath)currentFoundPartialMatch.Pop();
                                match.__sub0._matchOfEnclosingPattern = match;
                                currentFoundPartialMatch.Push(match);
                            }
                            ...
                            if(maxMatches > 0 && foundPartialMatches.Count >= maxMatches)
                            {
                                candidate_iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_1.lgspFlags = candidate_iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_1.lgspFlags & ~((uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace) | prevGlobal__candidate_iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_1;
                                candidate_iteratedPath_alt_0_recursive_node_intermediate_inlined__sub0_1.lgspFlags = candidate_iteratedPath_alt_0_recursive_node_intermediate_inlined__sub0_1.lgspFlags & ~((uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace) | prevGlobal__candidate_iteratedPath_alt_0_recursive_node_intermediate_inlined__sub0_1;
                                openTasks.Push(this);
                                return;
                            }
                            candidate_iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_1.lgspFlags = candidate_iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_1.lgspFlags & ~((uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace) | prevGlobal__candidate_iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_1;
                    ...
                    while( (candidate_iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_1 = candidate_iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_1.lgspOutNext) != head_candidate_iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_1 );
                }
            } while(false);
            openTasks.Push(this);
            return;
    ...
    public class AlternativeAction_findChainPlusChainToInt_alt_0_inlined__sub1_2_in_findChainPlusChainToInt : GRGEN_LGSP.LGSPSubpatternAction
    {
        private AlternativeAction_findChainPlusChainToInt_alt_0_inlined__sub1_2_in_findChainPlusChainToInt(GRGEN_LGSP.LGSPActionExecutionEnvironment actionEnv_, Stack<GRGEN_LGSP.LGSPSubpatternAction> openTasks_, GRGEN_LGSP.PatternGraph[] patternGraphs_)
            : base(patternGraphs_)
        {
            actionEnv = actionEnv_; openTasks = openTasks_;
        }

        public static AlternativeAction_findChainPlusChainToInt_alt_0_inlined__sub1_2_in_findChainPlusChainToInt getNewTask(GRGEN_LGSP.LGSPActionExecutionEnvironment actionEnv_, Stack<GRGEN_LGSP.LGSPSubpatternAction> openTasks_, GRGEN_LGSP.PatternGraph[] patternGraphs_) {
            AlternativeAction_findChainPlusChainToInt_alt_0_inlined__sub1_2_in_findChainPlusChainToInt newTask;
            if(numFreeTasks>0) {
                newTask = freeListHead;
                newTask.actionEnv = actionEnv_; newTask.openTasks = openTasks_;
                freeListHead = newTask.next;
                ...
                newTask = new AlternativeAction_findChainPlusChainToInt_alt_0_inlined__sub1_2_in_findChainPlusChainToInt(actionEnv_, openTasks_, patternGraphs_);
            }
            return newTask;
        }

        public static void releaseTask(AlternativeAction_findChainPlusChainToInt_alt_0_inlined__sub1_2_in_findChainPlusChainToInt oldTask) {
            if(numFreeTasks<MAX_NUM_FREE_TASKS) {
                oldTask.next = freeListHead;
                oldTask.actionEnv = null; oldTask.openTasks = null;
                freeListHead = oldTask;
        ...
        private static AlternativeAction_findChainPlusChainToInt_alt_0_inlined__sub1_2_in_findChainPlusChainToInt freeListHead = null;
        private static int numFreeTasks = 0;
        private const int MAX_NUM_FREE_TASKS = 100;

        private AlternativeAction_findChainPlusChainToInt_alt_0_inlined__sub1_2_in_findChainPlusChainToInt next = null;

        public GRGEN_LGSP.LGSPNode iteratedPathToIntNode_node_beg_inlined__sub1_2;
        ...
        public override void myMatch(List<Stack<GRGEN_LIBGR.IMatch>> foundPartialMatches, int maxMatches, int isoSpace)
        {
            ...
            do {
                patternGraph = patternGraphs[(int)Pattern_iteratedPathToIntNode.iteratedPathToIntNode_alt_0_CaseNums.@base];
                // SubPreset iteratedPathToIntNode_node_beg_inlined__sub1_2 
                GRGEN_LGSP.LGSPNode candidate_iteratedPathToIntNode_node_beg_inlined__sub1_2 = iteratedPathToIntNode_node_beg_inlined__sub1_2;
                // Extend Outgoing iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub1_2 from iteratedPathToIntNode_node_beg_inlined__sub1_2 
                GRGEN_LGSP.LGSPEdge head_candidate_iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub1_2 = candidate_iteratedPathToIntNode_node_beg_inlined__sub1_2.lgspOuthead;
                if(head_candidate_iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub1_2 != null)
                {
                    GRGEN_LGSP.LGSPEdge candidate_iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub1_2 = head_candidate_iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub1_2;
                    do
                    {
                        if(candidate_iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub1_2.lgspType.TypeID!=1) {
                            continue;
                        }
                        if((candidate_iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub1_2.lgspFlags & (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace)==(uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace)
                        {
                            continue;
                        }
                        // Implicit Target iteratedPathToIntNode_alt_0_base_node_end_inlined__sub1_2 from iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub1_2 
                        GRGEN_LGSP.LGSPNode candidate_iteratedPathToIntNode_alt_0_base_node_end_inlined__sub1_2 = candidate_iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub1_2.lgspTarget;
                        if(candidate_iteratedPathToIntNode_alt_0_base_node_end_inlined__sub1_2.lgspType.TypeID!=1) {
                            continue;
                        }
                        if((candidate_iteratedPathToIntNode_alt_0_base_node_end_inlined__sub1_2.lgspFlags & (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED << isoSpace) != 0)
                        {
                            continue;
                        }
                        if((candidate_iteratedPathToIntNode_alt_0_base_node_end_inlined__sub1_2.lgspFlags & (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace)==(uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace)
                        {
                            continue;
                        }
                        // Check whether there are subpattern matching tasks left to execute
                        if(openTasks.Count==0)
                        {
                            ...
                            foundPartialMatches.Add(currentFoundPartialMatch);
                            Pattern_iteratedPathToIntNode.Match_iteratedPathToIntNode_alt_0_base match = new Pattern_iteratedPathToIntNode.Match_iteratedPathToIntNode_alt_0_base();
                            match._node_beg = candidate_iteratedPathToIntNode_node_beg_inlined__sub1_2;
                            match._node_end = candidate_iteratedPathToIntNode_alt_0_base_node_end_inlined__sub1_2;
                            match._edge__edge0 = candidate_iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub1_2;
                            currentFoundPartialMatch.Push(match);
                            // if enough matches were found, we leave
                            if(maxMatches > 0 && foundPartialMatches.Count >= maxMatches)
                            {
                        ...
                        uint prevGlobal__candidate_iteratedPathToIntNode_alt_0_base_node_end_inlined__sub1_2;
                        prevGlobal__candidate_iteratedPathToIntNode_alt_0_base_node_end_inlined__sub1_2 = candidate_iteratedPathToIntNode_alt_0_base_node_end_inlined__sub1_2.lgspFlags & (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace;
                        candidate_iteratedPathToIntNode_alt_0_base_node_end_inlined__sub1_2.lgspFlags |= (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace;
                        uint prevGlobal__candidate_iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub1_2;
                        prevGlobal__candidate_iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub1_2 = candidate_iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub1_2.lgspFlags & (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace;
                        candidate_iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub1_2.lgspFlags |= (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace;
                        // Match subpatterns 
                        openTasks.Peek().myMatch(matchesList, maxMatches - foundPartialMatches.Count, isoSpace);
                        // Check whether subpatterns were found 
                        if(matchesList.Count>0) {
                            ...
                            if(maxMatches > 0 && foundPartialMatches.Count >= maxMatches)
                            {
                                candidate_iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub1_2.lgspFlags = candidate_iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub1_2.lgspFlags & ~((uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace) | prevGlobal__candidate_iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub1_2;
                                candidate_iteratedPathToIntNode_alt_0_base_node_end_inlined__sub1_2.lgspFlags = candidate_iteratedPathToIntNode_alt_0_base_node_end_inlined__sub1_2.lgspFlags & ~((uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace) | prevGlobal__candidate_iteratedPathToIntNode_alt_0_base_node_end_inlined__sub1_2;
                                openTasks.Push(this);
                                return;
                            }
                            candidate_iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub1_2.lgspFlags = candidate_iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub1_2.lgspFlags & ~((uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace) | prevGlobal__candidate_iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub1_2;
                    ...
                    while( (candidate_iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub1_2 = candidate_iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub1_2.lgspOutNext) != head_candidate_iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub1_2 );
                }
            } while(false);
            if(matchesList.Count>0) {
                if(matchesList==foundPartialMatches) {
            ...
            do {
                ...
                // SubPreset iteratedPathToIntNode_node_beg_inlined__sub1_2 
                GRGEN_LGSP.LGSPNode candidate_iteratedPathToIntNode_node_beg_inlined__sub1_2 = iteratedPathToIntNode_node_beg_inlined__sub1_2;
                // Extend Outgoing iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub1_2 from iteratedPathToIntNode_node_beg_inlined__sub1_2 
                GRGEN_LGSP.LGSPEdge head_candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub1_2 = candidate_iteratedPathToIntNode_node_beg_inlined__sub1_2.lgspOuthead;
                if(head_candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub1_2 != null)
                {
                    GRGEN_LGSP.LGSPEdge candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub1_2 = head_candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub1_2;
                    do
                    {
                        if(candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub1_2.lgspType.TypeID!=1) {
                            continue;
                        }
                        if((candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub1_2.lgspFlags & (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace)==(uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace)
                        {
                            continue;
                        }
                        // Implicit Target iteratedPathToIntNode_alt_0_recursive_node_intermediate_inlined__sub1_2 from iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub1_2 
                        GRGEN_LGSP.LGSPNode candidate_iteratedPathToIntNode_alt_0_recursive_node_intermediate_inlined__sub1_2 = candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub1_2.lgspTarget;
                        if(candidate_iteratedPathToIntNode_alt_0_recursive_node_intermediate_inlined__sub1_2.lgspType.TypeID!=0) {
                            continue;
                        }
                        if((candidate_iteratedPathToIntNode_alt_0_recursive_node_intermediate_inlined__sub1_2.lgspFlags & (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED << isoSpace) != 0)
                        {
                            continue;
                        }
                        if((candidate_iteratedPathToIntNode_alt_0_recursive_node_intermediate_inlined__sub1_2.lgspFlags & (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace)==(uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace)
                        {
                            continue;
                        }
                        // Push subpattern matching task for _sub0_inlined__sub1_2
                        PatternAction_iteratedPathToIntNode taskFor__sub0_inlined__sub1_2 = PatternAction_iteratedPathToIntNode.getNewTask(actionEnv, openTasks);
                        taskFor__sub0_inlined__sub1_2.iteratedPathToIntNode_node_beg = candidate_iteratedPathToIntNode_alt_0_recursive_node_intermediate_inlined__sub1_2;
                        taskFor__sub0_inlined__sub1_2.searchPatternpath = false;
                        taskFor__sub0_inlined__sub1_2.matchOfNestingPattern = null;
                        taskFor__sub0_inlined__sub1_2.lastMatchAtPreviousNestingLevel = null;
                        openTasks.Push(taskFor__sub0_inlined__sub1_2);
                        uint prevGlobal__candidate_iteratedPathToIntNode_alt_0_recursive_node_intermediate_inlined__sub1_2;
                        prevGlobal__candidate_iteratedPathToIntNode_alt_0_recursive_node_intermediate_inlined__sub1_2 = candidate_iteratedPathToIntNode_alt_0_recursive_node_intermediate_inlined__sub1_2.lgspFlags & (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace;
                        candidate_iteratedPathToIntNode_alt_0_recursive_node_intermediate_inlined__sub1_2.lgspFlags |= (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace;
                        uint prevGlobal__candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub1_2;
                        prevGlobal__candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub1_2 = candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub1_2.lgspFlags & (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace;
                        candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub1_2.lgspFlags |= (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace;
                        // Match subpatterns 
                        openTasks.Peek().myMatch(matchesList, maxMatches - foundPartialMatches.Count, isoSpace);
                        // Pop subpattern matching task for _sub0_inlined__sub1_2
                        openTasks.Pop();
                        PatternAction_iteratedPathToIntNode.releaseTask(taskFor__sub0_inlined__sub1_2);
                        // Check whether subpatterns were found 
                        if(matchesList.Count>0) {
                            // subpatterns/alternatives were found, extend the partial matches by our local match object
                            foreach(Stack<GRGEN_LIBGR.IMatch> currentFoundPartialMatch in matchesList)
                            {
                                Pattern_iteratedPathToIntNode.Match_iteratedPathToIntNode_alt_0_recursive match = new Pattern_iteratedPathToIntNode.Match_iteratedPathToIntNode_alt_0_recursive();
                                match._node_beg = candidate_iteratedPathToIntNode_node_beg_inlined__sub1_2;
                                match._node_intermediate = candidate_iteratedPathToIntNode_alt_0_recursive_node_intermediate_inlined__sub1_2;
                                match._edge__edge0 = candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub1_2;
                                match.__sub0 = (@Pattern_iteratedPathToIntNode.Match_iteratedPathToIntNode)currentFoundPartialMatch.Pop();
                                match.__sub0._matchOfEnclosingPattern = match;
                                currentFoundPartialMatch.Push(match);
                            }
                            ...
                            if(maxMatches > 0 && foundPartialMatches.Count >= maxMatches)
                            {
                                candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub1_2.lgspFlags = candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub1_2.lgspFlags & ~((uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace) | prevGlobal__candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub1_2;
                                candidate_iteratedPathToIntNode_alt_0_recursive_node_intermediate_inlined__sub1_2.lgspFlags = candidate_iteratedPathToIntNode_alt_0_recursive_node_intermediate_inlined__sub1_2.lgspFlags & ~((uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace) | prevGlobal__candidate_iteratedPathToIntNode_alt_0_recursive_node_intermediate_inlined__sub1_2;
                                openTasks.Push(this);
                                return;
                            }
                            candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub1_2.lgspFlags = candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub1_2.lgspFlags & ~((uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace) | prevGlobal__candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub1_2;
                    ...
                    while( (candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub1_2 = candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub1_2.lgspOutNext) != head_candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub1_2 );
                }
            } while(false);
            openTasks.Push(this);
            return;
    ...
    public class Action_findChainPlusChainToIntIndependent : GRGEN_LGSP.LGSPAction, GRGEN_LIBGR.IAction, IAction_findChainPlusChainToIntIndependent
    {
        public Action_findChainPlusChainToIntIndependent()
            : base(Rule_findChainPlusChainToIntIndependent.Instance.patternGraph)
        {
        ...
        [ThreadStatic] private static GRGEN_LGSP.LGSPMatchesList<Rule_findChainPlusChainToIntIndependent.Match_findChainPlusChainToIntIndependent, Rule_findChainPlusChainToIntIndependent.IMatch_findChainPlusChainToIntIndependent> matches;
        ...
        public GRGEN_LIBGR.IMatchesExact<Rule_findChainPlusChainToIntIndependent.IMatch_findChainPlusChainToIntIndependent> myMatch(GRGEN_LGSP.LGSPActionExecutionEnvironment actionEnv, int maxMatches, GRGEN_LIBGR.INode findChainPlusChainToIntIndependent_node_beg, GRGEN_LIBGR.INode findChainPlusChainToIntIndependent_node_end)
        {
            ...
            // IndependentPattern 
            {
                ...
                // Element iteratedPathToIntNode_node_beg_inlined__sub0_4 assigned from other element findChainPlusChainToIntIndependent_node_end 
                GRGEN_LGSP.LGSPNode candidate_iteratedPathToIntNode_node_beg_inlined__sub0_4 = candidate_findChainPlusChainToIntIndependent_node_end;
                // Push alternative matching task for findChainPlusChainToIntIndependent_idpt_0_alt_0_inlined__sub0_4_in_findChainPlusChainToIntIndependent_idpt_0
                AlternativeAction_findChainPlusChainToIntIndependent_idpt_0_alt_0_inlined__sub0_4_in_findChainPlusChainToIntIndependent_idpt_0 taskFor_idpt_0_alt_0_inlined__sub0_4_in_findChainPlusChainToIntIndependent_idpt_0 = AlternativeAction_findChainPlusChainToIntIndependent_idpt_0_alt_0_inlined__sub0_4_in_findChainPlusChainToIntIndependent_idpt_0.getNewTask(actionEnv, idpt_0_openTasks, Pattern_iteratedPathToIntNode.Instance.patternGraph.alternatives[(int)Pattern_iteratedPathToIntNode.iteratedPathToIntNode_AltNums.@alt_0].alternativeCases);
                taskFor_idpt_0_alt_0_inlined__sub0_4_in_findChainPlusChainToIntIndependent_idpt_0.iteratedPathToIntNode_node_beg_inlined__sub0_4 = candidate_iteratedPathToIntNode_node_beg_inlined__sub0_4;
                taskFor_idpt_0_alt_0_inlined__sub0_4_in_findChainPlusChainToIntIndependent_idpt_0.searchPatternpath = false;
                taskFor_idpt_0_alt_0_inlined__sub0_4_in_findChainPlusChainToIntIndependent_idpt_0.matchOfNestingPattern = null;
                taskFor_idpt_0_alt_0_inlined__sub0_4_in_findChainPlusChainToIntIndependent_idpt_0.lastMatchAtPreviousNestingLevel = null;
                idpt_0_openTasks.Push(taskFor_idpt_0_alt_0_inlined__sub0_4_in_findChainPlusChainToIntIndependent_idpt_0);
                ...
                // Pop alternative matching task for findChainPlusChainToIntIndependent_idpt_0_alt_0_inlined__sub0_4_in_findChainPlusChainToIntIndependent_idpt_0
                idpt_0_openTasks.Pop();
                AlternativeAction_findChainPlusChainToIntIndependent_idpt_0_alt_0_inlined__sub0_4_in_findChainPlusChainToIntIndependent_idpt_0.releaseTask(taskFor_idpt_0_alt_0_inlined__sub0_4_in_findChainPlusChainToIntIndependent_idpt_0);
                // Check whether subpatterns were found 
                if(idpt_0_matchesList.Count>0) {
                    ...
                    match__sub0._node_beg = candidate_iteratedPathToIntNode_node_beg_inlined__sub0_4;
            ...
            return matches;
label15: ;
            // Element iteratedPath_node_end_inlined__sub0_3 assigned from other element findChainPlusChainToIntIndependent_node_end 
            GRGEN_LGSP.LGSPNode candidate_iteratedPath_node_end_inlined__sub0_3 = candidate_findChainPlusChainToIntIndependent_node_end;
            // Element iteratedPath_node_beg_inlined__sub0_3 assigned from other element findChainPlusChainToIntIndependent_node_beg 
            GRGEN_LGSP.LGSPNode candidate_iteratedPath_node_beg_inlined__sub0_3 = candidate_findChainPlusChainToIntIndependent_node_beg;
            // Push alternative matching task for findChainPlusChainToIntIndependent_alt_0_inlined__sub0_3_in_findChainPlusChainToIntIndependent
            AlternativeAction_findChainPlusChainToIntIndependent_alt_0_inlined__sub0_3_in_findChainPlusChainToIntIndependent taskFor_alt_0_inlined__sub0_3_in_findChainPlusChainToIntIndependent = AlternativeAction_findChainPlusChainToIntIndependent_alt_0_inlined__sub0_3_in_findChainPlusChainToIntIndependent.getNewTask(actionEnv, openTasks, Pattern_iteratedPath.Instance.patternGraph.alternatives[(int)Pattern_iteratedPath.iteratedPath_AltNums.@alt_0].alternativeCases);
            taskFor_alt_0_inlined__sub0_3_in_findChainPlusChainToIntIndependent.iteratedPath_node_beg_inlined__sub0_3 = candidate_iteratedPath_node_beg_inlined__sub0_3;
            taskFor_alt_0_inlined__sub0_3_in_findChainPlusChainToIntIndependent.iteratedPath_node_end_inlined__sub0_3 = candidate_iteratedPath_node_end_inlined__sub0_3;
            taskFor_alt_0_inlined__sub0_3_in_findChainPlusChainToIntIndependent.searchPatternpath = false;
            taskFor_alt_0_inlined__sub0_3_in_findChainPlusChainToIntIndependent.matchOfNestingPattern = null;
            taskFor_alt_0_inlined__sub0_3_in_findChainPlusChainToIntIndependent.lastMatchAtPreviousNestingLevel = null;
            openTasks.Push(taskFor_alt_0_inlined__sub0_3_in_findChainPlusChainToIntIndependent);
            ...
            // Match subpatterns 
            openTasks.Peek().myMatch(matchesList, maxMatches - foundPartialMatches.Count, isoSpace);
            // Pop alternative matching task for findChainPlusChainToIntIndependent_alt_0_inlined__sub0_3_in_findChainPlusChainToIntIndependent
            openTasks.Pop();
            AlternativeAction_findChainPlusChainToIntIndependent_alt_0_inlined__sub0_3_in_findChainPlusChainToIntIndependent.releaseTask(taskFor_alt_0_inlined__sub0_3_in_findChainPlusChainToIntIndependent);
            // Check whether subpatterns were found 
            if(matchesList.Count>0) {
                // subpatterns/alternatives were found, extend the partial matches by our local match object, becoming a complete match object and save it
                foreach(Stack<GRGEN_LIBGR.IMatch> currentFoundPartialMatch in matchesList)
                {
                    ...
                    match__sub0._node_beg = candidate_iteratedPath_node_beg_inlined__sub0_3;
                    match__sub0._node_end = candidate_iteratedPath_node_end_inlined__sub0_3;
                    match.__sub0 = match__sub0;
                    match__sub0._alt_0 = (Pattern_iteratedPath.IMatch_iteratedPath_alt_0)currentFoundPartialMatch.Pop();
                    match__sub0._alt_0.SetMatchOfEnclosingPattern(match__sub0);
    ...
    public class AlternativeAction_findChainPlusChainToIntIndependent_alt_0_inlined__sub0_3_in_findChainPlusChainToIntIndependent : GRGEN_LGSP.LGSPSubpatternAction
    {
        private AlternativeAction_findChainPlusChainToIntIndependent_alt_0_inlined__sub0_3_in_findChainPlusChainToIntIndependent(GRGEN_LGSP.LGSPActionExecutionEnvironment actionEnv_, Stack<GRGEN_LGSP.LGSPSubpatternAction> openTasks_, GRGEN_LGSP.PatternGraph[] patternGraphs_)
            : base(patternGraphs_)
        {
            actionEnv = actionEnv_; openTasks = openTasks_;
        }

        public static AlternativeAction_findChainPlusChainToIntIndependent_alt_0_inlined__sub0_3_in_findChainPlusChainToIntIndependent getNewTask(GRGEN_LGSP.LGSPActionExecutionEnvironment actionEnv_, Stack<GRGEN_LGSP.LGSPSubpatternAction> openTasks_, GRGEN_LGSP.PatternGraph[] patternGraphs_) {
            AlternativeAction_findChainPlusChainToIntIndependent_alt_0_inlined__sub0_3_in_findChainPlusChainToIntIndependent newTask;
            if(numFreeTasks>0) {
                newTask = freeListHead;
                newTask.actionEnv = actionEnv_; newTask.openTasks = openTasks_;
                freeListHead = newTask.next;
                ...
                newTask = new AlternativeAction_findChainPlusChainToIntIndependent_alt_0_inlined__sub0_3_in_findChainPlusChainToIntIndependent(actionEnv_, openTasks_, patternGraphs_);
            }
            return newTask;
        }

        public static void releaseTask(AlternativeAction_findChainPlusChainToIntIndependent_alt_0_inlined__sub0_3_in_findChainPlusChainToIntIndependent oldTask) {
            if(numFreeTasks<MAX_NUM_FREE_TASKS) {
                oldTask.next = freeListHead;
                oldTask.actionEnv = null; oldTask.openTasks = null;
                freeListHead = oldTask;
        ...
        private static AlternativeAction_findChainPlusChainToIntIndependent_alt_0_inlined__sub0_3_in_findChainPlusChainToIntIndependent freeListHead = null;
        private static int numFreeTasks = 0;
        private const int MAX_NUM_FREE_TASKS = 100;

        private AlternativeAction_findChainPlusChainToIntIndependent_alt_0_inlined__sub0_3_in_findChainPlusChainToIntIndependent next = null;

        public GRGEN_LGSP.LGSPNode iteratedPath_node_beg_inlined__sub0_3;
        public GRGEN_LGSP.LGSPNode iteratedPath_node_end_inlined__sub0_3;
        ...
        public override void myMatch(List<Stack<GRGEN_LIBGR.IMatch>> foundPartialMatches, int maxMatches, int isoSpace)
        {
            ...
            do {
                patternGraph = patternGraphs[(int)Pattern_iteratedPath.iteratedPath_alt_0_CaseNums.@base];
                // SubPreset iteratedPath_node_beg_inlined__sub0_3 
                GRGEN_LGSP.LGSPNode candidate_iteratedPath_node_beg_inlined__sub0_3 = iteratedPath_node_beg_inlined__sub0_3;
                // SubPreset iteratedPath_node_end_inlined__sub0_3 
                GRGEN_LGSP.LGSPNode candidate_iteratedPath_node_end_inlined__sub0_3 = iteratedPath_node_end_inlined__sub0_3;
                // Extend Outgoing iteratedPath_alt_0_base_edge__edge0_inlined__sub0_3 from iteratedPath_node_beg_inlined__sub0_3 
                GRGEN_LGSP.LGSPEdge head_candidate_iteratedPath_alt_0_base_edge__edge0_inlined__sub0_3 = candidate_iteratedPath_node_beg_inlined__sub0_3.lgspOuthead;
                if(head_candidate_iteratedPath_alt_0_base_edge__edge0_inlined__sub0_3 != null)
                {
                    GRGEN_LGSP.LGSPEdge candidate_iteratedPath_alt_0_base_edge__edge0_inlined__sub0_3 = head_candidate_iteratedPath_alt_0_base_edge__edge0_inlined__sub0_3;
                    do
                    {
                        if(candidate_iteratedPath_alt_0_base_edge__edge0_inlined__sub0_3.lgspType.TypeID!=1) {
                            continue;
                        }
                        if(candidate_iteratedPath_alt_0_base_edge__edge0_inlined__sub0_3.lgspTarget != candidate_iteratedPath_node_end_inlined__sub0_3) {
                            continue;
                        }
                        if((candidate_iteratedPath_alt_0_base_edge__edge0_inlined__sub0_3.lgspFlags & (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace)==(uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace)
                        {
                            continue;
                        }
                        // Check whether there are subpattern matching tasks left to execute
                        if(openTasks.Count==0)
                        {
                            ...
                            foundPartialMatches.Add(currentFoundPartialMatch);
                            Pattern_iteratedPath.Match_iteratedPath_alt_0_base match = new Pattern_iteratedPath.Match_iteratedPath_alt_0_base();
                            match._node_beg = candidate_iteratedPath_node_beg_inlined__sub0_3;
                            match._node_end = candidate_iteratedPath_node_end_inlined__sub0_3;
                            match._edge__edge0 = candidate_iteratedPath_alt_0_base_edge__edge0_inlined__sub0_3;
                            currentFoundPartialMatch.Push(match);
                            // if enough matches were found, we leave
                            if(maxMatches > 0 && foundPartialMatches.Count >= maxMatches)
                            {
                        ...
                        uint prevGlobal__candidate_iteratedPath_alt_0_base_edge__edge0_inlined__sub0_3;
                        prevGlobal__candidate_iteratedPath_alt_0_base_edge__edge0_inlined__sub0_3 = candidate_iteratedPath_alt_0_base_edge__edge0_inlined__sub0_3.lgspFlags & (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace;
                        candidate_iteratedPath_alt_0_base_edge__edge0_inlined__sub0_3.lgspFlags |= (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace;
                        // Match subpatterns 
                        openTasks.Peek().myMatch(matchesList, maxMatches - foundPartialMatches.Count, isoSpace);
                        // Check whether subpatterns were found 
                        if(matchesList.Count>0) {
                            ...
                            if(maxMatches > 0 && foundPartialMatches.Count >= maxMatches)
                            {
                                candidate_iteratedPath_alt_0_base_edge__edge0_inlined__sub0_3.lgspFlags = candidate_iteratedPath_alt_0_base_edge__edge0_inlined__sub0_3.lgspFlags & ~((uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace) | prevGlobal__candidate_iteratedPath_alt_0_base_edge__edge0_inlined__sub0_3;
                                openTasks.Push(this);
                                return;
                            }
                            candidate_iteratedPath_alt_0_base_edge__edge0_inlined__sub0_3.lgspFlags = candidate_iteratedPath_alt_0_base_edge__edge0_inlined__sub0_3.lgspFlags & ~((uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace) | prevGlobal__candidate_iteratedPath_alt_0_base_edge__edge0_inlined__sub0_3;
                    ...
                    while( (candidate_iteratedPath_alt_0_base_edge__edge0_inlined__sub0_3 = candidate_iteratedPath_alt_0_base_edge__edge0_inlined__sub0_3.lgspOutNext) != head_candidate_iteratedPath_alt_0_base_edge__edge0_inlined__sub0_3 );
                }
            } while(false);
            if(matchesList.Count>0) {
                if(matchesList==foundPartialMatches) {
            ...
            do {
                ...
                // SubPreset iteratedPath_node_end_inlined__sub0_3 
                GRGEN_LGSP.LGSPNode candidate_iteratedPath_node_end_inlined__sub0_3 = iteratedPath_node_end_inlined__sub0_3;
                // Extend Outgoing iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_3 from iteratedPath_node_beg_inlined__sub0_3 
                GRGEN_LGSP.LGSPEdge head_candidate_iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_3 = candidate_iteratedPath_node_beg_inlined__sub0_3.lgspOuthead;
                if(head_candidate_iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_3 != null)
                {
                    GRGEN_LGSP.LGSPEdge candidate_iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_3 = head_candidate_iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_3;
                    do
                    {
                        if(candidate_iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_3.lgspType.TypeID!=1) {
                            continue;
                        }
                        if((candidate_iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_3.lgspFlags & (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace)==(uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace)
                        {
                            continue;
                        }
                        // Implicit Target iteratedPath_alt_0_recursive_node_intermediate_inlined__sub0_3 from iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_3 
                        GRGEN_LGSP.LGSPNode candidate_iteratedPath_alt_0_recursive_node_intermediate_inlined__sub0_3 = candidate_iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_3.lgspTarget;
                        if((candidate_iteratedPath_alt_0_recursive_node_intermediate_inlined__sub0_3.lgspFlags & (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED << isoSpace) != 0
                            && candidate_iteratedPath_alt_0_recursive_node_intermediate_inlined__sub0_3==candidate_iteratedPath_node_beg_inlined__sub0_3
                            )
                        {
                            continue;
                        }
                        if((candidate_iteratedPath_alt_0_recursive_node_intermediate_inlined__sub0_3.lgspFlags & (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace)==(uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace)
                        {
                            continue;
                        }
                        // Push subpattern matching task for _sub0_inlined__sub0_3
                        PatternAction_iteratedPath taskFor__sub0_inlined__sub0_3 = PatternAction_iteratedPath.getNewTask(actionEnv, openTasks);
                        taskFor__sub0_inlined__sub0_3.iteratedPath_node_beg = candidate_iteratedPath_alt_0_recursive_node_intermediate_inlined__sub0_3;
                        taskFor__sub0_inlined__sub0_3.iteratedPath_node_end = candidate_iteratedPath_node_end_inlined__sub0_3;
                        ...
                        uint prevGlobal__candidate_iteratedPath_alt_0_recursive_node_intermediate_inlined__sub0_3;
                        prevGlobal__candidate_iteratedPath_alt_0_recursive_node_intermediate_inlined__sub0_3 = candidate_iteratedPath_alt_0_recursive_node_intermediate_inlined__sub0_3.lgspFlags & (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace;
                        candidate_iteratedPath_alt_0_recursive_node_intermediate_inlined__sub0_3.lgspFlags |= (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace;
                        uint prevGlobal__candidate_iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_3;
                        prevGlobal__candidate_iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_3 = candidate_iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_3.lgspFlags & (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace;
                        candidate_iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_3.lgspFlags |= (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace;
                        // Match subpatterns 
                        openTasks.Peek().myMatch(matchesList, maxMatches - foundPartialMatches.Count, isoSpace);
                        // Pop subpattern matching task for _sub0_inlined__sub0_3
                        openTasks.Pop();
                        PatternAction_iteratedPath.releaseTask(taskFor__sub0_inlined__sub0_3);
                        // Check whether subpatterns were found 
                        if(matchesList.Count>0) {
                            // subpatterns/alternatives were found, extend the partial matches by our local match object
                            foreach(Stack<GRGEN_LIBGR.IMatch> currentFoundPartialMatch in matchesList)
                            {
                                Pattern_iteratedPath.Match_iteratedPath_alt_0_recursive match = new Pattern_iteratedPath.Match_iteratedPath_alt_0_recursive();
                                match._node_beg = candidate_iteratedPath_node_beg_inlined__sub0_3;
                                match._node_intermediate = candidate_iteratedPath_alt_0_recursive_node_intermediate_inlined__sub0_3;
                                match._node_end = candidate_iteratedPath_node_end_inlined__sub0_3;
                                match._edge__edge0 = candidate_iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_3;
                                match.__sub0 = (@Pattern_iteratedPath.Match_iteratedPath)currentFoundPartialMatch.Pop();
                                match.__sub0._matchOfEnclosingPattern = match;
                                currentFoundPartialMatch.Push(match);
                            }
                            ...
                            if(maxMatches > 0 && foundPartialMatches.Count >= maxMatches)
                            {
                                candidate_iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_3.lgspFlags = candidate_iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_3.lgspFlags & ~((uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace) | prevGlobal__candidate_iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_3;
                                candidate_iteratedPath_alt_0_recursive_node_intermediate_inlined__sub0_3.lgspFlags = candidate_iteratedPath_alt_0_recursive_node_intermediate_inlined__sub0_3.lgspFlags & ~((uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace) | prevGlobal__candidate_iteratedPath_alt_0_recursive_node_intermediate_inlined__sub0_3;
                                openTasks.Push(this);
                                return;
                            }
                            candidate_iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_3.lgspFlags = candidate_iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_3.lgspFlags & ~((uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace) | prevGlobal__candidate_iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_3;
                    ...
                    while( (candidate_iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_3 = candidate_iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_3.lgspOutNext) != head_candidate_iteratedPath_alt_0_recursive_edge__edge0_inlined__sub0_3 );
                }
            } while(false);
            openTasks.Push(this);
            return;
    ...
    public class AlternativeAction_findChainPlusChainToIntIndependent_idpt_0_alt_0_inlined__sub0_4_in_findChainPlusChainToIntIndependent_idpt_0 : GRGEN_LGSP.LGSPSubpatternAction
    {
        private AlternativeAction_findChainPlusChainToIntIndependent_idpt_0_alt_0_inlined__sub0_4_in_findChainPlusChainToIntIndependent_idpt_0(GRGEN_LGSP.LGSPActionExecutionEnvironment actionEnv_, Stack<GRGEN_LGSP.LGSPSubpatternAction> openTasks_, GRGEN_LGSP.PatternGraph[] patternGraphs_)
            : base(patternGraphs_)
        {
            actionEnv = actionEnv_; openTasks = openTasks_;
        }

        public static AlternativeAction_findChainPlusChainToIntIndependent_idpt_0_alt_0_inlined__sub0_4_in_findChainPlusChainToIntIndependent_idpt_0 getNewTask(GRGEN_LGSP.LGSPActionExecutionEnvironment actionEnv_, Stack<GRGEN_LGSP.LGSPSubpatternAction> openTasks_, GRGEN_LGSP.PatternGraph[] patternGraphs_) {
            AlternativeAction_findChainPlusChainToIntIndependent_idpt_0_alt_0_inlined__sub0_4_in_findChainPlusChainToIntIndependent_idpt_0 newTask;
            if(numFreeTasks>0) {
                newTask = freeListHead;
                newTask.actionEnv = actionEnv_; newTask.openTasks = openTasks_;
                freeListHead = newTask.next;
                ...
                newTask = new AlternativeAction_findChainPlusChainToIntIndependent_idpt_0_alt_0_inlined__sub0_4_in_findChainPlusChainToIntIndependent_idpt_0(actionEnv_, openTasks_, patternGraphs_);
            }
            return newTask;
        }

        public static void releaseTask(AlternativeAction_findChainPlusChainToIntIndependent_idpt_0_alt_0_inlined__sub0_4_in_findChainPlusChainToIntIndependent_idpt_0 oldTask) {
            if(numFreeTasks<MAX_NUM_FREE_TASKS) {
                oldTask.next = freeListHead;
                oldTask.actionEnv = null; oldTask.openTasks = null;
                freeListHead = oldTask;
        ...
        private static AlternativeAction_findChainPlusChainToIntIndependent_idpt_0_alt_0_inlined__sub0_4_in_findChainPlusChainToIntIndependent_idpt_0 freeListHead = null;
        private static int numFreeTasks = 0;
        private const int MAX_NUM_FREE_TASKS = 100;

        private AlternativeAction_findChainPlusChainToIntIndependent_idpt_0_alt_0_inlined__sub0_4_in_findChainPlusChainToIntIndependent_idpt_0 next = null;

        public GRGEN_LGSP.LGSPNode iteratedPathToIntNode_node_beg_inlined__sub0_4;
        ...
        public override void myMatch(List<Stack<GRGEN_LIBGR.IMatch>> foundPartialMatches, int maxMatches, int isoSpace)
        {
            ...
            do {
                patternGraph = patternGraphs[(int)Pattern_iteratedPathToIntNode.iteratedPathToIntNode_alt_0_CaseNums.@base];
                // SubPreset iteratedPathToIntNode_node_beg_inlined__sub0_4 
                GRGEN_LGSP.LGSPNode candidate_iteratedPathToIntNode_node_beg_inlined__sub0_4 = iteratedPathToIntNode_node_beg_inlined__sub0_4;
                // Extend Outgoing iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub0_4 from iteratedPathToIntNode_node_beg_inlined__sub0_4 
                GRGEN_LGSP.LGSPEdge head_candidate_iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub0_4 = candidate_iteratedPathToIntNode_node_beg_inlined__sub0_4.lgspOuthead;
                if(head_candidate_iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub0_4 != null)
                {
                    GRGEN_LGSP.LGSPEdge candidate_iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub0_4 = head_candidate_iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub0_4;
                    do
                    {
                        if(candidate_iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub0_4.lgspType.TypeID!=1) {
                            continue;
                        }
                        if((candidate_iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub0_4.lgspFlags & (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace)==(uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace)
                        {
                            continue;
                        }
                        // Implicit Target iteratedPathToIntNode_alt_0_base_node_end_inlined__sub0_4 from iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub0_4 
                        GRGEN_LGSP.LGSPNode candidate_iteratedPathToIntNode_alt_0_base_node_end_inlined__sub0_4 = candidate_iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub0_4.lgspTarget;
                        if(candidate_iteratedPathToIntNode_alt_0_base_node_end_inlined__sub0_4.lgspType.TypeID!=1) {
                            continue;
                        }
                        if((candidate_iteratedPathToIntNode_alt_0_base_node_end_inlined__sub0_4.lgspFlags & (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED << isoSpace) != 0)
                        {
                            continue;
                        }
                        if((candidate_iteratedPathToIntNode_alt_0_base_node_end_inlined__sub0_4.lgspFlags & (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace)==(uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace)
                        {
                            continue;
                        }
                        // Check whether there are subpattern matching tasks left to execute
                        if(openTasks.Count==0)
                        {
                            ...
                            foundPartialMatches.Add(currentFoundPartialMatch);
                            Pattern_iteratedPathToIntNode.Match_iteratedPathToIntNode_alt_0_base match = new Pattern_iteratedPathToIntNode.Match_iteratedPathToIntNode_alt_0_base();
                            match._node_beg = candidate_iteratedPathToIntNode_node_beg_inlined__sub0_4;
                            match._node_end = candidate_iteratedPathToIntNode_alt_0_base_node_end_inlined__sub0_4;
                            match._edge__edge0 = candidate_iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub0_4;
                            currentFoundPartialMatch.Push(match);
                            // if enough matches were found, we leave
                            if(maxMatches > 0 && foundPartialMatches.Count >= maxMatches)
                            {
                        ...
                        uint prevGlobal__candidate_iteratedPathToIntNode_alt_0_base_node_end_inlined__sub0_4;
                        prevGlobal__candidate_iteratedPathToIntNode_alt_0_base_node_end_inlined__sub0_4 = candidate_iteratedPathToIntNode_alt_0_base_node_end_inlined__sub0_4.lgspFlags & (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace;
                        candidate_iteratedPathToIntNode_alt_0_base_node_end_inlined__sub0_4.lgspFlags |= (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace;
                        uint prevGlobal__candidate_iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub0_4;
                        prevGlobal__candidate_iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub0_4 = candidate_iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub0_4.lgspFlags & (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace;
                        candidate_iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub0_4.lgspFlags |= (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace;
                        // Match subpatterns 
                        openTasks.Peek().myMatch(matchesList, maxMatches - foundPartialMatches.Count, isoSpace);
                        // Check whether subpatterns were found 
                        if(matchesList.Count>0) {
                            ...
                            if(maxMatches > 0 && foundPartialMatches.Count >= maxMatches)
                            {
                                candidate_iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub0_4.lgspFlags = candidate_iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub0_4.lgspFlags & ~((uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace) | prevGlobal__candidate_iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub0_4;
                                candidate_iteratedPathToIntNode_alt_0_base_node_end_inlined__sub0_4.lgspFlags = candidate_iteratedPathToIntNode_alt_0_base_node_end_inlined__sub0_4.lgspFlags & ~((uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace) | prevGlobal__candidate_iteratedPathToIntNode_alt_0_base_node_end_inlined__sub0_4;
                                openTasks.Push(this);
                                return;
                            }
                            candidate_iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub0_4.lgspFlags = candidate_iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub0_4.lgspFlags & ~((uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace) | prevGlobal__candidate_iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub0_4;
                    ...
                    while( (candidate_iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub0_4 = candidate_iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub0_4.lgspOutNext) != head_candidate_iteratedPathToIntNode_alt_0_base_edge__edge0_inlined__sub0_4 );
                }
            } while(false);
            if(matchesList.Count>0) {
                if(matchesList==foundPartialMatches) {
            ...
            do {
                ...
                // SubPreset iteratedPathToIntNode_node_beg_inlined__sub0_4 
                GRGEN_LGSP.LGSPNode candidate_iteratedPathToIntNode_node_beg_inlined__sub0_4 = iteratedPathToIntNode_node_beg_inlined__sub0_4;
                // Extend Outgoing iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub0_4 from iteratedPathToIntNode_node_beg_inlined__sub0_4 
                GRGEN_LGSP.LGSPEdge head_candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub0_4 = candidate_iteratedPathToIntNode_node_beg_inlined__sub0_4.lgspOuthead;
                if(head_candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub0_4 != null)
                {
                    GRGEN_LGSP.LGSPEdge candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub0_4 = head_candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub0_4;
                    do
                    {
                        if(candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub0_4.lgspType.TypeID!=1) {
                            continue;
                        }
                        if((candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub0_4.lgspFlags & (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace)==(uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace)
                        {
                            continue;
                        }
                        // Implicit Target iteratedPathToIntNode_alt_0_recursive_node_intermediate_inlined__sub0_4 from iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub0_4 
                        GRGEN_LGSP.LGSPNode candidate_iteratedPathToIntNode_alt_0_recursive_node_intermediate_inlined__sub0_4 = candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub0_4.lgspTarget;
                        if(candidate_iteratedPathToIntNode_alt_0_recursive_node_intermediate_inlined__sub0_4.lgspType.TypeID!=0) {
                            continue;
                        }
                        if((candidate_iteratedPathToIntNode_alt_0_recursive_node_intermediate_inlined__sub0_4.lgspFlags & (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED << isoSpace) != 0)
                        {
                            continue;
                        }
                        if((candidate_iteratedPathToIntNode_alt_0_recursive_node_intermediate_inlined__sub0_4.lgspFlags & (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace)==(uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace)
                        {
                            continue;
                        }
                        // Push subpattern matching task for _sub0_inlined__sub0_4
                        PatternAction_iteratedPathToIntNode taskFor__sub0_inlined__sub0_4 = PatternAction_iteratedPathToIntNode.getNewTask(actionEnv, openTasks);
                        taskFor__sub0_inlined__sub0_4.iteratedPathToIntNode_node_beg = candidate_iteratedPathToIntNode_alt_0_recursive_node_intermediate_inlined__sub0_4;
                        ...
                        uint prevGlobal__candidate_iteratedPathToIntNode_alt_0_recursive_node_intermediate_inlined__sub0_4;
                        prevGlobal__candidate_iteratedPathToIntNode_alt_0_recursive_node_intermediate_inlined__sub0_4 = candidate_iteratedPathToIntNode_alt_0_recursive_node_intermediate_inlined__sub0_4.lgspFlags & (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace;
                        candidate_iteratedPathToIntNode_alt_0_recursive_node_intermediate_inlined__sub0_4.lgspFlags |= (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace;
                        uint prevGlobal__candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub0_4;
                        prevGlobal__candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub0_4 = candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub0_4.lgspFlags & (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace;
                        candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub0_4.lgspFlags |= (uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace;
                        // Match subpatterns 
                        openTasks.Peek().myMatch(matchesList, maxMatches - foundPartialMatches.Count, isoSpace);
                        // Pop subpattern matching task for _sub0_inlined__sub0_4
                        openTasks.Pop();
                        PatternAction_iteratedPathToIntNode.releaseTask(taskFor__sub0_inlined__sub0_4);
                        // Check whether subpatterns were found 
                        if(matchesList.Count>0) {
                            // subpatterns/alternatives were found, extend the partial matches by our local match object
                            foreach(Stack<GRGEN_LIBGR.IMatch> currentFoundPartialMatch in matchesList)
                            {
                                Pattern_iteratedPathToIntNode.Match_iteratedPathToIntNode_alt_0_recursive match = new Pattern_iteratedPathToIntNode.Match_iteratedPathToIntNode_alt_0_recursive();
                                match._node_beg = candidate_iteratedPathToIntNode_node_beg_inlined__sub0_4;
                                match._node_intermediate = candidate_iteratedPathToIntNode_alt_0_recursive_node_intermediate_inlined__sub0_4;
                                match._edge__edge0 = candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub0_4;
                                match.__sub0 = (@Pattern_iteratedPathToIntNode.Match_iteratedPathToIntNode)currentFoundPartialMatch.Pop();
                                match.__sub0._matchOfEnclosingPattern = match;
                                currentFoundPartialMatch.Push(match);
                            }
                            ...
                            if(maxMatches > 0 && foundPartialMatches.Count >= maxMatches)
                            {
                                candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub0_4.lgspFlags = candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub0_4.lgspFlags & ~((uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace) | prevGlobal__candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub0_4;
                                candidate_iteratedPathToIntNode_alt_0_recursive_node_intermediate_inlined__sub0_4.lgspFlags = candidate_iteratedPathToIntNode_alt_0_recursive_node_intermediate_inlined__sub0_4.lgspFlags & ~((uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace) | prevGlobal__candidate_iteratedPathToIntNode_alt_0_recursive_node_intermediate_inlined__sub0_4;
                                openTasks.Push(this);
                                return;
                            }
                            candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub0_4.lgspFlags = candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub0_4.lgspFlags & ~((uint)GRGEN_LGSP.LGSPElemFlags.IS_MATCHED_BY_ENCLOSING_PATTERN << isoSpace) | prevGlobal__candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub0_4;
                    ...
                    while( (candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub0_4 = candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub0_4.lgspOutNext) != head_candidate_iteratedPathToIntNode_alt_0_recursive_edge__edge0_inlined__sub0_4 );
                }
            } while(false);
            openTasks.Push(this);
            return;
    ...
    public class IndependentActions : GRGEN_LGSP.LGSPActions
    {
        ...
        private void InitActions()
        {
            ...
            analyzer.AnalyzeNestingOfPatternGraph(GRGEN_ACTIONS.Pattern_iteratedPath.Instance.patternGraph, false);
            GRGEN_LGSP.PatternGraphAnalyzer.PrepareInline(GRGEN_ACTIONS.Pattern_iteratedPath.Instance.patternGraph);
            analyzer.RememberMatchingPattern(GRGEN_ACTIONS.Pattern_iteratedPath.Instance);
            analyzer.AnalyzeNestingOfPatternGraph(GRGEN_ACTIONS.Pattern_iteratedPathToIntNode.Instance.patternGraph, false);
            GRGEN_LGSP.PatternGraphAnalyzer.PrepareInline(GRGEN_ACTIONS.Pattern_iteratedPathToIntNode.Instance.patternGraph);
            analyzer.RememberMatchingPattern(GRGEN_ACTIONS.Pattern_iteratedPathToIntNode.Instance);
            analyzer.AnalyzeNestingOfPatternGraph(GRGEN_ACTIONS.Rule_create.Instance.patternGraph, false);
            GRGEN_LGSP.PatternGraphAnalyzer.PrepareInline(GRGEN_ACTIONS.Rule_create.Instance.patternGraph);
            analyzer.RememberMatchingPattern(GRGEN_ACTIONS.Rule_create.Instance);
            actions.Add("create", (GRGEN_LGSP.LGSPAction) GRGEN_ACTIONS.Action_create.Instance);
            @create = GRGEN_ACTIONS.Action_create.Instance;
            analyzer.AnalyzeNestingOfPatternGraph(GRGEN_ACTIONS.Rule_find.Instance.patternGraph, false);
            GRGEN_LGSP.PatternGraphAnalyzer.PrepareInline(GRGEN_ACTIONS.Rule_find.Instance.patternGraph);
            analyzer.RememberMatchingPattern(GRGEN_ACTIONS.Rule_find.Instance);
            actions.Add("find", (GRGEN_LGSP.LGSPAction) GRGEN_ACTIONS.Action_find.Instance);
            @find = GRGEN_ACTIONS.Action_find.Instance;
            analyzer.AnalyzeNestingOfPatternGraph(GRGEN_ACTIONS.Rule_findIndependent.Instance.patternGraph, false);
            GRGEN_LGSP.PatternGraphAnalyzer.PrepareInline(GRGEN_ACTIONS.Rule_findIndependent.Instance.patternGraph);
            analyzer.RememberMatchingPattern(GRGEN_ACTIONS.Rule_findIndependent.Instance);
            actions.Add("findIndependent", (GRGEN_LGSP.LGSPAction) GRGEN_ACTIONS.Action_findIndependent.Instance);
            @findIndependent = GRGEN_ACTIONS.Action_findIndependent.Instance;
            analyzer.AnalyzeNestingOfPatternGraph(GRGEN_ACTIONS.Rule_findMultiNested.Instance.patternGraph, false);
            GRGEN_LGSP.PatternGraphAnalyzer.PrepareInline(GRGEN_ACTIONS.Rule_findMultiNested.Instance.patternGraph);
            analyzer.RememberMatchingPattern(GRGEN_ACTIONS.Rule_findMultiNested.Instance);
            actions.Add("findMultiNested", (GRGEN_LGSP.LGSPAction) GRGEN_ACTIONS.Action_findMultiNested.Instance);
            @findMultiNested = GRGEN_ACTIONS.Action_findMultiNested.Instance;
            analyzer.AnalyzeNestingOfPatternGraph(GRGEN_ACTIONS.Rule_createIterated.Instance.patternGraph, false);
            GRGEN_LGSP.PatternGraphAnalyzer.PrepareInline(GRGEN_ACTIONS.Rule_createIterated.Instance.patternGraph);
            analyzer.RememberMatchingPattern(GRGEN_ACTIONS.Rule_createIterated.Instance);
            actions.Add("createIterated", (GRGEN_LGSP.LGSPAction) GRGEN_ACTIONS.Action_createIterated.Instance);
            @createIterated = GRGEN_ACTIONS.Action_createIterated.Instance;
            analyzer.AnalyzeNestingOfPatternGraph(GRGEN_ACTIONS.Rule_findChainPlusChainToInt.Instance.patternGraph, false);
            GRGEN_LGSP.PatternGraphAnalyzer.PrepareInline(GRGEN_ACTIONS.Rule_findChainPlusChainToInt.Instance.patternGraph);
            analyzer.RememberMatchingPattern(GRGEN_ACTIONS.Rule_findChainPlusChainToInt.Instance);
            actions.Add("findChainPlusChainToInt", (GRGEN_LGSP.LGSPAction) GRGEN_ACTIONS.Action_findChainPlusChainToInt.Instance);
            @findChainPlusChainToInt = GRGEN_ACTIONS.Action_findChainPlusChainToInt.Instance;
            analyzer.AnalyzeNestingOfPatternGraph(GRGEN_ACTIONS.Rule_findChainPlusChainToIntIndependent.Instance.patternGraph, false);
            GRGEN_LGSP.PatternGraphAnalyzer.PrepareInline(GRGEN_ACTIONS.Rule_findChainPlusChainToIntIndependent.Instance.patternGraph);
            analyzer.RememberMatchingPattern(GRGEN_ACTIONS.Rule_findChainPlusChainToIntIndependent.Instance);
            actions.Add("findChainPlusChainToIntIndependent", (GRGEN_LGSP.LGSPAction) GRGEN_ACTIONS.Action_findChainPlusChainToIntIndependent.Instance);
            @findChainPlusChainToIntIndependent = GRGEN_ACTIONS.Action_findChainPlusChainToIntIndependent.Instance;
            analyzer.ComputeInterPatternRelations(false);
            analyzer.AnalyzeWithInterPatternRelationsKnown(GRGEN_ACTIONS.Pattern_iteratedPath.Instance.patternGraph);
            analyzer.AnalyzeWithInterPatternRelationsKnown(GRGEN_ACTIONS.Pattern_iteratedPathToIntNode.Instance.patternGraph);
            analyzer.AnalyzeWithInterPatternRelationsKnown(GRGEN_ACTIONS.Rule_create.Instance.patternGraph);
            analyzer.AnalyzeWithInterPatternRelationsKnown(GRGEN_ACTIONS.Rule_find.Instance.patternGraph);
            analyzer.AnalyzeWithInterPatternRelationsKnown(GRGEN_ACTIONS.Rule_findIndependent.Instance.patternGraph);
            analyzer.AnalyzeWithInterPatternRelationsKnown(GRGEN_ACTIONS.Rule_findMultiNested.Instance.patternGraph);
            analyzer.AnalyzeWithInterPatternRelationsKnown(GRGEN_ACTIONS.Rule_createIterated.Instance.patternGraph);
            analyzer.AnalyzeWithInterPatternRelationsKnown(GRGEN_ACTIONS.Rule_findChainPlusChainToInt.Instance.patternGraph);
            analyzer.AnalyzeWithInterPatternRelationsKnown(GRGEN_ACTIONS.Rule_findChainPlusChainToIntIndependent.Instance.patternGraph);
            analyzer.InlineSubpatternUsages(GRGEN_ACTIONS.Pattern_iteratedPath.Instance.patternGraph);
            analyzer.InlineSubpatternUsages(GRGEN_ACTIONS.Pattern_iteratedPathToIntNode.Instance.patternGraph);
            analyzer.InlineSubpatternUsages(GRGEN_ACTIONS.Rule_create.Instance.patternGraph);
            analyzer.InlineSubpatternUsages(GRGEN_ACTIONS.Rule_find.Instance.patternGraph);
            analyzer.InlineSubpatternUsages(GRGEN_ACTIONS.Rule_findIndependent.Instance.patternGraph);
            analyzer.InlineSubpatternUsages(GRGEN_ACTIONS.Rule_findMultiNested.Instance.patternGraph);
            analyzer.InlineSubpatternUsages(GRGEN_ACTIONS.Rule_createIterated.Instance.patternGraph);
            analyzer.InlineSubpatternUsages(GRGEN_ACTIONS.Rule_findChainPlusChainToInt.Instance.patternGraph);
            analyzer.InlineSubpatternUsages(GRGEN_ACTIONS.Rule_findChainPlusChainToIntIndependent.Instance.patternGraph);
            GRGEN_ACTIONS.Pattern_iteratedPath.Instance.patternGraph.maxIsoSpace = 0;
            GRGEN_ACTIONS.Pattern_iteratedPathToIntNode.Instance.patternGraph.maxIsoSpace = 0;
            GRGEN_ACTIONS.Rule_create.Instance.patternGraph.maxIsoSpace = 0;
            GRGEN_ACTIONS.Rule_find.Instance.patternGraph.maxIsoSpace = 0;
            GRGEN_ACTIONS.Rule_findIndependent.Instance.patternGraph.maxIsoSpace = 0;
            GRGEN_ACTIONS.Rule_findMultiNested.Instance.patternGraph.maxIsoSpace = 0;
            GRGEN_ACTIONS.Rule_createIterated.Instance.patternGraph.maxIsoSpace = 0;
            GRGEN_ACTIONS.Rule_findChainPlusChainToInt.Instance.patternGraph.maxIsoSpace = 0;
            GRGEN_ACTIONS.Rule_findChainPlusChainToIntIndependent.Instance.patternGraph.maxIsoSpace = 0;
            analyzer.AnalyzeNestingOfPatternGraph(GRGEN_ACTIONS.Pattern_iteratedPath.Instance.patternGraph, true);
            analyzer.AnalyzeNestingOfPatternGraph(GRGEN_ACTIONS.Pattern_iteratedPathToIntNode.Instance.patternGraph, true);
            analyzer.AnalyzeNestingOfPatternGraph(GRGEN_ACTIONS.Rule_create.Instance.patternGraph, true);
            analyzer.AnalyzeNestingOfPatternGraph(GRGEN_ACTIONS.Rule_find.Instance.patternGraph, true);
            analyzer.AnalyzeNestingOfPatternGraph(GRGEN_ACTIONS.Rule_findIndependent.Instance.patternGraph, true);
            analyzer.AnalyzeNestingOfPatternGraph(GRGEN_ACTIONS.Rule_findMultiNested.Instance.patternGraph, true);
            analyzer.AnalyzeNestingOfPatternGraph(GRGEN_ACTIONS.Rule_createIterated.Instance.patternGraph, true);
            analyzer.AnalyzeNestingOfPatternGraph(GRGEN_ACTIONS.Rule_findChainPlusChainToInt.Instance.patternGraph, true);
            analyzer.AnalyzeNestingOfPatternGraph(GRGEN_ACTIONS.Rule_findChainPlusChainToIntIndependent.Instance.patternGraph, true);
            analyzer.ComputeInterPatternRelations(true);
        }
        
        public GRGEN_ACTIONS.IAction_create @create;
        public GRGEN_ACTIONS.IAction_find @find;
        public GRGEN_ACTIONS.IAction_findIndependent @findIndependent;
        public GRGEN_ACTIONS.IAction_findMultiNested @findMultiNested;
        public GRGEN_ACTIONS.IAction_createIterated @createIterated;
        public GRGEN_ACTIONS.IAction_findChainPlusChainToInt @findChainPlusChainToInt;
        public GRGEN_ACTIONS.IAction_findChainPlusChainToIntIndependent @findChainPlusChainToIntIndependent;
        ...
        public override IList ArrayOrderAscendingBy(IList array, string member)
        {
            ...
            else
            {
                ...
                case "findIndependent":
                    switch(member)
                    {
                    default:
                        return null;
                    }
                case "findMultiNested":
                    switch(member)
                    {
                    default:
                        return null;
                ...
                case "findChainPlusChainToInt":
                    switch(member)
                    {
                    default:
                        return null;
                    }
                case "findChainPlusChainToIntIndependent":
                    switch(member)
                    {
                    default:
                        return null;
        ...
        public override IList ArrayGroupBy(IList array, string member)
        {
            ...
            else
            {
                ...
                case "find":
                    ...
                    {
                    case "beg":
                        return ArrayHelper.Array_find_groupBy_beg(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array));
                    case "_node0":
                        return ArrayHelper.Array_find_groupBy__node0(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array));
                    case "end":
                        return ArrayHelper.Array_find_groupBy_end(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array));
                    case "_node1":
                        return ArrayHelper.Array_find_groupBy__node1(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array));
                    case "_edge0":
                        return ArrayHelper.Array_find_groupBy__edge0(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array));
                    case "_edge1":
                        return ArrayHelper.Array_find_groupBy__edge1(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array));
                    case "_edge2":
                        return ArrayHelper.Array_find_groupBy__edge2(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array));
                    case "_edge3":
                        return ArrayHelper.Array_find_groupBy__edge3(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array));
                    default:
                        return null;
                    }
                case "findIndependent":
                    ...
                    {
                    case "beg":
                        return ArrayHelper.Array_findIndependent_groupBy_beg(GRGEN_ACTIONS.Rule_findIndependent.ConvertAsNeeded(array));
                    case "_node0":
                        return ArrayHelper.Array_findIndependent_groupBy__node0(GRGEN_ACTIONS.Rule_findIndependent.ConvertAsNeeded(array));
                    case "end":
                        return ArrayHelper.Array_findIndependent_groupBy_end(GRGEN_ACTIONS.Rule_findIndependent.ConvertAsNeeded(array));
                    case "_edge0":
                        return ArrayHelper.Array_findIndependent_groupBy__edge0(GRGEN_ACTIONS.Rule_findIndependent.ConvertAsNeeded(array));
                    case "_edge1":
                        return ArrayHelper.Array_findIndependent_groupBy__edge1(GRGEN_ACTIONS.Rule_findIndependent.ConvertAsNeeded(array));
                    default:
                        return null;
                    }
                case "findMultiNested":
                    ...
                    {
                    case "beg":
                        return ArrayHelper.Array_findMultiNested_groupBy_beg(GRGEN_ACTIONS.Rule_findMultiNested.ConvertAsNeeded(array));
                    case "_node0":
                        return ArrayHelper.Array_findMultiNested_groupBy__node0(GRGEN_ACTIONS.Rule_findMultiNested.ConvertAsNeeded(array));
                    case "end":
                        return ArrayHelper.Array_findMultiNested_groupBy_end(GRGEN_ACTIONS.Rule_findMultiNested.ConvertAsNeeded(array));
                    case "_edge0":
                        return ArrayHelper.Array_findMultiNested_groupBy__edge0(GRGEN_ACTIONS.Rule_findMultiNested.ConvertAsNeeded(array));
                    case "_edge1":
                        return ArrayHelper.Array_findMultiNested_groupBy__edge1(GRGEN_ACTIONS.Rule_findMultiNested.ConvertAsNeeded(array));
                    default:
                        return null;
                    }
                case "createIterated":
                ...
                case "findChainPlusChainToInt":
                    ...
                    {
                    case "beg":
                        return ArrayHelper.Array_findChainPlusChainToInt_groupBy_beg(GRGEN_ACTIONS.Rule_findChainPlusChainToInt.ConvertAsNeeded(array));
                    case "end":
                        return ArrayHelper.Array_findChainPlusChainToInt_groupBy_end(GRGEN_ACTIONS.Rule_findChainPlusChainToInt.ConvertAsNeeded(array));
                    default:
                        return null;
                    }
                case "findChainPlusChainToIntIndependent":
                    ...
                    {
                    case "beg":
                        return ArrayHelper.Array_findChainPlusChainToIntIndependent_groupBy_beg(GRGEN_ACTIONS.Rule_findChainPlusChainToIntIndependent.ConvertAsNeeded(array));
                    case "end":
                        return ArrayHelper.Array_findChainPlusChainToIntIndependent_groupBy_end(GRGEN_ACTIONS.Rule_findChainPlusChainToIntIndependent.ConvertAsNeeded(array));
                    default:
                        return null;
                    }
                default:
        ...
        public override IList ArrayKeepOneForEach(IList array, string member)
        {
            ...
            else
            {
                ...
                case "find":
                    ...
                    {
                    case "beg":
                        return ArrayHelper.Array_find_keepOneForEachBy_beg(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array));
                    case "_node0":
                        return ArrayHelper.Array_find_keepOneForEachBy__node0(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array));
                    case "end":
                        return ArrayHelper.Array_find_keepOneForEachBy_end(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array));
                    case "_node1":
                        return ArrayHelper.Array_find_keepOneForEachBy__node1(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array));
                    case "_edge0":
                        return ArrayHelper.Array_find_keepOneForEachBy__edge0(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array));
                    case "_edge1":
                        return ArrayHelper.Array_find_keepOneForEachBy__edge1(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array));
                    case "_edge2":
                        return ArrayHelper.Array_find_keepOneForEachBy__edge2(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array));
                    case "_edge3":
                        return ArrayHelper.Array_find_keepOneForEachBy__edge3(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array));
                    default:
                        return null;
                    }
                case "findIndependent":
                    ...
                    {
                    case "beg":
                        return ArrayHelper.Array_findIndependent_keepOneForEachBy_beg(GRGEN_ACTIONS.Rule_findIndependent.ConvertAsNeeded(array));
                    case "_node0":
                        return ArrayHelper.Array_findIndependent_keepOneForEachBy__node0(GRGEN_ACTIONS.Rule_findIndependent.ConvertAsNeeded(array));
                    case "end":
                        return ArrayHelper.Array_findIndependent_keepOneForEachBy_end(GRGEN_ACTIONS.Rule_findIndependent.ConvertAsNeeded(array));
                    case "_edge0":
                        return ArrayHelper.Array_findIndependent_keepOneForEachBy__edge0(GRGEN_ACTIONS.Rule_findIndependent.ConvertAsNeeded(array));
                    case "_edge1":
                        return ArrayHelper.Array_findIndependent_keepOneForEachBy__edge1(GRGEN_ACTIONS.Rule_findIndependent.ConvertAsNeeded(array));
                    default:
                        return null;
                    }
                case "findMultiNested":
                    ...
                    {
                    case "beg":
                        return ArrayHelper.Array_findMultiNested_keepOneForEachBy_beg(GRGEN_ACTIONS.Rule_findMultiNested.ConvertAsNeeded(array));
                    case "_node0":
                        return ArrayHelper.Array_findMultiNested_keepOneForEachBy__node0(GRGEN_ACTIONS.Rule_findMultiNested.ConvertAsNeeded(array));
                    case "end":
                        return ArrayHelper.Array_findMultiNested_keepOneForEachBy_end(GRGEN_ACTIONS.Rule_findMultiNested.ConvertAsNeeded(array));
                    case "_edge0":
                        return ArrayHelper.Array_findMultiNested_keepOneForEachBy__edge0(GRGEN_ACTIONS.Rule_findMultiNested.ConvertAsNeeded(array));
                    case "_edge1":
                        return ArrayHelper.Array_findMultiNested_keepOneForEachBy__edge1(GRGEN_ACTIONS.Rule_findMultiNested.ConvertAsNeeded(array));
                    default:
                        return null;
                    }
                case "createIterated":
                ...
                case "findChainPlusChainToInt":
                    ...
                    {
                    case "beg":
                        return ArrayHelper.Array_findChainPlusChainToInt_keepOneForEachBy_beg(GRGEN_ACTIONS.Rule_findChainPlusChainToInt.ConvertAsNeeded(array));
                    case "end":
                        return ArrayHelper.Array_findChainPlusChainToInt_keepOneForEachBy_end(GRGEN_ACTIONS.Rule_findChainPlusChainToInt.ConvertAsNeeded(array));
                    default:
                        return null;
                    }
                case "findChainPlusChainToIntIndependent":
                    ...
                    {
                    case "beg":
                        return ArrayHelper.Array_findChainPlusChainToIntIndependent_keepOneForEachBy_beg(GRGEN_ACTIONS.Rule_findChainPlusChainToIntIndependent.ConvertAsNeeded(array));
                    case "end":
                        return ArrayHelper.Array_findChainPlusChainToIntIndependent_keepOneForEachBy_end(GRGEN_ACTIONS.Rule_findChainPlusChainToIntIndependent.ConvertAsNeeded(array));
                    default:
                        return null;
                    }
                default:
        ...
        public override int ArrayIndexOfBy(IList array, string member, object value)
        {
            ...
            else
            {
                ...
                case "find":
                    ...
                    {
                    case "beg":
                        return ArrayHelper.Array_find_indexOfBy_beg(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value);
                    case "_node0":
                        return ArrayHelper.Array_find_indexOfBy__node0(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value);
                    case "end":
                        return ArrayHelper.Array_find_indexOfBy_end(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value);
                    case "_node1":
                        return ArrayHelper.Array_find_indexOfBy__node1(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value);
                    case "_edge0":
                        return ArrayHelper.Array_find_indexOfBy__edge0(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array), (GRGEN_LIBGR.IDEdge)value);
                    case "_edge1":
                        return ArrayHelper.Array_find_indexOfBy__edge1(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array), (GRGEN_LIBGR.IDEdge)value);
                    case "_edge2":
                        return ArrayHelper.Array_find_indexOfBy__edge2(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array), (GRGEN_LIBGR.IDEdge)value);
                    case "_edge3":
                        return ArrayHelper.Array_find_indexOfBy__edge3(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array), (GRGEN_LIBGR.IDEdge)value);
                    default:
                        return -1;
                    }
                case "findIndependent":
                    ...
                    {
                    case "beg":
                        return ArrayHelper.Array_findIndependent_indexOfBy_beg(GRGEN_ACTIONS.Rule_findIndependent.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value);
                    case "_node0":
                        return ArrayHelper.Array_findIndependent_indexOfBy__node0(GRGEN_ACTIONS.Rule_findIndependent.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value);
                    case "end":
                        return ArrayHelper.Array_findIndependent_indexOfBy_end(GRGEN_ACTIONS.Rule_findIndependent.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value);
                    case "_edge0":
                        return ArrayHelper.Array_findIndependent_indexOfBy__edge0(GRGEN_ACTIONS.Rule_findIndependent.ConvertAsNeeded(array), (GRGEN_LIBGR.IDEdge)value);
                    case "_edge1":
                        return ArrayHelper.Array_findIndependent_indexOfBy__edge1(GRGEN_ACTIONS.Rule_findIndependent.ConvertAsNeeded(array), (GRGEN_LIBGR.IDEdge)value);
                    default:
                        return -1;
                    }
                case "findMultiNested":
                    ...
                    {
                    case "beg":
                        return ArrayHelper.Array_findMultiNested_indexOfBy_beg(GRGEN_ACTIONS.Rule_findMultiNested.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value);
                    case "_node0":
                        return ArrayHelper.Array_findMultiNested_indexOfBy__node0(GRGEN_ACTIONS.Rule_findMultiNested.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value);
                    case "end":
                        return ArrayHelper.Array_findMultiNested_indexOfBy_end(GRGEN_ACTIONS.Rule_findMultiNested.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value);
                    case "_edge0":
                        return ArrayHelper.Array_findMultiNested_indexOfBy__edge0(GRGEN_ACTIONS.Rule_findMultiNested.ConvertAsNeeded(array), (GRGEN_LIBGR.IDEdge)value);
                    case "_edge1":
                        return ArrayHelper.Array_findMultiNested_indexOfBy__edge1(GRGEN_ACTIONS.Rule_findMultiNested.ConvertAsNeeded(array), (GRGEN_LIBGR.IDEdge)value);
                    default:
                        return -1;
                    }
                case "createIterated":
                ...
                case "findChainPlusChainToInt":
                    ...
                    {
                    case "beg":
                        return ArrayHelper.Array_findChainPlusChainToInt_indexOfBy_beg(GRGEN_ACTIONS.Rule_findChainPlusChainToInt.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value);
                    case "end":
                        return ArrayHelper.Array_findChainPlusChainToInt_indexOfBy_end(GRGEN_ACTIONS.Rule_findChainPlusChainToInt.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value);
                    default:
                        return -1;
                    }
                case "findChainPlusChainToIntIndependent":
                    ...
                    {
                    case "beg":
                        return ArrayHelper.Array_findChainPlusChainToIntIndependent_indexOfBy_beg(GRGEN_ACTIONS.Rule_findChainPlusChainToIntIndependent.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value);
                    case "end":
                        return ArrayHelper.Array_findChainPlusChainToIntIndependent_indexOfBy_end(GRGEN_ACTIONS.Rule_findChainPlusChainToIntIndependent.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value);
                    default:
                        return -1;
                    }
                default:
        ...
        public override int ArrayIndexOfBy(IList array, string member, object value, int startIndex)
        {
            ...
            else
            {
                ...
                case "find":
                    ...
                    {
                    case "beg":
                        return ArrayHelper.Array_find_indexOfBy_beg(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value, startIndex);
                    case "_node0":
                        return ArrayHelper.Array_find_indexOfBy__node0(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value, startIndex);
                    case "end":
                        return ArrayHelper.Array_find_indexOfBy_end(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value, startIndex);
                    case "_node1":
                        return ArrayHelper.Array_find_indexOfBy__node1(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value, startIndex);
                    case "_edge0":
                        return ArrayHelper.Array_find_indexOfBy__edge0(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array), (GRGEN_LIBGR.IDEdge)value, startIndex);
                    case "_edge1":
                        return ArrayHelper.Array_find_indexOfBy__edge1(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array), (GRGEN_LIBGR.IDEdge)value, startIndex);
                    case "_edge2":
                        return ArrayHelper.Array_find_indexOfBy__edge2(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array), (GRGEN_LIBGR.IDEdge)value, startIndex);
                    case "_edge3":
                        return ArrayHelper.Array_find_indexOfBy__edge3(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array), (GRGEN_LIBGR.IDEdge)value, startIndex);
                    default:
                        return -1;
                    }
                case "findIndependent":
                    ...
                    {
                    case "beg":
                        return ArrayHelper.Array_findIndependent_indexOfBy_beg(GRGEN_ACTIONS.Rule_findIndependent.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value, startIndex);
                    case "_node0":
                        return ArrayHelper.Array_findIndependent_indexOfBy__node0(GRGEN_ACTIONS.Rule_findIndependent.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value, startIndex);
                    case "end":
                        return ArrayHelper.Array_findIndependent_indexOfBy_end(GRGEN_ACTIONS.Rule_findIndependent.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value, startIndex);
                    case "_edge0":
                        return ArrayHelper.Array_findIndependent_indexOfBy__edge0(GRGEN_ACTIONS.Rule_findIndependent.ConvertAsNeeded(array), (GRGEN_LIBGR.IDEdge)value, startIndex);
                    case "_edge1":
                        return ArrayHelper.Array_findIndependent_indexOfBy__edge1(GRGEN_ACTIONS.Rule_findIndependent.ConvertAsNeeded(array), (GRGEN_LIBGR.IDEdge)value, startIndex);
                    default:
                        return -1;
                    }
                case "findMultiNested":
                    ...
                    {
                    case "beg":
                        return ArrayHelper.Array_findMultiNested_indexOfBy_beg(GRGEN_ACTIONS.Rule_findMultiNested.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value, startIndex);
                    case "_node0":
                        return ArrayHelper.Array_findMultiNested_indexOfBy__node0(GRGEN_ACTIONS.Rule_findMultiNested.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value, startIndex);
                    case "end":
                        return ArrayHelper.Array_findMultiNested_indexOfBy_end(GRGEN_ACTIONS.Rule_findMultiNested.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value, startIndex);
                    case "_edge0":
                        return ArrayHelper.Array_findMultiNested_indexOfBy__edge0(GRGEN_ACTIONS.Rule_findMultiNested.ConvertAsNeeded(array), (GRGEN_LIBGR.IDEdge)value, startIndex);
                    case "_edge1":
                        return ArrayHelper.Array_findMultiNested_indexOfBy__edge1(GRGEN_ACTIONS.Rule_findMultiNested.ConvertAsNeeded(array), (GRGEN_LIBGR.IDEdge)value, startIndex);
                    default:
                        return -1;
                    }
                case "createIterated":
                ...
                case "findChainPlusChainToInt":
                    ...
                    {
                    case "beg":
                        return ArrayHelper.Array_findChainPlusChainToInt_indexOfBy_beg(GRGEN_ACTIONS.Rule_findChainPlusChainToInt.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value, startIndex);
                    case "end":
                        return ArrayHelper.Array_findChainPlusChainToInt_indexOfBy_end(GRGEN_ACTIONS.Rule_findChainPlusChainToInt.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value, startIndex);
                    default:
                        return -1;
                    }
                case "findChainPlusChainToIntIndependent":
                    ...
                    {
                    case "beg":
                        return ArrayHelper.Array_findChainPlusChainToIntIndependent_indexOfBy_beg(GRGEN_ACTIONS.Rule_findChainPlusChainToIntIndependent.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value, startIndex);
                    case "end":
                        return ArrayHelper.Array_findChainPlusChainToIntIndependent_indexOfBy_end(GRGEN_ACTIONS.Rule_findChainPlusChainToIntIndependent.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value, startIndex);
                    default:
                        return -1;
                    }
                default:
        ...
        public override int ArrayLastIndexOfBy(IList array, string member, object value)
        {
            ...
            else
            {
                ...
                case "find":
                    ...
                    {
                    case "beg":
                        return ArrayHelper.Array_find_lastIndexOfBy_beg(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value);
                    case "_node0":
                        return ArrayHelper.Array_find_lastIndexOfBy__node0(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value);
                    case "end":
                        return ArrayHelper.Array_find_lastIndexOfBy_end(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value);
                    case "_node1":
                        return ArrayHelper.Array_find_lastIndexOfBy__node1(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value);
                    case "_edge0":
                        return ArrayHelper.Array_find_lastIndexOfBy__edge0(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array), (GRGEN_LIBGR.IDEdge)value);
                    case "_edge1":
                        return ArrayHelper.Array_find_lastIndexOfBy__edge1(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array), (GRGEN_LIBGR.IDEdge)value);
                    case "_edge2":
                        return ArrayHelper.Array_find_lastIndexOfBy__edge2(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array), (GRGEN_LIBGR.IDEdge)value);
                    case "_edge3":
                        return ArrayHelper.Array_find_lastIndexOfBy__edge3(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array), (GRGEN_LIBGR.IDEdge)value);
                    default:
                        return -1;
                    }
                case "findIndependent":
                    ...
                    {
                    case "beg":
                        return ArrayHelper.Array_findIndependent_lastIndexOfBy_beg(GRGEN_ACTIONS.Rule_findIndependent.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value);
                    case "_node0":
                        return ArrayHelper.Array_findIndependent_lastIndexOfBy__node0(GRGEN_ACTIONS.Rule_findIndependent.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value);
                    case "end":
                        return ArrayHelper.Array_findIndependent_lastIndexOfBy_end(GRGEN_ACTIONS.Rule_findIndependent.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value);
                    case "_edge0":
                        return ArrayHelper.Array_findIndependent_lastIndexOfBy__edge0(GRGEN_ACTIONS.Rule_findIndependent.ConvertAsNeeded(array), (GRGEN_LIBGR.IDEdge)value);
                    case "_edge1":
                        return ArrayHelper.Array_findIndependent_lastIndexOfBy__edge1(GRGEN_ACTIONS.Rule_findIndependent.ConvertAsNeeded(array), (GRGEN_LIBGR.IDEdge)value);
                    default:
                        return -1;
                    }
                case "findMultiNested":
                    ...
                    {
                    case "beg":
                        return ArrayHelper.Array_findMultiNested_lastIndexOfBy_beg(GRGEN_ACTIONS.Rule_findMultiNested.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value);
                    case "_node0":
                        return ArrayHelper.Array_findMultiNested_lastIndexOfBy__node0(GRGEN_ACTIONS.Rule_findMultiNested.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value);
                    case "end":
                        return ArrayHelper.Array_findMultiNested_lastIndexOfBy_end(GRGEN_ACTIONS.Rule_findMultiNested.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value);
                    case "_edge0":
                        return ArrayHelper.Array_findMultiNested_lastIndexOfBy__edge0(GRGEN_ACTIONS.Rule_findMultiNested.ConvertAsNeeded(array), (GRGEN_LIBGR.IDEdge)value);
                    case "_edge1":
                        return ArrayHelper.Array_findMultiNested_lastIndexOfBy__edge1(GRGEN_ACTIONS.Rule_findMultiNested.ConvertAsNeeded(array), (GRGEN_LIBGR.IDEdge)value);
                    default:
                        return -1;
                    }
                case "createIterated":
                ...
                case "findChainPlusChainToInt":
                    ...
                    {
                    case "beg":
                        return ArrayHelper.Array_findChainPlusChainToInt_lastIndexOfBy_beg(GRGEN_ACTIONS.Rule_findChainPlusChainToInt.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value);
                    case "end":
                        return ArrayHelper.Array_findChainPlusChainToInt_lastIndexOfBy_end(GRGEN_ACTIONS.Rule_findChainPlusChainToInt.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value);
                    default:
                        return -1;
                    }
                case "findChainPlusChainToIntIndependent":
                    ...
                    {
                    case "beg":
                        return ArrayHelper.Array_findChainPlusChainToIntIndependent_lastIndexOfBy_beg(GRGEN_ACTIONS.Rule_findChainPlusChainToIntIndependent.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value);
                    case "end":
                        return ArrayHelper.Array_findChainPlusChainToIntIndependent_lastIndexOfBy_end(GRGEN_ACTIONS.Rule_findChainPlusChainToIntIndependent.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value);
                    default:
                        return -1;
                    }
                default:
        ...
        public override int ArrayLastIndexOfBy(IList array, string member, object value, int startIndex)
        {
            ...
            else
            {
                ...
                case "find":
                    ...
                    {
                    case "beg":
                        return ArrayHelper.Array_find_lastIndexOfBy_beg(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value, startIndex);
                    case "_node0":
                        return ArrayHelper.Array_find_lastIndexOfBy__node0(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value, startIndex);
                    case "end":
                        return ArrayHelper.Array_find_lastIndexOfBy_end(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value, startIndex);
                    case "_node1":
                        return ArrayHelper.Array_find_lastIndexOfBy__node1(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value, startIndex);
                    case "_edge0":
                        return ArrayHelper.Array_find_lastIndexOfBy__edge0(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array), (GRGEN_LIBGR.IDEdge)value, startIndex);
                    case "_edge1":
                        return ArrayHelper.Array_find_lastIndexOfBy__edge1(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array), (GRGEN_LIBGR.IDEdge)value, startIndex);
                    case "_edge2":
                        return ArrayHelper.Array_find_lastIndexOfBy__edge2(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array), (GRGEN_LIBGR.IDEdge)value, startIndex);
                    case "_edge3":
                        return ArrayHelper.Array_find_lastIndexOfBy__edge3(GRGEN_ACTIONS.Rule_find.ConvertAsNeeded(array), (GRGEN_LIBGR.IDEdge)value, startIndex);
                    default:
                        return -1;
                    }
                case "findIndependent":
                    ...
                    {
                    case "beg":
                        return ArrayHelper.Array_findIndependent_lastIndexOfBy_beg(GRGEN_ACTIONS.Rule_findIndependent.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value, startIndex);
                    case "_node0":
                        return ArrayHelper.Array_findIndependent_lastIndexOfBy__node0(GRGEN_ACTIONS.Rule_findIndependent.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value, startIndex);
                    case "end":
                        return ArrayHelper.Array_findIndependent_lastIndexOfBy_end(GRGEN_ACTIONS.Rule_findIndependent.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value, startIndex);
                    case "_edge0":
                        return ArrayHelper.Array_findIndependent_lastIndexOfBy__edge0(GRGEN_ACTIONS.Rule_findIndependent.ConvertAsNeeded(array), (GRGEN_LIBGR.IDEdge)value, startIndex);
                    case "_edge1":
                        return ArrayHelper.Array_findIndependent_lastIndexOfBy__edge1(GRGEN_ACTIONS.Rule_findIndependent.ConvertAsNeeded(array), (GRGEN_LIBGR.IDEdge)value, startIndex);
                    default:
                        return -1;
                    }
                case "findMultiNested":
                    ...
                    {
                    case "beg":
                        return ArrayHelper.Array_findMultiNested_lastIndexOfBy_beg(GRGEN_ACTIONS.Rule_findMultiNested.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value, startIndex);
                    case "_node0":
                        return ArrayHelper.Array_findMultiNested_lastIndexOfBy__node0(GRGEN_ACTIONS.Rule_findMultiNested.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value, startIndex);
                    case "end":
                        return ArrayHelper.Array_findMultiNested_lastIndexOfBy_end(GRGEN_ACTIONS.Rule_findMultiNested.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value, startIndex);
                    case "_edge0":
                        return ArrayHelper.Array_findMultiNested_lastIndexOfBy__edge0(GRGEN_ACTIONS.Rule_findMultiNested.ConvertAsNeeded(array), (GRGEN_LIBGR.IDEdge)value, startIndex);
                    case "_edge1":
                        return ArrayHelper.Array_findMultiNested_lastIndexOfBy__edge1(GRGEN_ACTIONS.Rule_findMultiNested.ConvertAsNeeded(array), (GRGEN_LIBGR.IDEdge)value, startIndex);
                    default:
                        return -1;
                    }
                case "createIterated":
                ...
                case "findChainPlusChainToInt":
                    ...
                    {
                    case "beg":
                        return ArrayHelper.Array_findChainPlusChainToInt_lastIndexOfBy_beg(GRGEN_ACTIONS.Rule_findChainPlusChainToInt.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value, startIndex);
                    case "end":
                        return ArrayHelper.Array_findChainPlusChainToInt_lastIndexOfBy_end(GRGEN_ACTIONS.Rule_findChainPlusChainToInt.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value, startIndex);
                    default:
                        return -1;
                    }
                case "findChainPlusChainToIntIndependent":
                    ...
                    {
                    case "beg":
                        return ArrayHelper.Array_findChainPlusChainToIntIndependent_lastIndexOfBy_beg(GRGEN_ACTIONS.Rule_findChainPlusChainToIntIndependent.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value, startIndex);
                    case "end":
                        return ArrayHelper.Array_findChainPlusChainToIntIndependent_lastIndexOfBy_end(GRGEN_ACTIONS.Rule_findChainPlusChainToIntIndependent.ConvertAsNeeded(array), (GRGEN_LIBGR.INode)value, startIndex);
                    default:
                        return -1;
                    }
                default:
