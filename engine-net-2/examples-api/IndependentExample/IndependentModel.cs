...
// Generated from "..\..\tests\independent\Independent.grg" on Sun Mar 23 22:55:36 CET 2014
...
namespace de.unika.ipd.grGen.Model_Independent
{
	...
	public sealed class IndependentGraphModel : GRGEN_LGSP.LGSPGraphModel
	{
		...
		public override void CreateAndBindIndexSet(GRGEN_LGSP.LGSPGraph graph) {
			graph.indices = new IndependentIndexSet(graph);
		}
		public override void FillIndexSetAsClone(GRGEN_LGSP.LGSPGraph graph, GRGEN_LGSP.LGSPGraph originalGraph, IDictionary<GRGEN_LIBGR.IGraphElement, GRGEN_LIBGR.IGraphElement> oldToNewMap) {
			((IndependentIndexSet)graph.indices).FillAsClone(originalGraph, oldToNewMap);
		}
