...
namespace de.unika.ipd.grGen.Model_ExternalAttributeEvaluation
{
    ...
    {
        public static bool IsEqual(object this_, object that, IDictionary<object, object> oldToNewObjectMap)
        {
		...
		public static bool IsLower(object this_, object that, IDictionary<object, object> oldToNewObjectMap)
        {
        ...
        public static bool IsEqual(Own this_, Own that, IDictionary<object, object> oldToNewObjectMap)
        {
            return this_ == that; // equal if identical, default implementation
        }
		
		public static bool IsLower(Own this_, Own that, IDictionary<object, object> oldToNewObjectMap)
        {
            throw new Exception("not implemented");
        }
        ...
        public static bool IsEqual(OwnPown this_, OwnPown that, IDictionary<object, object> oldToNewObjectMap)
        {
            return this_.ehe == that.ehe;
        }

		public static bool IsLower(OwnPown this_, OwnPown that, IDictionary<object, object> oldToNewObjectMap)
		{
        ...
        public static bool IsEqual(OwnPownHome this_, OwnPownHome that, IDictionary<object, object> oldToNewObjectMap)
        {
            return this_.ehe == that.ehe && this_.aha == that.aha;
        }

		public static bool IsLower(OwnPownHome this_, OwnPownHome that, IDictionary<object, object> oldToNewObjectMap)
		{
