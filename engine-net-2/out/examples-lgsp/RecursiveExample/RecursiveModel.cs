...
namespace de.unika.ipd.grGen.Model_Recursive
{
	//
	// Enums
	//
	...
	public sealed class RecursiveNodeModel : INodeModel
	{
		public RecursiveNodeModel()
		{
	...
	public sealed class RecursiveEdgeModel : IEdgeModel
	{
		public RecursiveEdgeModel()
		{
	...
	public sealed class RecursiveGraphModel : IGraphModel
	{
		private RecursiveNodeModel nodeModel = new RecursiveNodeModel();
		private RecursiveEdgeModel edgeModel = new RecursiveEdgeModel();
		private ValidateInfo[] validateInfos = {
		};

		public String Name { get { return "Recursive"; } }
