        ...
        static int Main(string[] args)
        {
                ...
                if(args[i][0] == '-')
                {
                    switch(args[i])
                    {
                        ...
                        case "-use":
                            ...
                            dirname = args[++i];
                            flags |= ProcessSpecFlags.UseFrontendGeneratedFiles;
            ...
            if(specFile == null)
            {
                ConsoleUI.outWriter.WriteLine(
                    ...
                    + "  -use <existing-dir>   Use old C# files generated by the frontend\n"
                    ...
                    + "  -profile              Instruments the matcher code\n"
                    + "                        to count the search steps carried out.\n"
                    ...
                    + "                        Mostly attribute change events. Imapcts transactions,\n"
                    + "                        recording, persistence, debugging/graph change display.");
                return 1;
            }
