...
namespace de.unika.ipd.grGen.lgsp
{
    ...
    public abstract class LGSPRulePattern : LGSPMatchingPattern, IRulePattern
    {
        ...
        /// <summary>
        /// Returns whether the filter is available to be called (filter function package prefixed)
        /// </summary>
    ...
    {
        public LGSPFilterAutoGenerated(String name, String package, String packagePrefixedName, string[] entities)
