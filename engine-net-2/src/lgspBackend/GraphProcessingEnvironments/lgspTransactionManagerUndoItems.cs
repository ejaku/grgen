...
namespace de.unika.ipd.grGen.lgsp
{
    ...
    ////////////////////////////////////////////////////////////////////////////////
    {
        ...
        public override string ToString()
        {
            ...
            {
                if(_attrType.Kind == AttributeKind.SetAttr)
                    return NameDotAttribute() + ".add(" + EmitHelper.ToStringAutomatic(_value, _graph, false, null, null, null) + ")";
                else if(_attrType.Kind == AttributeKind.MapAttr)
                    return NameDotAttribute() + ".add(" + EmitHelper.ToStringAutomatic(_keyOfValue, _graph, false, null, null, null) + ", " + EmitHelper.ToStringAutomatic(_value, _graph, false, null, null, null) + ")";
                else if(_attrType.Kind == AttributeKind.ArrayAttr)
                {
                    if(_keyOfValue == null)
                        return NameDotAttribute() + ".add(" + EmitHelper.ToStringAutomatic(_value, _graph, false, null, null, null) + ")";
            ...
            {
                if(_attrType.Kind == AttributeKind.SetAttr)
                    return NameDotAttribute() + ".rem(" + EmitHelper.ToStringAutomatic(_value, _graph, false, null, null, null) + ")";
                else if(_attrType.Kind == AttributeKind.MapAttr)
                    return NameDotAttribute() + ".rem(" + EmitHelper.ToStringAutomatic(_keyOfValue, _graph, false, null, null, null) + ")";
                else if(_attrType.Kind == AttributeKind.ArrayAttr)
                {
                    if(_keyOfValue == null)
            ...
            {
                if(_attrType.Kind == AttributeKind.ArrayAttr)
                    return NameDotAttribute() + "[" + EmitHelper.ToStringAutomatic(_keyOfValue, _graph, false, null, null, null) + "] = " + EmitHelper.ToStringAutomatic(_value, _graph, false, null, null, null);
                else //if(_attrType.Kind == AttributeKind.DequeAttr)
                    return NameDotAttribute() + "[" + EmitHelper.ToStringAutomatic(_keyOfValue, _graph, false, null, null, null) + "] = " + EmitHelper.ToStringAutomatic(_value, _graph, false, null, null, null);
            }
            else if(_undoOperation == UndoOperation.Assign)
                return NameDotAttribute() + " = " + EmitHelper.ToStringAutomatic(_value, _graph, false, null, null, null);
