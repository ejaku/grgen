...
namespace de.unika.ipd.grGen.lgsp
{
    ...
    public static class SequenceExpressionGeneratorHelper
    {
            ...
            string balancedType, string leftType, string rightType, IGraphModel model)
        {
            ...
            else if(TypesHelper.GetExternalObjectType(balancedType, model) != null)
            ...
            else if(balancedType == "string")
            {
                if(leftType == "string")
                {
                    if(rightType.StartsWith("set<"))
                        return "("+leftValue+" + GRGEN_LIBGR.EmitHelper.ToString("+rightValue+", graph, false, null, null, null))";
                ...
                else //rightType == "string"
                {
                    if(leftType.StartsWith("set<"))
                        return "(GRGEN_LIBGR.EmitHelper.ToString("+leftValue+", graph, false, null, null, null) + "+rightValue+")";
