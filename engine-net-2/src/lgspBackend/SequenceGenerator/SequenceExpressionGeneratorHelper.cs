            ...
            else if(balancedType == "string")
            {
                if(leftType == "string")
                {
                    if(rightType.StartsWith("set<"))
                        return "("+leftValue+" + GRGEN_LIBGR.EmitHelper.ToString("+rightValue+", graph, false, null))";
                ...
                else //rightType == "string"
                {
                    if(leftType.StartsWith("set<"))
                        return "(GRGEN_LIBGR.EmitHelper.ToString("+leftValue+", graph, false, null) + "+rightValue+")";
