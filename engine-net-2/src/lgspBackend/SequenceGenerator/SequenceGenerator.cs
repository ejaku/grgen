    ...
    public class SequenceGenerator
    {
        ...
        internal void EmitMatchClassFilterCall(SourceBuilder source, SequenceFilterCallCompiled sequenceFilterCall, string matchListName)
        {
            if(sequenceFilterCall.Filter is IFilterAutoSupplied)
            {
                ...
                EmitMatchClassFilterAutoSuppliedCall(source, filterAutoSupplied, sequenceFilterCall.ArgumentExpressions, matchListName);
            }
            else if(sequenceFilterCall.Filter is IFilterAutoGenerated)
            {
                ...
                EmitMatchClassFilterAutoGeneratedCall(source, filterAutoGenerated, sequenceFilterCall.MatchClassName, matchListName);
            }
            else
            {
                IFilterFunction filterFunction = (IFilterFunction)sequenceFilterCall.Filter;
                EmitMatchClassFilterFunctionCall(source, filterFunction, sequenceFilterCall.ArgumentExpressions, matchListName);
            }
        }

        private void EmitMatchClassFilterAutoSuppliedCall(SourceBuilder source, IFilterAutoSupplied filterAutoSupplied, SequenceExpression[] argumentExpressions, string matchListName)
        {
        ...
        private void EmitMatchClassFilterAutoGeneratedCall(SourceBuilder source, IFilterAutoGenerated filterAutoGenerated, string matchClassName, string matchListName)
        {
        ...
        private void EmitMatchClassFilterFunctionCall(SourceBuilder source, IFilterFunction filterFunction, SequenceExpression[] argumentExpressions, string matchListName)
        {
