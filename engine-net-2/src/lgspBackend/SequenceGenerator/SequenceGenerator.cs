            ...
            else
            {
                if(filterCall.IsAutoGenerated)
                {
                    source.AppendFrontFormat("GRGEN_ACTIONS.{0}MatchFilters.Filter_{1}_{2}(procEnv, {3});\n",
                        TypesHelper.GetPackagePrefixDot(filterCall.ImplementationPackageAutoGenerated), patternName, filterCall.FullNameUnderscore, matchesName);
                }
                else
                {
            ...
            else
            {
                if(filterCall.IsAutoGenerated)
                {
                    source.AppendFrontFormat("GRGEN_ACTIONS.{0}MatchClassFilters.Filter_{1}_{2}(procEnv, {3});\n",
                        TypesHelper.GetPackagePrefixDot(filterCall.ImplementationPackageAutoGenerated), matchClassName, filterCall.FullNameUnderscore, matchListName);
                }
                else
                {
