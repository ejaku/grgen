...
namespace de.unika.ipd.grGen.lgsp
{
    class SequenceMultiSequenceBacktrackRuleGenerator
    {
        ...
        public SequenceMultiSequenceBacktrackRuleGenerator(SequenceMultiSequenceBacktrack seqMulti, SequenceRuleCall seqRule, Sequence seqSeq, SequenceGeneratorHelper seqHelper)
        {
