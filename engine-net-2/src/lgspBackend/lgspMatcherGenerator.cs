...
/*            StreamWriter sw = new StreamWriter(dumpname + "-scheduledsp.vcg", false);
        ...
        void GenerateActionImplementation(SourceBuilder sb, LGSPRulePattern matchingPattern)
        {
            ...
            sb.AppendFront("{\n");
            sb.Indent();
            sb.AppendFrontFormat("_rulePattern.Modify((GRGEN_LGSP.LGSPGraph)graph, match{0});\n", outArguments);
            sb.Unindent();
            sb.AppendFront("}\n");
            ...
            sb.AppendFrontFormat("_rulePattern.Modify((GRGEN_LGSP.LGSPGraph)graph, matches.First{0});\n", outArguments);
