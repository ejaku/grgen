...
namespace de.unika.ipd.grGen.libGr
{
    ...
    public class SequenceFilterCallCompiled : SequenceFilterCall
    {
        public SequenceFilterCallCompiled(String filterBase, List<String> entities,
            String package, String packagePrefixedName, String implementationPackageAutoGenerated,
            ...
            : base(argExprs)
        {
            ...
            ImplementationPackageAutoGenerated = implementationPackageAutoGenerated;
        ...
        public SequenceFilterCallCompiled(String filterBase, List<String> entities,
            String package, String packagePrefixedName, String implementationPackageAutoGenerated,
            String matchClassName, String matchClassPackage, String matchClassPackagePrefixedName,
            bool isAutoSupplied, bool isAutoGenerated,
            SequenceExpression[] argExprs)
            : base(argExprs)
        {
        ...
        /// <summary>
        /// True in case this is the call of an auto-generated filter.
        /// In this case, Entities is not null (but may be empty for auto).
        /// </summary>
