...
namespace de.unika.ipd.grGen.libGr
{
    ...
    public class SequenceFilterCallCompiled : SequenceFilterCall
    {
            ...
            : base(argExprs)
        {
            if(isAutoSupplied)
            {
                PrePackage = packagePrefix;
                Name = filterBase;
                MatchClassPrePackage = null;
                MatchClassName = null;
                IsAutoSupplied = true;
            ...
            {
                Package = PrePackage;
                PackagePrefixedName = Package + "::" + Name;
                return;
            }
            ...
            : base(argExprs)
        {
            if(isAutoSupplied)
            {
                PrePackage = packagePrefix;
                Name = filterBase;
                MatchClassPrePackage = matchClassPackage;
                MatchClassName = matchClassName;
                IsAutoSupplied = true;
                PrePackageContext = packageContext;

                MatchClassPackage = matchClassPackage;
                MatchClassPackagePrefixedName = matchClassPackage != null ? matchClassPackage + "::" + matchClassName : matchClassName;
            ...
            if(isAutoGenerated)
            {
                ...
                Package = null; // implementation only for auto-generated filters, does not appear in calls
                PackagePrefixedName = Name;
                ImplementationPackageAutoGenerated = MatchClassPackage;
                return;
            }
