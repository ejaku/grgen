...
namespace de.unika.ipd.grGen.libGr
{
    ...
    public abstract class SequenceCheckingEnvironment
    {
        ...
        public void CheckProcedureMethodCall(SequenceExpression targetExpr, SequenceComputationProcedureMethodCall seqCompProcMethodCall)
        {
            ...
            GraphElementType ownerType = TypesHelper.GetNodeOrEdgeType(targetExprType, Model);
            if(ownerType == null)
            {
        ...
        public void CheckProcedureMethodCall(SequenceVariable targetVar, SequenceComputationProcedureMethodCall seqCompProcMethodCall)
        {
            ...
            GraphElementType ownerType = TypesHelper.GetNodeOrEdgeType(targetVar.Type, Model);
            if(ownerType == null)
            {
                // error, must be node or edge type
        ...
        private void CheckProcedureCallBase(SequenceComputationProcedureCall seqCompProcCall, GraphElementType ownerType)
        {
        ...
        private void CheckFunctionCallBase(SequenceExpressionFunctionCall seqExprFuncCall, GraphElementType ownerType)
        {
        ...
        private void CheckInputParameters(Invocation invocation, SequenceExpression[] ArgumentExpressions, GraphElementType ownerType)
        {
        ...
        private void CheckOutputParameters(Invocation invocation, SequenceVariable[] ReturnVars, GraphElementType ownerType)
        {
            // Check whether number of parameters and return parameters match
        ...
        protected abstract int NumInputParameters(Invocation invocation, GraphElementType ownerType);
        protected abstract int NumOutputParameters(Invocation invocation, GraphElementType ownerType);
        protected abstract string InputParameterType(int i, Invocation invocation, GraphElementType ownerType);
        protected abstract string OutputParameterType(int i, Invocation invocation, GraphElementType ownerType);
