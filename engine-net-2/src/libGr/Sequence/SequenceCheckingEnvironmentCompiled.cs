...
namespace de.unika.ipd.grGen.libGr
{
    ...
    public class SequenceCheckingEnvironmentCompiled : SequenceCheckingEnvironment
    {
        ...
        protected override bool IsFilterExisting(SequenceFilterCall sequenceFilterCall, SequenceRuleCall seq)
        {
            ...
            String ruleName = seq.PackagePrefixedName;

            if(sequenceFilterCallCompiled.IsAutoGenerated)
                return actionsTypeInformation.GetFilterOfRule(ruleName, sequenceFilterCallCompiled.FullName) != null;

            return actionsTypeInformation.GetFilterOfRule(ruleName, sequenceFilterCallCompiled.PackagePrefixedName) != null;
        }
        ...
        protected override bool IsFilterExisting(SequenceFilterCall sequenceFilterCall, SequenceMultiRuleAllCall seq)
        {
            ...
            if(sequenceFilterCallCompiled.IsAutoGenerated)
                return actionsTypeInformation.GetFilterOfMatchClass(matchClassName, sequenceFilterCallCompiled.FullName) != null;

            return actionsTypeInformation.GetFilterOfMatchClass(matchClassName, sequenceFilterCallCompiled.PackagePrefixedName) != null;
        }
