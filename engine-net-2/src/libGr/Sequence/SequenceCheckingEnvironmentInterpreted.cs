    ...
    public class SequenceCheckingEnvironmentInterpreted : SequenceCheckingEnvironment
    {
        ...
        protected override bool IsFilterExisting(FilterCall filterCall, SequenceRuleCall seq)
        {
            ...
            if(filterCall.IsAutoGenerated)
            {
                ...
                return rulePattern.GetFilter(filterCall.FullName) != null;
            }
            ...
            if(filterCall.PrePackage != null)
            {
                ...
                return rulePattern.GetFilter(filterCall.PackagePrefixedName) != null;
            }
            if(rulePattern.GetFilter(filterCall.Name) != null)
            {
                filterCall.Package = null;
                filterCall.PackagePrefixedName = filterCall.Name;
                return true;
            }
            if(filterCall.PrePackageContext != null && rulePattern.GetFilter(filterCall.PrePackageContext + "::" + filterCall.Name) != null)
            {
                filterCall.Package = filterCall.PrePackageContext;
                filterCall.PackagePrefixedName = filterCall.Package + "::" + filterCall.Name;
                return true;
            }
            if(rulePattern.PatternGraph.Package != null && rulePattern.GetFilter(rulePattern.PatternGraph.Package + "::" + filterCall.Name) != null)
            {
        ...
        protected override bool IsFilterExisting(FilterCall filterCall, SequenceMultiRuleAllCall seq)
        {
            ...
            if(filterCall.IsAutoGenerated)
            {
                ...
                return matchClass.GetFilter(filterCall.FullName) != null;
            }
            ...
            if(filterCall.PrePackage != null)
            {
                filterCall.Package = filterCall.PrePackage;
                filterCall.PackagePrefixedName = filterCall.Package + "::" + filterCall.Name;
                return matchClass.GetFilter(filterCall.PackagePrefixedName) != null;
            }
            if(matchClass.GetFilter(filterCall.Name) != null)
            {
                filterCall.Package = null;
                filterCall.PackagePrefixedName = filterCall.Name;
                return true;
            }
            if(filterCall.PrePackageContext != null && matchClass.GetFilter(filterCall.PrePackageContext + "::" + filterCall.Name) != null)
            {
                filterCall.Package = filterCall.PrePackageContext;
                filterCall.PackagePrefixedName = filterCall.Package + "::" + filterCall.Name;
                return true;
            }
            if(filterCall.MatchClassPackage != null && matchClass.GetFilter(filterCall.MatchClassPackage + "::" + filterCall.Name) != null)
            {
