    ...
    public class SequenceParserEnvironmentCompiled : SequenceParserEnvironment
    {
            ...
            String packagePrefix, String filterBase, List<String> entities, List<SequenceExpression> argExprs)
        {
            ...
            else
            {
                if(packagePrefix != null)
                    PackagePrefixedName = packagePrefix + "::" + filterBase;
                else if(actionNames.GetFilterOfRule(packagePrefixedRuleName, filterName) != null)
                    PackagePrefixedName = filterBase;
                else if(rulePackage != null && actionNames.GetFilterOfRule(packagePrefixedRuleName, rulePackage + "::" + filterName) != null)
                    PackagePrefixedName = rulePackage + "::" + filterBase;
            ...
            String packagePrefix, String filterBase, List<String> entities, List<SequenceExpression> argExprs)
        {
            ...
            else
            {
                if(packagePrefix != null)
                    PackagePrefixedName = packagePrefix + "::" + filterBase;
                else if(actionNames.GetFilterOfMatchClass(packagePrefixedMatchClassName, filterName) != null)
                    PackagePrefixedName = filterBase;
                    ...
                    PackagePrefixedName = matchClassPackage + "::" + filterBase;
                else if(packageContext != null)
                    PackagePrefixedName = packageContext + "::" + filterBase;
                else
                    PackagePrefixedName = filterBase; // should not occur, (to be) handled in SequenceCheckingEnvironment
