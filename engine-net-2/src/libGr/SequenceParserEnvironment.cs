...
namespace de.unika.ipd.grGen.libGr.sequenceParser
{
	...
	/// <summary>
	/// An evironment class for the sequence parser.
	/// </summary>
	public class SequenceParserEnvironment
	{
		...
		/// </summary>
		internal string typeOfGraphElementThis;
