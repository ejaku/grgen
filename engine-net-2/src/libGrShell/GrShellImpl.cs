    ...
    public class GrShellImpl : IGrShellImplForDriver, IGrShellImplForSequenceApplierAndDebugger
    {
        ...
        public void Help(List<String> commands)
        {
            ...
            ConsoleUI.outWriter.Write("\nList of variable handling and user input constructs,\n"
                ...
                + "                             to the type of e2\n"
                + " - object type <o1> is <o2>  Tells whether the object o1 has a type compatible\n"
                + "                             to the type of o2\n"
                + " - transient object type <to1> is <to2>\n"
                + "                             Tells whether the transient object to1\n"
                + "                             has a type compatible to the type of to2\n"
        ...
        public void HelpNew(List<String> commands)
        {
            ...
            ConsoleUI.outWriter.WriteLine("\nList of available commands for \"new\":\n"
                ...
                + " - new graph <filename> persist with <provider> to <c-params> [<pg-params>]\n"
                ...
                + "   optionally applying the specified persistent graph parameters.\n"
        ...
        public void HelpShow(List<String> commands)
        {
            ...
            ConsoleUI.outWriter.WriteLine("\nList of available commands for \"show\":\n"
                ...
                + "   Shows the number of elements in the same way as specified above.\n\n"
                + " - show (node|edge|object|transient object) types\n"
                + "   Shows the entity types of the current graph model.\n\n"
                + " - show (node|edge|object|transient object) (sub|super) types <type>\n"
                + "   Shows the sub/super types of the given entity type.\n\n"
                + " - show (node|edge|object|transient object) attributes [[only] <type>]\n"
                + "   Shows all attributes of all the types of the given kind,\n"
                + "   of all types compatible to the given entity type,\n"
                + "   or only of the given entity type.\n\n"
                + " - show (node|edge|object|transient object) <entity>\n"
                + "   Shows the attributes including their values of the given entity.\n\n"
                + " - show <entity>.<attribute>\n"
                + "   Shows the value of the given attribute of the given entity.\n\n"
                + " - show var <var>\n"
        ...
        public void ParseAndDefineSequence(String str, Token tok, out bool noError)
        {
            ...
            {
                ConsoleUI.errorOutWriter.WriteLine("Unable to parse sequence definition at line " + tok.beginLine + ":");
                GrShellSequenceApplierAndDebugger.HandleSequenceParserException(ex);
                noError = false;
            }
            catch(de.unika.ipd.grGen.libGr.sequenceParser.ParseException ex)
            {
                ConsoleUI.errorOutWriter.WriteLine("Unable to process sequence definition at line " + tok.beginLine + ":");
        ...
        public SequenceExpression ParseSequenceExpression(String str, String ruleOfMatchThis, String typeOfGraphElementThis, Token tok, out bool noError)
        {
            ...
            {
                ConsoleUI.errorOutWriter.WriteLine("Unable to parse sequence expression at line " + tok.beginLine + ":");
                GrShellSequenceApplierAndDebugger.HandleSequenceParserException(ex);
                noError = false;
                return null;
            }
        ...
        public void ApplySequenceExpression(SequenceExpression seqExpr, Token tok, out bool noError)
        {
            ...
            {
                ConsoleUI.errorOutWriter.WriteLine("\nUnable to evaluate sequence expression at line " + tok.beginLine + ":");
                GrShellSequenceApplierAndDebugger.HandleSequenceParserException(ex);
                noError = false;
            }
            catch(de.unika.ipd.grGen.libGr.sequenceParser.ParseException ex)
        ...
        public Sequence ParseSequence(String str, Token tok, out bool noError)
        {
            ...
            {
                ConsoleUI.errorOutWriter.WriteLine("Unable to parse sequence at line " + tok.beginLine + ":");
                GrShellSequenceApplierAndDebugger.HandleSequenceParserException(ex);
                noError = false;
                return null;
            }
        ...
        public void ApplySequence(Sequence seq, Token tok, out bool noError)
        {
            ...
            {
                ConsoleUI.errorOutWriter.WriteLine("\nUnable to execute sequence at line " + tok.beginLine + ":");
                GrShellSequenceApplierAndDebugger.HandleSequenceParserException(ex);
                noError = false;
            }
            catch(de.unika.ipd.grGen.libGr.sequenceParser.ParseException ex)
        ...
        public void DebugSequence(Sequence seq, Token tok, out bool noError)
        {
            ...
            {
                ConsoleUI.errorOutWriter.WriteLine("\nUnable to debug execute sequence at line " + tok.beginLine + ":");
                GrShellSequenceApplierAndDebugger.HandleSequenceParserException(ex);
                noError = false;
            }
            catch(de.unika.ipd.grGen.libGr.sequenceParser.ParseException ex)
        ...
        public void DebugSequenceExpression(SequenceExpression seqExpr, Token tok, out bool noError)
        {
            ...
            {
                ConsoleUI.errorOutWriter.WriteLine("\nUnable to debug evaluate sequence expression at line " + tok.beginLine + ":");
                GrShellSequenceApplierAndDebugger.HandleSequenceParserException(ex);
                noError = false;
            }
            catch(de.unika.ipd.grGen.libGr.sequenceParser.ParseException ex)
