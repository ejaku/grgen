        ...
        public void ApplyRewriteSequenceExpression(SequenceExpression seqExpr, bool debug)
        {
            ...
            try
            {
                ...
                ConsoleUI.outWriter.WriteLine("Evaluating Sequence Expression done after {0} ms with result: {1}",
                    ...
                    EmitHelper.ToStringAutomatic(result, impl.curShellProcEnv.ProcEnv.Graph, impl.curShellProcEnv.objectNamerAndIndexer, impl.curShellProcEnv.transientObjectNamerAndIndexer, null));
