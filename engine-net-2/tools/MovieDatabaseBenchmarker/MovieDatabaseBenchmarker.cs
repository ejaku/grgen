...
namespace MovieDatabase
{
    class MovieDatabaseBenchmarker
    {
        static void Main(string[] args)
        {
            if(args.Length != 2)
            {
                Console.WriteLine("usage: MovieDatabaseBenchmarker <name of rule to apply> <name of grs file to import or number of creation iterations of synthetic graph>");
            ...
            Console.WriteLine("Number of Movies: " + graph.nodesByTypeCounts[graph.Model.NodeModel.GetType("Movie").TypeID]);
            Console.WriteLine("Number of Persons: " + graph.nodesByTypeCounts[graph.Model.NodeModel.GetType("Person").TypeID]);
            Console.WriteLine("Number of personToMovies: " + graph.edgesByTypeCounts[graph.Model.EdgeModel.GetType("personToMovie").TypeID]);
            ...
            Console.WriteLine("Number of Groups: " + graph.nodesByTypeCounts[graph.Model.NodeModel.GetType("Group").TypeID]);
