	...
	protected boolean checkLocal() {
		...
		if(entities != null) {
			...
			for(int i=0; i < entities.size(); ++i) {
				...
				DeclNode resolvedEntity = action != null ? action.pattern.tryGetMember(entity) : iterated.pattern.tryGetMember(entity);
				if(resolvedEntity==null) {
					reportError("Unknown entity " + entity + " in " + (action != null ? action.getIdentNode() : iterated.getIdentNode()));
					return false;
				}
