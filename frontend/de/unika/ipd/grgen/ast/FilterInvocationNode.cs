...
public class FilterInvocationNode extends FilterInvocationBaseNode
{
	...
	{
		super(filterUnresolved.getCoords(), iteratedUnresolved);
	...
	protected IR constructIR()
	{
		...
		if(filterAutoGenerated != null) {
			filterInvocation = new FilterInvocation(filterUnresolved.getIRIdent().toString(), filterUnresolved.getIRIdent(),
		...
		for(ExprNode expr : arguments.getChildrenExact()) {
			...
			filterInvocation.addArgument(exprEvaluated.checkIR(Expression.class));
		}
