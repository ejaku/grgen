		...
		protected internal override IR ConstructIR()
		{
			...
			if(filterAutoGenerated != null)
			{
				filterInvocation = new FilterInvocation(filterUnresolved.IRIdent.ToString(), filterUnresolved.IRIdent,
						filterAutoGenerated.CheckIR<FilterAutoGenerated>(typeof(FilterAutoGenerated)), iterated.CheckIR<Rule>(typeof(Rule)));
			}
			else
			{
				filterInvocation = new FilterInvocation(filterUnresolved.IRIdent.ToString(), filterUnresolved.IRIdent,
						filterAutoSupplied.CheckIR<FilterAutoSupplied>(typeof(FilterAutoSupplied)), iterated.CheckIR<Rule>(typeof(Rule)));
			}
			foreach(ExprNode expr in arguments.ChildrenExact)
			{
				ExprNode exprEvaluated = expr.Evaluate();
				filterInvocation.AddArgument(exprEvaluated.CheckIR<Expression>(typeof(Expression)));
			}
