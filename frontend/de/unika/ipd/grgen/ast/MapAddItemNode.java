...
public class MapAddItemNode extends ExprNode
{
	static {
		setName(MapAddItemNode.class, "map add item");
	}
	...
	public MapAddItemNode(Coords coords, MemberAccessExprNode target, ExprNode keyExpr,
	                         ExprNode valueExpr)
	{
		super(coords);
