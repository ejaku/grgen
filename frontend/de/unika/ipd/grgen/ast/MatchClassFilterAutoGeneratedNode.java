...
public class MatchClassFilterAutoGeneratedNode extends BaseNode implements MatchClassFilterCharacter
{
	...
	public MatchClassFilterAutoGeneratedNode(Coords coords, String name, ArrayList<String> entities,
			IdentNode matchType)
	{
		super(coords);
		this.name = name;
		...
		if(entities != null) {
			...
			for(int i = 0; i < entities.size(); ++i) {
				...
				if(resolvedEntity == null) {
					reportError("Unknown entity " + entity + " in " + matchType.getIdentNode());
					return false;
				}
