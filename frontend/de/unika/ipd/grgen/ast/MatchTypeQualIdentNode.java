 ...
 */
 public class MatchTypeQualIdentNode extends BaseNode /*implements DeclaredCharacter*/ {
	...
	private static final DeclarationTypeResolver<DefinedMatchTypeNode> ownerResolver = new DeclarationTypeResolver<DefinedMatchTypeNode>(DefinedMatchTypeNode.class);
	private static final DeclarationPairResolver<MatchClassFilterFunctionDeclNode, MatchClassFilterAutoGeneratedNode> memberResolver = new DeclarationPairResolver<MatchClassFilterFunctionDeclNode, MatchClassFilterAutoGeneratedNode>(MatchClassFilterFunctionDeclNode.class, MatchClassFilterAutoGeneratedNode.class);
	...
	protected boolean resolveLocal() {
		...
		Pair<MatchClassFilterFunctionDeclNode, MatchClassFilterAutoGeneratedNode> resolved = memberResolver.resolve(memberUnresolved, this);
		if(resolved == null) {
			memberUnresolved.reportError("Unknown match class filter function " + memberUnresolved.toString() + " called.");
			return false;
		}
