...
import de.unika.ipd.grgen.ir.containers.ArrayOrderDescending;
import de.unika.ipd.grgen.ir.exprevals.Expression;
import de.unika.ipd.grgen.ir.IR;
import de.unika.ipd.grgen.parser.Coords;

public class ArrayOrderDescendingNode extends ExprNode
{
	static {
	...
	protected boolean checkLocal() {
		...
		if(!(arrayType.valueType.equals(BasicTypeNode.byteType))
			...
			targetExpr.reportError("array orderDescending only available for arrays of type byte,short,int,long,float,double,string,boolean,enum");
		}
		return true;
	}
