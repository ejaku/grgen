...
{
	static {
		setClassName(FilterAutoGeneratedDeclNode.class, "auto generated filter");
	}
			...
			for(int i = 0; i < entities.size(); ++i) {
				...
				if(resolvedEntity == null) {
					reportError("The entity " + entity
							...
							+ " is not known in the "
							+ (action != null ? action.getKind() + " " + action.getIdent() : "iterated " + iterated.getIdent()) + ".");
					return false;
				}
	...
	public FilterAutoGenerated getIRFilterAutoGenerated()
	{
	...
	protected IR constructIR()
	{
		...
		if(entityTypes != null) {
			for(TypeNode entityType : entityTypes) {
				filterAutoGen.addEntityType(entityType.getIRType());
			}
		}
