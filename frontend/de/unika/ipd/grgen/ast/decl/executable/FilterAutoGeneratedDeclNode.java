		...
		if(entities == null) {
			...
			for(int i = 0; i < entities.size(); ++i) {
				...
				if(resolvedEntity == null) {
					reportError("The entity " + entity + " referenced in the filter declaration " + name + " is not known in the "
							+ (action != null ? "rule/test " + action.getIdentNode() : "iterated " +  iterated.getIdentNode()) + ".");
					return false;
				}
