...
{
	static {
		setClassName(MatchClassFilterAutoGeneratedDeclNode.class, "match filter function declaration");
	}
			...
			for(int i = 0; i < entities.size(); ++i) {
				...
				if(resolvedEntity == null) {
					reportError("The entity " + entity
							...
							+ " is not known in the "
							+ "match class " + matchType.getIdent() + ".");
					return false;
				}
	...
	public MatchClassFilterAutoGenerated getIRMatchClassFilterAutoGenerated()
	{
