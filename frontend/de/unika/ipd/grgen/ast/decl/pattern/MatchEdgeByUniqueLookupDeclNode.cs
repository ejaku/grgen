...
namespace de.unika.ipd.grgen.ast.decl.pattern
{
	...
	public class MatchEdgeByUniqueLookupDeclNode : EdgeDeclNode
	{
		static MatchEdgeByUniqueLookupDeclNode()
		{
			SetClassName(typeof(MatchEdgeByUniqueLookupDeclNode), "match edge by unique lookup decl");
		}
		...
		protected internal override IR ConstructIR()
		{
			...
			expr = expr.Evaluate();
			edge.UniqueIndexAccess = new UniqueLookup(expr.CheckIR<Expression>(typeof(Expression)));
			return edge;
		}
	}
