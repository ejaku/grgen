...
{
	static {
		setClassName(ArrayDevNode.class, "array dev");
	}
	...
	protected boolean checkLocal()
	{
		...
		if(!arrayType.valueType.isAccumulatableType()) {
			targetExpr.reportError("The array function method dev can only be employed on an object of type array<" + TypeNode.getAccumulatableTypesAsString() + ">"
