...
namespace de.unika.ipd.grgen.ast.expr.array
{
	...
	public class ArrayIndexOfByNode : ArrayFunctionMethodInvocationBaseExprNode
	{
		static ArrayIndexOfByNode()
		{
			SetClassName(typeof(ArrayIndexOfByNode), "array index of by");
		}
		...
		protected internal override bool CheckLocal()
		{
			...
			if(!valueType.IsEqual(memberType))
			{
				...
				{
					valueExprOld.ReportError("The array function method indexOfBy expects as 1. argument (valueToSearchFor) a value of type " + memberType.TypeName
		...
		protected internal override IR ConstructIR()
		{
			...
			if(startIndexExpr != null)
			{
				...
				return new ArrayIndexOfByExpr(targetExpr.CheckIR<Expression>(typeof(Expression)),
