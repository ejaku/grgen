...
public class ArrayIndexOfByNode extends ArrayFunctionMethodInvocationBaseExprNode
{
	static {
		setClassName(ArrayIndexOfByNode.class, "array index of by");
	}
	...
	protected boolean checkLocal()
	{
		...
		if(!valueType.isEqual(memberType)) {
			...
			if(valueExpr == ConstNode.getInvalid()) {
				valueExprOld.reportError("The array function method indexOfBy expects as 1. argument (valueToSearchFor) a value of type " + memberType.getTypeName()
