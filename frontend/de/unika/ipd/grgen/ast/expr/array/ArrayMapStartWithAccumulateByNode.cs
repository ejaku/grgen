...
namespace de.unika.ipd.grgen.ast.expr.array
{
	...
	public class ArrayMapStartWithAccumulateByNode : ArrayFunctionMethodInvocationBaseExprNode
	{
		...
		protected internal override IR ConstructIR()
		{
			...
			return new ArrayMapStartWithAccumulateByExpr(targetExpr.CheckIR(typeof(Expression)),
					initArrayAccessVar != null ? initArrayAccessVar.CheckIR(typeof(Variable)) : null,
					initExpr.CheckIR(typeof(Expression)), arrayAccessVar != null ? arrayAccessVar.CheckIR(typeof(Variable)) : null,
