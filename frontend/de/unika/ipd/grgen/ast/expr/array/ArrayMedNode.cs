...
namespace de.unika.ipd.grgen.ast.expr.array
{
	...
	public class ArrayMedNode : ArrayAccumulationMethodNode
	{
		static ArrayMedNode()
		{
			SetClassName(typeof(ArrayMedNode), "array med");
		}
		...
		protected internal override bool CheckLocal()
		{
			...
			{
				targetExpr.ReportError("The array function method med can only be employed on an object of type array<" + TypeNode.AccumulatableTypesAsString + ">"
		...
		protected internal override IR ConstructIR()
		{
			...
			return new ArrayMedExpr(targetExpr.CheckIR<Expression>(typeof(Expression)));
		}
	}
