...
namespace de.unika.ipd.grgen.ast.expr.array
{
	...
	public class ArrayOrNode : ArrayAccumulationMethodNode
	{
		static ArrayOrNode()
		{
			SetClassName(typeof(ArrayOrNode), "array or");
		}
		...
		protected internal override IR ConstructIR()
		{
			...
			return new ArrayOrExpr(targetExpr.CheckIR<Expression>(typeof(Expression)));
		}
	}
