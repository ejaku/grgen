...
namespace de.unika.ipd.grgen.ast.expr.array
{
	...
	public class ArrayOrderAscendingByNode : ArrayFunctionMethodInvocationBaseExprNode
	{
		static ArrayOrderAscendingByNode()
		{
			SetClassName(typeof(ArrayOrderAscendingByNode), "array order ascending by");
		}
		...
		protected internal override IR ConstructIR()
		{
			...
			return new ArrayOrderAscendingBy(targetExpr.CheckIR<Expression>(typeof(Expression)),
					accessedMember);
		}
	}
