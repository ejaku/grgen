...
{
	static {
		setClassName(ArrayProdNode.class, "array prod");
	}
	...
	protected boolean checkLocal()
	{
		...
		if(!arrayType.valueType.isAccumulatableType()) {
			targetExpr.reportError("The array function method prod can only be employed on an object of type array<" + TypeNode.getAccumulatableTypesAsString() + ">"
