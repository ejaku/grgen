...
namespace de.unika.ipd.grgen.ast.expr.array
{
	...
	public class ArraySumNode : ArrayAccumulationMethodNode
	{
		static ArraySumNode()
		{
			SetClassName(typeof(ArraySumNode), "array sum");
		}
		...
		protected internal override bool CheckLocal()
		{
			...
			{
				targetExpr.ReportError("The array function method sum can only be employed on an object of type array<" + TypeNode.AccumulatableTypesAsString + ">"
		...
		protected internal override IR ConstructIR()
		{
			...
			return new ArraySumExpr(targetExpr.CheckIR<Expression>(typeof(Expression)));
		}
	}
