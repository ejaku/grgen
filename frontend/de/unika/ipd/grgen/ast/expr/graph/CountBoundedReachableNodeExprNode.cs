...
namespace de.unika.ipd.grgen.ast.expr.graph
{
	...
	/// </summary>
	public class CountBoundedReachableNodeExprNode : BoundedNeighborhoodQueryExprNode
	{
		static CountBoundedReachableNodeExprNode()
		{
			SetClassName(typeof(CountBoundedReachableNodeExprNode), "count bounded reachable node expr");
		}
		...
		protected internal override IR ConstructIR()
		{
			...
			return new CountBoundedReachableNodeExpr(startNodeExpr.CheckIR<Expression>(typeof(Expression)),
					depthExpr.CheckIR<Expression>(typeof(Expression)),
