...
namespace de.unika.ipd.grgen.ast.expr.graph
{
	...
	/// </summary>
	public class CountReachableNodeExprNode : NeighborhoodQueryExprNode
	{
		static CountReachableNodeExprNode()
		{
			SetClassName(typeof(CountReachableNodeExprNode), "count reachable node expr");
		}
		...
		protected internal override IR ConstructIR()
		{
			...
			return new CountReachableNodeExpr(startNodeExpr.CheckIR<Expression>(typeof(Expression)),
