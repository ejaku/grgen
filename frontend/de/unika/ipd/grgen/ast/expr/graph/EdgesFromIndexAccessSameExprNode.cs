 ...
 */
public class EdgesFromIndexAccessSameExprNode extends FromIndexAccessSameExprNode
{
	static {
		setClassName(EdgesFromIndexAccessSameExprNode.class, "edges from index access same expr");
	}
