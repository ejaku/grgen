...
public class IsBoundedReachableNodeExprNode : NeighborhoodQueryExprNode
{
	...
	protected internal override IR ConstructIR()
	{
		...
		return new IsBoundedReachableNodeExpr(startNodeExpr.CheckIR(typeof(Expression)),
				endNodeExpr.CheckIR(typeof(Expression)), depthExpr.CheckIR(typeof(Expression)),
