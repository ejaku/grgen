...
/// <summary>
/// A node yielding whether the given edge is in the edges from an index by accessing using a comparison for equality.
/// </summary>
public class IsInEdgesFromIndexAccessSameExprNode : FromIndexAccessSameExprNode
{
	static IsInEdgesFromIndexAccessSameExprNode()
	{
		SetClassName(typeof(IsInEdgesFromIndexAccessSameExprNode), "is in edges from index access same expr");
	}
