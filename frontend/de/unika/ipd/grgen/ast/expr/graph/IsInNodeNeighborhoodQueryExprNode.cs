...
/// </summary>
public abstract class IsInNodeNeighborhoodQueryExprNode : NeighborhoodQueryExprNode
{
	static IsInNodeNeighborhoodQueryExprNode()
	{
		SetClassName(typeof(IsInNodeNeighborhoodQueryExprNode), "is in node neighborhood query expr");
	}

	protected internal ExprNode endNodeExpr;


	protected internal IsInNodeNeighborhoodQueryExprNode(Coords coords,
