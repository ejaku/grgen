...
public class NodesFromIndexAccessFromToAsArrayExprNode extends FromIndexAccessFromToExprNode
{
	...
	public NodesFromIndexAccessFromToAsArrayExprNode(Coords coords, ExprNode index, boolean ascending, ExprNode fromExpr, boolean fromExclusive, ExprNode toExpr, boolean toExclusive)
	{
