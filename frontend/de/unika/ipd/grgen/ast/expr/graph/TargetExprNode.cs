...
namespace de.unika.ipd.grgen.ast.expr.graph
{
	...
	/// </summary>
	public class TargetExprNode : BuiltinFunctionInvocationBaseNode
	{
		static TargetExprNode()
		{
			SetClassName(typeof(TargetExprNode), "target expr");
		}
		...
		{
			edge = edge.Evaluate();
			return new TargetExpr(edge.CheckIR<Expression>(typeof(Expression)), Type.IRType);
		}
