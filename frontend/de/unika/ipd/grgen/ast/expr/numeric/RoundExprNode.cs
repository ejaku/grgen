...
namespace de.unika.ipd.grgen.ast.expr.numeric
{
	...
	public class RoundExprNode : BuiltinFunctionInvocationBaseNode
	{
		static RoundExprNode()
		{
			SetClassName(typeof(RoundExprNode), "round expr");
		}

		private ExprNode argumentExpr;

		public RoundExprNode(Coords coords, ExprNode argumentExpr)
			: base(coords)
		{
		...
		protected internal override bool CheckLocal()
		{
			if(argumentExpr.Type.IsEqual(BasicTypeNode.doubleType))
				return true;
			ReportError("The function Math::round() expects as argument a value of type double"
		...
		protected internal override IR ConstructIR()
		{
			...
			return new RoundExpr(argumentExpr.CheckIR<Expression>(typeof(Expression)));
		}
