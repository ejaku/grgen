...
public class ShortMaxExprNode : BuiltinFunctionInvocationBaseNode
{
	static ShortMaxExprNode()
	{
		SetClassName(typeof(ShortMaxExprNode), "shortmax expr");
	}
