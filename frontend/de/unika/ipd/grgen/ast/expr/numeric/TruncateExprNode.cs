...
namespace de.unika.ipd.grgen.ast.expr.numeric
{
	...
	public class TruncateExprNode : BuiltinFunctionInvocationBaseNode
	{
		static TruncateExprNode()
		{
			SetClassName(typeof(TruncateExprNode), "truncate expr");
		}
		...
		protected internal override IR ConstructIR()
		{
			...
			return new TruncateExpr(argumentExpr.CheckIR<Expression>(typeof(Expression)));
		}
