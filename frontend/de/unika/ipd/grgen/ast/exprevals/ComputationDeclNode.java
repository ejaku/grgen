 ...
 */
public class ComputationDeclNode extends ComputationBase {
	static {
	...
	static final ComputationTypeNode computationType = new ComputationTypeNode();

	public ComputationDeclNode(IdentNode id, CollectNode<EvalStatementNode> evals, CollectNode<BaseNode> params, CollectNode<BaseNode> rets) {
	...
	protected IR constructIR() {
		...
		for(TypeNode retType : returnTypes.getChildren()) {
			computation.addReturnType(retType.checkIR(Type.class));
		}
	...
	public static String getKindStr() {
		return "computation declaration";
	}
