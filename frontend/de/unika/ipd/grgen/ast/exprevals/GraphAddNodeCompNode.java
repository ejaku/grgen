...
import de.unika.ipd.grgen.ir.exprevals.GraphAddNodeComp;
import de.unika.ipd.grgen.parser.Coords;

/**
 * A node for adding a node to graph.
 */
public class GraphAddNodeCompNode extends ComputationInvocationBaseNode {
	static {
		setName(GraphAddNodeCompNode.class, "graph add node comp");
	}
	...
	public GraphAddNodeCompNode(Coords coords, ExprNode nodeType) {
		super(coords);
	...
	protected IR constructIR() {
		GraphAddNodeComp addNode = new GraphAddNodeComp(nodeType.checkIR(Expression.class));
