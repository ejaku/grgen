...
import de.unika.ipd.grgen.ir.exprevals.GraphMerge;
import de.unika.ipd.grgen.ir.IR;
import de.unika.ipd.grgen.parser.Coords;

public class GraphMergeNode extends EvalStatementNode {
	static {
		setName(GraphMergeNode.class, "graph merge statement");
	}
	...
	public GraphMergeNode(Coords coords, ExprNode targetExpr, ExprNode sourceExpr,
	...
	protected IR constructIR() {
		return new GraphMerge(targetExpr.checkIR(Expression.class),
