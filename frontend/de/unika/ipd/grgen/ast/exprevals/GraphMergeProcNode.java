...
import de.unika.ipd.grgen.ir.exprevals.GraphMergeProc;
import de.unika.ipd.grgen.ir.IR;
import de.unika.ipd.grgen.parser.Coords;

public class GraphMergeProcNode extends ProcedureInvocationBaseNode {
	static {
	...
	public GraphMergeProcNode(Coords coords, ExprNode targetExpr, ExprNode sourceExpr,
	...
	protected IR constructIR() {
		return new GraphMergeProc(targetExpr.checkIR(Expression.class),
