...
import de.unika.ipd.grgen.ir.exprevals.GraphRedirectSourceAndTargetComp;
import de.unika.ipd.grgen.ir.IR;
import de.unika.ipd.grgen.parser.Coords;

public class GraphRedirectSourceAndTargetCompNode extends ComputationInvocationBaseNode {
	static {
		setName(GraphRedirectSourceAndTargetCompNode.class, "graph redirect source and target computation");
	}
	...
	public GraphRedirectSourceAndTargetCompNode(Coords coords, ExprNode edgeExpr, ExprNode newSourceExpr, ExprNode newTargetExpr,
	...
	protected IR constructIR() {
		return new GraphRedirectSourceAndTargetComp(edgeExpr.checkIR(Expression.class),
