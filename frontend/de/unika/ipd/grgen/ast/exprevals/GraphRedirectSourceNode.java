...
import de.unika.ipd.grgen.ir.exprevals.GraphRedirectSource;
import de.unika.ipd.grgen.ir.IR;
import de.unika.ipd.grgen.parser.Coords;

public class GraphRedirectSourceNode extends EvalStatementNode {
	static {
		setName(GraphRedirectSourceNode.class, "graph redirect source statement");
	}
	...
	public GraphRedirectSourceNode(Coords coords, ExprNode edgeExpr, ExprNode newSourceExpr,
	...
	protected IR constructIR() {
		return new GraphRedirectSource(edgeExpr.checkIR(Expression.class),
