...
import de.unika.ipd.grgen.ir.exprevals.GraphRedirectTargetComp;
import de.unika.ipd.grgen.ir.IR;
import de.unika.ipd.grgen.parser.Coords;

public class GraphRedirectTargetCompNode extends ComputationInvocationBaseNode {
	static {
		setName(GraphRedirectTargetCompNode.class, "graph redirect target computation");
	}
	...
	public GraphRedirectTargetCompNode(Coords coords, ExprNode edgeExpr, ExprNode newTargetExpr,
	...
	protected IR constructIR() {
		return new GraphRedirectTargetComp(edgeExpr.checkIR(Expression.class),
