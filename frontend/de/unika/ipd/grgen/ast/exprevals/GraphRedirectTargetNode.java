...
import de.unika.ipd.grgen.ir.exprevals.GraphRedirectTarget;
import de.unika.ipd.grgen.ir.IR;
import de.unika.ipd.grgen.parser.Coords;

public class GraphRedirectTargetNode extends EvalStatementNode {
	static {
		setName(GraphRedirectTargetNode.class, "graph redirect target statement");
	}
	...
	public GraphRedirectTargetNode(Coords coords, ExprNode edgeExpr, ExprNode newTargetExpr,
	...
	protected IR constructIR() {
		return new GraphRedirectTarget(edgeExpr.checkIR(Expression.class),
