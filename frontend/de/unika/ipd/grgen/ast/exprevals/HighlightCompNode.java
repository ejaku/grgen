...
import de.unika.ipd.grgen.ir.exprevals.HighlightComp;
import de.unika.ipd.grgen.ir.IR;
import de.unika.ipd.grgen.parser.Coords;

public class HighlightCompNode extends ComputationInvocationBaseNode {
	static {
		setName(HighlightCompNode.class, "highlight computation");
	}

	private CollectNode<ExprNode> highlightChildren = new CollectNode<ExprNode>();

	public HighlightCompNode(Coords coords) {
		super(coords);
	...
	protected IR constructIR() {
		...
		return new HighlightComp(expressionsToHighlight);
	}
}
