...
import de.unika.ipd.grgen.ir.exprevals.HighlightStatement;
import de.unika.ipd.grgen.ir.IR;
import de.unika.ipd.grgen.parser.Coords;

public class HighlightStatementNode extends EvalStatementNode {
	static {
		setName(HighlightStatementNode.class, "highlight statement");
	}

	private CollectNode<ExprNode> highlightChildren = new CollectNode<ExprNode>();

	public HighlightStatementNode(Coords coords) {
		super(coords);
	...
	protected IR constructIR() {
		...
		return new HighlightStatement(expressionsToHighlight);
	}
}
