...
import de.unika.ipd.grgen.ir.exprevals.InsertDefinedSubgraphComp;
import de.unika.ipd.grgen.parser.Coords;

/**
 * A node yielding an inserted edge of the insertion of a defined subgraph of an edge set.
 */
public class InsertDefinedSubgraphCompNode extends ComputationInvocationBaseNode {
	static {
		setName(InsertDefinedSubgraphCompNode.class, "insert defined subgraph computation");
	}
	...
	public InsertDefinedSubgraphCompNode(Coords coords, ExprNode edgeSetExpr, ExprNode edgeExpr) {
		super(coords);
	...
	protected IR constructIR() {
		InsertDefinedSubgraphComp insertDefined = new InsertDefinedSubgraphComp(
