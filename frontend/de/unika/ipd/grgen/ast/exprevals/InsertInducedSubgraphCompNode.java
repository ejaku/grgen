...
import de.unika.ipd.grgen.ir.exprevals.InsertInducedSubgraphComp;
import de.unika.ipd.grgen.parser.Coords;

/**
 * A node yielding an inserted node of the insertion of an induced subgraph of a node set.
 */
public class InsertInducedSubgraphCompNode extends ComputationInvocationBaseNode {
	static {
		setName(InsertInducedSubgraphCompNode.class, "insert induced subgraph computation");
	}
	...
	public InsertInducedSubgraphCompNode(Coords coords, ExprNode nodeSetExpr, ExprNode nodeExpr) {
		super(coords);
	...
	protected IR constructIR() {
		InsertInducedSubgraphComp insertInduced = new InsertInducedSubgraphComp(
