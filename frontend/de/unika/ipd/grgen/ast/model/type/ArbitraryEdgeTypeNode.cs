...
public class ArbitraryEdgeTypeNode : EdgeTypeNode
{
	static ArbitraryEdgeTypeNode()
	{
		SetClassName(typeof(ArbitraryEdgeTypeNode), "arbitrary edge type");
	}

	/// <summary>
	/// Make a new arbitrary edge type node. </summary>
	...
	protected internal override sealed EdgeType DirectednessIR
	{
		set
		{
