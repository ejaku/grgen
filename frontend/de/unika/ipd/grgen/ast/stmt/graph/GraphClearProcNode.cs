...
namespace de.unika.ipd.grgen.ast.stmt.graph
{
	...
	public class GraphClearProcNode : BuiltinProcedureInvocationBaseNode
	{
		static GraphClearProcNode()
		{
			SetClassName(typeof(GraphClearProcNode), "graph clear procedure");
		}
