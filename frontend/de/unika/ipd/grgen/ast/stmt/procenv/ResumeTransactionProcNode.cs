...
public class ResumeTransactionProcNode : BuiltinProcedureInvocationBaseNode
{
	static ResumeTransactionProcNode()
	{
		SetClassName(typeof(ResumeTransactionProcNode), "resume transaction procedure");
	}
