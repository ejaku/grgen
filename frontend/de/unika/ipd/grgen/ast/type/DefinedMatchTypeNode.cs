...
namespace de.unika.ipd.grgen.ast.type
{
	...
	public class DefinedMatchTypeNode : MatchTypeNode
	{
		...
		public virtual DefinedMatchType IRDefinedMatchType
		{
			get
			{
				return CheckIR<DefinedMatchType>(typeof(DefinedMatchType));
			}
		}
		...
		protected internal override IR ConstructIR()
		{
			...
			{
				if(filter is MatchClassFilterFunctionDeclNode)
					((MatchClassFilterFunctionDeclNode)filter).CheckIR<MatchClassFilterFunction>(typeof(MatchClassFilterFunction));
				else
					((MatchClassFilterAutoGeneratedDeclNode)filter).CheckIR<MatchClassFilterAutoGenerated>(typeof(MatchClassFilterAutoGenerated));
			}
