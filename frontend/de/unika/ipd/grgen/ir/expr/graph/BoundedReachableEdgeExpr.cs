...
namespace de.unika.ipd.grgen.ir.expr.graph
{
	...
	public class BoundedReachableEdgeExpr : NeighborhoodQueryExpr
	{
		...
		public BoundedReachableEdgeExpr(Expression startNodeExpression, Expression depthExpression,
			...
			: base("bounded reachable edge expression", type, startNodeExpression, incidentEdgeTypeExpr, direction, adjacentNodeTypeExpr)
		{
