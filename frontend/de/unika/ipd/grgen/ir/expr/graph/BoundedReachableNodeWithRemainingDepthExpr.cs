...
public class BoundedReachableNodeWithRemainingDepthExpr : NeighborhoodQueryExpr
{
	private readonly Expression depthExpr;

	public BoundedReachableNodeWithRemainingDepthExpr(Expression startNodeExpression, Expression depthExpression,
			Expression incidentEdgeTypeExpr, Direction direction,
			Expression adjacentNodeTypeExpr, Type type)
		: base("bounded reachable node with remaining depth expression", type, startNodeExpression, incidentEdgeTypeExpr, direction, adjacentNodeTypeExpr)
	{
