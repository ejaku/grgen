...
public class BoundedReachableNodeWithRemainingDepthExpr extends NeighborhoodQueryExpr
{
	...
	{
		super("bounded reachable node with remaining depth expression", type, startNodeExpression,
