...
namespace de.unika.ipd.grgen.ir.expr.graph
{
	...
	public class CountAdjacentNodeExpr : NeighborhoodQueryExpr
	{
		public CountAdjacentNodeExpr(Expression startNodeExpression,
			...
			: base("count adjacent node expression", IntType.Type, startNodeExpression, incidentEdgeTypeExpr, direction, adjacentNodeTypeExpr)
		{
		}
