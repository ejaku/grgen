...
public class CountIncidentEdgeExpr : NeighborhoodQueryExpr
{
	public CountIncidentEdgeExpr(Expression startNodeExpression,
		...
		: base("count incident edge expression", IntType.Type, startNodeExpression, incidentEdgeTypeExpr, direction, adjacentNodeTypeExpr)
	{
	}
