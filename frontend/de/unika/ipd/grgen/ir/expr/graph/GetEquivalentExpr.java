...
public class GetEquivalentExpr extends BuiltinFunctionInvocationExpr
{
	private final Expression subgraphExpr;
	private final Expression setExpr;
	private final boolean includingAttributes;

	public GetEquivalentExpr(Expression subgraphExpr, Expression setExpr, boolean includingAttributes, Type type)
	{
		super("get equivalent expression", type);
