...
public class IsInNodesFromIndexAccessFromToExpr extends NodesFromIndexAccessExpr
{
	private final Expression candidateExpr;
	private final IndexAccessOrdering indexAccess;

	public IsInNodesFromIndexAccessFromToExpr(Expression candidateExpr, IndexAccessOrdering indexAccess, Type type)
	{
