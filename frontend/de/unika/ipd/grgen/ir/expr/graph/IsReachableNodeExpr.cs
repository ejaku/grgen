...
namespace de.unika.ipd.grgen.ir.expr.graph
{
	...
	public class IsReachableNodeExpr : NeighborhoodQueryExpr
	{
		...
		public IsReachableNodeExpr(Expression startNodeExpression, Expression endNodeExpression,
			...
			: base("is reachable node expression", type, startNodeExpression, incidentEdgeTypeExpr, direction, adjacentNodeTypeExpr)
		{
