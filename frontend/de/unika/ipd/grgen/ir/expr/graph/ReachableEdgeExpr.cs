...
namespace de.unika.ipd.grgen.ir.expr.graph
{
	...
	public class ReachableEdgeExpr : NeighborhoodQueryExpr
	{
		public ReachableEdgeExpr(Expression startNodeExpression,
			...
			: base("reachable edge expression", type, startNodeExpression, incidentEdgeTypeExpr, direction, adjacentNodeTypeExpr)
		{
		}
