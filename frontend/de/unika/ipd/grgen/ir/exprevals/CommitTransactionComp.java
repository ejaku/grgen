...
public class CommitTransactionComp extends ComputationInvocationBase {
	private Expression transactionIdExpr;

	public CommitTransactionComp(Expression stringExpr) {
		super("commit transaction computation");
