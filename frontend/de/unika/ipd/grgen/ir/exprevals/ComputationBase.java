 ...
 * A computation base.
 */
public abstract class ComputationBase extends Identifiable {
	 ...
	 */
	public ComputationBase(String name, Ident ident) {
		super(name, ident);
	}

	/** Add a return type to the computation. */
	public void addReturnType(Type returnType) {
		returnTypes.add(returnType);
	}

	/** Get all return types of this computation. */
	public List<Type> getReturnTypes() {
		return Collections.unmodifiableList(returnTypes);
	}
	
	/** Get all parameter types of this computation. */
