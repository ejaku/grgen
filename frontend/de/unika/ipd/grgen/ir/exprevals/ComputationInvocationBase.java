...
/**
 * A base class for computation invocations.
 */
public abstract class ComputationInvocationBase extends EvalStatement {
	/** The arguments of the computation invocation. */
	protected List<Expression> arguments = new ArrayList<Expression>();

	/** The return types of the computation invocation. */
	protected Vector<Type> returnTypes = new Vector<Type>();

	protected ComputationInvocationBase(String name) {
		super(name);
	}
	...
	/** Adds a return type t to the computation. */
	...
	public abstract ComputationBase getComputationBase();
}
