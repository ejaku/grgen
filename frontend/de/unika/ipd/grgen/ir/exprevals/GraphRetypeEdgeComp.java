...
public class GraphRetypeEdgeComp extends ComputationInvocationBase {
	private final Expression edge;
	private final Expression newEdgeType;

	public GraphRetypeEdgeComp(Expression edge, Expression newEdgeType) {
		super("graph retype edge compuation");
		this.edge = edge;
