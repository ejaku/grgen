...
public class RollbackTransactionComp extends ComputationInvocationBase {
	private Expression transactionIdExpr;

	public RollbackTransactionComp(Expression transactionIdExpr) {
		super("rollback transaction computation");
