...
public class DebugHighlightProc : BuiltinProcedureInvocationBase
{
	private ICollection<Expression> exprs;

	public DebugHighlightProc(ICollection<Expression> expressions)
		: base("debug highlight procedure")
	{
