...
import de.unika.ipd.grgen.ast.ResolverCollectNode;
...
public abstract class ParserEnvironment extends Base {
	...
	public ParserEnvironment(Sys system) {
		...
		nodeRoot = predefineType("Node",
				new NodeTypeNode(new CollectNode(), new CollectNode(), 0, null));

		// The edge type root
		edgeRoot = predefineType("Edge",
				new EdgeTypeNode(new CollectNode(), new ResolverCollectNode<ConnAssertNode, ConnAssertNode>(), new CollectNode(), 0, null));
