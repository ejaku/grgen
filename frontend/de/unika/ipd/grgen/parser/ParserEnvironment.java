...
public abstract class ParserEnvironment extends Base {
	...
	{
		if( (i.getText().equals("nodes") || i.getText().equals("edges")) && params.getChildren().size()<=1
	...
	public boolean isKnownForFunction(String name)
	{
		if(name.equals("adjacent") || name.equals("adjacentIncoming") || name.equals("adjacentOutgoing")
			...
			|| name.equals("reachableEdges") || name.equals("reachableEdgesIncoming") || name.equals("reachableEdgesOutgoing")
			|| name.equals("boundedReachable") || name.equals("boundedReachableIncoming") || name.equals("boundedReachableOutgoing")
			|| name.equals("boundedReachableEdges") || name.equals("boundedReachableEdgesIncoming") || name.equals("boundedReachableEdgesOutgoing")
	...
	public boolean isAutoGeneratedBaseFilterName(String name)
	{
		if(name.equals("orderAscendingBy") || name.equals("orderDescendingBy") || name.equals("groupBy")
			|| name.equals("keepSameAsFirst") || name.equals("keepSameAsLast") || name.equals("keepOneForEach")) {
			return true;
		}
		return false;
	}
