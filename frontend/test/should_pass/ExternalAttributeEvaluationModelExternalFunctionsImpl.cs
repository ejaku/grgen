...
namespace de.unika.ipd.grGen.Model_ExternalAttributeEvaluation
{
    ...
    {
        public static bool IsEqual(object this_, object that, IDictionary<object, object> visitedMap)
        {
		...
		public static bool IsLower(object this_, object that, IDictionary<object, object> visitedMap)
        {
        ...
        public static bool IsEqual(Own this_, Own that, IDictionary<object, object> visitedMap)
        {
            return this_ == that; // equal if identical, default implementation
        }
		
		public static bool IsLower(Own this_, Own that, IDictionary<object, object> visitedMap)
        {
            throw new Exception("not implemented");
        }

        
		public static OwnPown Copy(OwnPown that, GRGEN_LIBGR.IGraph graph, IDictionary<object, object> oldToNewMap)
        {
            return new OwnPown(that);
        }
        public static bool IsEqual(OwnPown this_, OwnPown that, IDictionary<object, object> visitedMap)
        {
            return this_.ehe == that.ehe;
        }

		public static bool IsLower(OwnPown this_, OwnPown that, IDictionary<object, object> visitedMap)
		{
			return this_.ehe.Length < that.ehe.Length;
		}

		
        public static OwnPownHome Copy(OwnPownHome that, GRGEN_LIBGR.IGraph graph, IDictionary<object, object> oldToNewMap)
        {
            return new OwnPownHome(that);
        }

        public static bool IsEqual(OwnPownHome this_, OwnPownHome that, IDictionary<object, object> visitedMap)
        {
            return this_.ehe == that.ehe && this_.aha == that.aha;
        }

		public static bool IsLower(OwnPownHome this_, OwnPownHome that, IDictionary<object, object> visitedMap)
		{
